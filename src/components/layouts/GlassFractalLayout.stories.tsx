...
const orgChart: FractalNode[] = [
  {
    id: 'ceo',
    content: <div className="glass-glass-glass-text-xs glass-glass-glass-font-bold">CEO</div>,
    children: [
      {
        id: 'cto',
        content: <div className="glass-glass-glass-text-xs">CTO</div>,
        children: [
          { id: 'dev1', content: <div className="glass-glass-glass-text-xs">Dev</div> },
          { id: 'dev2', content: <div className="glass-glass-glass-text-xs">Dev</div> },
          { id: 'dev3', content: <div className="glass-glass-glass-text-xs">Dev</div> }
        ]
      },
      {
        id: 'cfo',
        content: <div className="glass-glass-glass-text-xs">CFO</div>,
        children: [
          { id: 'acc1', content: <div className="glass-glass-glass-text-xs">Acc</div> },
          { id: 'acc2', content: <div className="glass-glass-glass-text-xs">Acc</div> }
        ]
      },
      {
        id: 'cmo',
        content: <div className="glass-glass-glass-text-xs">CMO</div>,
        children: [
          { id: 'mark1', content: <div className="glass-glass-glass-text-xs">Mkt</div> },
          { id: 'mark2', content: <div className="glass-glass-glass-text-xs">Mkt</div> },
          { id: 'mark3', content: <div className="glass-glass-glass-text-xs">Mkt</div> },
          { id: 'mark4', content: <div className="glass-glass-glass-text-xs">Mkt</div> }
        ]
      }
    ]
  }
...
const mathNodes: FractalNode[] = [
  {
    id: 'center',
    content: <div className="glass-glass-glass-w-4 glass-glass-glass-h-4 glass-gradient-primary glass-gradient-primary glass-gradient-primary glass-radius-full" />,
    children: Array.from({ length: 8 }, (_, i) => ({
      id: `ring1-${i}`,
      content: <div className="glass-glass-glass-w-3 glass-glass-glass-h-3 glass-gradient-primary glass-gradient-primary glass-gradient-primary glass-radius-full" />,
      children: Array.from({ length: 3 }, (_, j) => ({
        id: `ring2-${i}-${j}`,
        content: <div className="glass-glass-glass-w-2 glass-glass-glass-h-2 glass-gradient-primary glass-gradient-primary glass-gradient-primary glass-radius-full" />
      }))
    }))
  }
];
