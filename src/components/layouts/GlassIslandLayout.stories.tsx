...
const mockIslands: Island[] = [
  {
    ...
    content: (
      <div className="h-full">
        <h3 className="text-lg font-semibold text-white/90 mb-2">Dashboard</h3>
  ...
  },
  {
    ...
    content: (
      <div className="h-full">
        <h3 className="text-lg font-semibold text-white/90 mb-2">Team Chat</h3>
  ...
  },
  {
    ...
    content: (
      <div className="h-full">
        <h3 className="text-lg font-semibold text-white/90 mb-2">Calendar</h3>
  ...
  },
  {
    ...
    content: (
      <div className="h-full">
        <h3 className="text-lg font-semibold text-white/90 mb-2">Metrics</h3>
  ...
  },
  {
    ...
    content: (
      <div className="h-full">
        <h3 className="text-lg font-semibold text-white/90 mb-2">Tasks</h3>
        <div className="space-y-1 text-sm text-white/70">
  ...
  },
  {
    ...
    content: (
      <div className="h-full">
        <h3 className="text-lg font-semibold text-white/90 mb-2">Notes</h3>
...
const largeIslands = [
  ...mockIslands,
  {
    ...
    content: (
      <div className="h-full">
        <h3 className="text-lg font-semibold text-white/90 mb-2">Reports</h3>
  ...
  },
  {
    ...
    content: (
      <div className="h-full">
        <h3 className="text-lg font-semibold text-white/90 mb-2">Settings</h3>
        <div className="text-sm text-white/70">
  ...
  args: {
    islands: [
      ...largeIslands,
      {
        ...
        height: 180,
        category: 'system',
        content: <div className="p-4"><h3 className="text-white/90">System Monitoring</h3></div>
      },
      {
        id: 'logs',
        x: 600,
        ...
        height: 160,
        category: 'system',
        content: <div className="p-4"><h3 className="text-white/90">Log Viewer</h3></div>
      }
    ],
    connections: [
      ...mockConnections,
...
export const PerformanceTest: Story = {
  args: {
    islands: Array.from({ length: 20 }, (_, i) => ({
      ...
      content: (
        <div className="p-4">
          <h4 className="text-white/90">Island {i + 1}</h4>
          <p className="text-white/60 text-sm">Test content</p>
        </div>
      )
    })),
    showMinimap: true,
