    ...
    return (
      ...
      >
        ...
        >
          {/* Center Button */}
          <motion.button
            className="relative z-20 flex items-center justify-center glass-surface rounded-full border border-white/20 backdrop-blur-md bg-white/10 hover:bg-white/15 transition-colors"
            style={{
              width: itemSize + 8,
              height: itemSize + 8
            }}
          ...
          >
            {centerElement || (
              ...
              >
                <div className="w-4 h-0.5 bg-white/70 mb-1" />
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {item.shortcut && (
                        <div className="absolute -top-2 -right-2 bg-black/50 text-white/70 text-xs px-1 py-0.5 rounded text-[10px] backdrop-blur-sm">
                          {item.shortcut}
                        </div>
                      )}
                      ...
                      <AnimatePresence>
                        {isHovered && !prefersReducedMotion && (
                          <motion.div
                            className="absolute top-full mt-2 bg-black/80 text-white text-xs px-2 py-1 rounded backdrop-blur-sm whitespace-nowrap"
