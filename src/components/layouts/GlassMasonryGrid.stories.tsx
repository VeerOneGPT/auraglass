    ...
    return {
      ...
      content: (
        <div className={`h-full w-full bg-gradient-to-br ${color} rounded-lg flex items-center justify-center text-white relative overflow-hidden`}>
          <div className="glass-glass-glass-absolute glass-glass-glass-inset-0 glass-surface-dark/20" />
          <div className="glass-glass-glass-relative glass-glass-glass-z-10 glass-glass-glass-text-center glass-glass-glass-p-4">
            <h4 className="glass-glass-glass-font-semibold glass-glass-glass-mb-2">{category.charAt(0).toUpperCase() + category.slice(1)} {i + 1}</h4>
            ...
            <div className="mt-2 glass-glass-glass-text-xs opacity-75">
