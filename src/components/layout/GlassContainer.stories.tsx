...
const meta: Meta<typeof GlassContainer> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A responsive container with glassmorphism styling and consciousness interface integration for intelligent, adaptive user experiences.",
      },
    },
  },
  argTypes: {
  ...
  decorators: [
    (Story) => (
      ...
      >
        <div
          className="glass-min-glass-h-screen glass-p-8"
          style={{
            background:
              "radial-gradient(circle at 18% 12%, rgba(255,255,255,0.98), rgba(244,246,248,0.96) 38%, rgba(226,229,233,0.98) 100%)",
          }}
        >
          <Story />
        </div>
...
export const Default: Story = {
  args: {
    children: (
      <div className="glass-p-8" style={{ color: "rgba(15, 23, 42, 0.94)" }}>
        <div
          className="glass-text-xs glass-font-bold glass-mb-3"
          style={{
        ...
        <p
          ...
          style={{ color: "rgba(51, 65, 85, 0.88)", lineHeight: 1.55 }}
        >
          A calm, responsive surface for content that needs structure without
          visual weight.
        </p>
        <div
          className="glass-w-full glass-h-32 glass-radius-lg glass-flex glass-items-center glass-justify-center"
          style={{
            background: "rgba(255, 255, 255, 0.14)",
            border: "1px solid rgba(255, 255, 255, 0.34)",
            boxShadow:
              "inset 0 1px 0 rgba(255,255,255,0.42), inset 0 0 16px rgba(255,255,255,0.12)",
          }}
        >
          <span style={{ color: "rgba(51, 65, 85, 0.82)" }}>
