  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDown className="glass-glass-h-4 glass-glass-w-4 opacity-50 transition-transform group-data-[state=open]:rotate-180" />
...
>(({ className, children, variant = 'default', ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Item
      ...
      {...props}
    >
      <span className="glass-glass-absolute left-2 glass-glass-flex h-3.5 w-3.5 glass-glass-items-center glass-glass-justify-center">
        <SelectPrimitive.ItemIndicator>
          <Check className="glass-glass-h-4 glass-glass-w-4" />
        </SelectPrimitive.ItemIndicator>
      </span>
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <ChevronUp className="glass-glass-h-4 glass-glass-w-4" />
  </SelectPrimitive.ScrollUpButton>
));
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ...
    {...props}
  >
    <ChevronDown className="glass-glass-h-4 glass-glass-w-4" />
  </SelectPrimitive.ScrollDownButton>
));
