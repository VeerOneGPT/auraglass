  ...
  args: {
    children: (
      <div className="glass-glass-glass-p-4 glass-glass-glass-text-center">
        <h3 className="glass-glass-glass-text-lg glass-glass-glass-font-semibold glass-glass-glass-mb-2">GlassSwitch</h3>
        <p className="glass-glass-glass-text-sm opacity-80">This is the default glassswitch component.</p>
      </div>
    ),
  },
};
