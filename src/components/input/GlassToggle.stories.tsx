  ...
  args: {
    children: (
      <div className="glass-glass-p-4 glass-glass-text-center">
        <h3 className="glass-glass-text-lg glass-glass-font-semibold glass-glass-mb-2">GlassToggle</h3>
        <p className="glass-glass-text-sm opacity-80">This is the default glasstoggle component.</p>
      </div>
    ),
  },
};
