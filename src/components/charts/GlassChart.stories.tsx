  ...
  render: () => (
    <div className="space-y-6">
      <div className="text-center glass-gap-2">
        <h2 className="glass-text-xl font-semibold text-glass-text">Consciousness Interface Features</h2>
        <p className="glass-text-sm text-glass-text-secondary">Experience next-generation chart interactions</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 glass-gap-6">
        <div className="bg-glass-surface/10 backdrop-blur-sm glass-radius-lg glass-p-4 glass-gap-3">
          <div className="flex items-center glass-gap-2">
            ...
            <h3 className="font-medium text-glass-text">Predictive Engine</h3>
          </div>
        ...
        <div className="bg-glass-surface/10 backdrop-blur-sm glass-radius-lg glass-p-4 glass-gap-3">
          <div className="flex items-center glass-gap-2">
            ...
            <h3 className="font-medium text-glass-text">Biometric Adaptation</h3>
          </div>
          <ul className="glass-text-sm text-glass-text-secondary glass-gap-1 ml-5">
...
export const Variants: Story = {
  render: (args: any) => (
    <div className="flex flex-wrap glass-gap-6">
      <div className="flex flex-col glass-gap-2">
        <h3 className="glass-text-sm font-medium text-glass-text">Default</h3>
        <GlassChart {...args} />
      </div>
      <div className="flex flex-col glass-gap-2">
        <h3 className="glass-text-sm font-medium text-glass-text">Bar Chart</h3>
        <GlassChart {...args} type="bar" />
      </div>
      <div className="flex flex-col glass-gap-2">
        <h3 className="glass-text-sm font-medium text-glass-text">Area Chart</h3>
  ...
  render: (args: any) => (
    <div className="glass-gap-4">
      <div className="bg-glass-surface/20 backdrop-blur-sm glass-radius-lg glass-p-4">
        <h3 className="glass-text-sm font-medium text-glass-text glass-mb-2">Predictive Chart</h3>
        <p className="glass-text-xs text-glass-text-secondary glass-mb-4">Automatically preloads data and shows predictive insights</p>
...
export const WithEyeTracking: Story = {
  render: (args: any) => (
    <div className="glass-gap-4">
      <div className="bg-glass-surface/20 backdrop-blur-sm glass-radius-lg glass-p-4">
        <h3 className="glass-text-sm font-medium text-glass-text glass-mb-2">Eye Tracking Enabled</h3>
        <p className="glass-text-xs text-glass-text-secondary glass-mb-4">Responds to user gaze and highlights data points</p>
        <GlassChart {...args} />
      </div>
    </div>
  ),
...
export const AdaptiveChart: Story = {
  render: (args: any) => (
    <div className="glass-gap-4">
      <div className="bg-glass-surface/20 backdrop-blur-sm glass-radius-lg glass-p-4">
        <h3 className="glass-text-sm font-medium text-glass-text glass-mb-2">Biometric Adaptive</h3>
        <p className="glass-text-xs text-glass-text-secondary glass-mb-4">Adjusts complexity based on user stress levels</p>
...
export const ImmersiveExperience: Story = {
  render: (args: any) => (
    <div className="glass-gap-4">
      <div className="bg-glass-surface/20 backdrop-blur-sm glass-radius-lg glass-p-4">
        <h3 className="glass-text-sm font-medium text-glass-text glass-mb-2">Immersive with Spatial Audio</h3>
        <p className="glass-text-xs text-glass-text-secondary glass-mb-4">Full consciousness features with spatial audio feedback</p>
...
export const ConsciousnessComparison: Story = {
  render: (args: any) => (
    <div className="grid grid-cols-1 md:grid-cols-2 glass-gap-6">
      <div className="bg-glass-surface/20 backdrop-blur-sm glass-radius-lg glass-p-4">
        <h3 className="glass-text-sm font-medium text-glass-text glass-mb-2">Standard Chart</h3>
        <GlassChart {...args} />
      </div>
      <div className="bg-glass-surface/20 backdrop-blur-sm glass-radius-lg glass-p-4">
        <h3 className="glass-text-sm font-medium text-glass-text glass-mb-2">Consciousness Enhanced</h3>
