...
const meta: Meta<typeof GlassIntelligentSearch> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Advanced search interface with NLP capabilities, smart filters, voice search, and intelligent suggestions - like Google or Elasticsearch with AI enhancement.",
      },
    },
  },
};
...
const sampleData: SearchResult[] = [
  ...
  },
  {
    ...
    description:
      "Create scalable design systems with CSS-in-JS, design tokens, and component libraries. Learn best practices for responsive design and accessibility.",
    category: "Article",
  ...
  },
  {
    ...
    description:
      "Optimize your Node.js applications for better performance. Learn about memory management, clustering, caching strategies, and monitoring tools.",
    category: "Guide",
  ...
  },
  {
    ...
    description:
      "Start your journey into machine learning with Python. Cover supervised and unsupervised learning, neural networks, and practical applications.",
    category: "Course",
    tags: [
      "machine learning",
      "python",
  ...
  },
  {
    ...
    description:
      "Build efficient APIs with GraphQL. Learn about schemas, resolvers, subscriptions, and integration with React applications.",
    category: "Tutorial",
  ...
  },
  {
    ...
    description:
      "Containerize your applications with Docker. Learn about images, containers, Docker Compose, and deployment strategies.",
    category: "Guide",
    tags: [
      "docker",
      "containerization",
  ...
  },
  {
    ...
    description:
      "Master modern CSS layout techniques with Grid and Flexbox. Create complex layouts with ease and build responsive designs.",
    category: "Tutorial",
  ...
  },
  {
    ...
    description:
      "Explore Vue.js 3 and the Composition API. Learn about reactive state management, component composition, and modern Vue development.",
    category: "Documentation",
    tags: [
      "vue",
      "composition api",
  ...
  },
  {
    ...
    description:
      "Learn fundamental database design principles. Cover normalization, indexing, relationships, and performance optimization strategies.",
    category: "Guide",
  ...
  },
  {
    ...
    description:
      "Design scalable cloud architectures on AWS. Learn about EC2, S3, Lambda, RDS, and best practices for cloud-native applications.",
    category: "Course",
  ...
  },
  {
    ...
    description:
      "Comprehensive testing strategies for React applications. Cover unit testing, integration testing, and end-to-end testing with modern tools.",
    category: "Article",
...
export const BasicSearch: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Basic search interface with text matching and filters. Try searching for "React", "TypeScript", or "CSS".',
      },
    },
  },
};
...
export const IntelligentNLP: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Advanced search with NLP capabilities. Try queries like "find the best React tutorials", "show me guides about performance", or "compare frontend frameworks".',
      },
    },
  },
};
...
export const VoiceSearch: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Voice-enabled search with speech recognition. Click the microphone button and speak your search query.",
      },
    },
  },
};
...
export const FiltersOnly: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Focus on advanced filtering capabilities. Use the filter controls to narrow down results by category, tags, and rating.",
      },
    },
  },
};
...
export const SearchShowcase: Story = {
  render: () => {
    ...
    const [selectedTitle, setSelectedTitle] =
      React.useState("No result selected");
    ...
    return (
      <div className="search-story-surface">
        <section className="search-story-hero">
          ...
          <div
            className="search-story-metrics"
            aria-label="Search demo metrics"
          >
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Complete showcase of the intelligent search system with all advanced features enabled.",
      },
    },
  },
};
...
export const LargeDataset: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Performance test with a larger dataset of 100+ items to demonstrate search scalability and intelligent filtering.",
      },
    },
  },
};
