...
export const WithIcons: Story = {
  render: (args) => (
    <div className="glass-glass-flex glass-glass-flex-wrap glass-glass-gap-4">
      <ToggleButton {...args}>
        <ThumbsUp className="glass-glass-w-4 glass-glass-h-4 glass-mr-2" />
        Like
      </ToggleButton>
      <ToggleButton {...args}>
        <Star className="glass-glass-w-4 glass-glass-h-4 glass-mr-2" />
        Favorite
      </ToggleButton>
      <ToggleButton {...args}>
        <Heart className="glass-glass-w-4 glass-glass-h-4 glass-mr-2" />
        Love
      </ToggleButton>
    </div>
  ),
