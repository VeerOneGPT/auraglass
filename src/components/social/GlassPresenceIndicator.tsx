      ...
      >
        {showAvatars && (
          <div className="glass-glass-relative">
            ...
            `}>
              {user.avatar ? (
                <img src={user.avatar} alt={user.name} className="glass-glass-w-full glass-glass-h-full glass-radius-full object-cover" />
              ) : (
          ...
          {showNames && (
            <div className="glass-glass-flex glass-glass-items-center space-x-1">
              ...
              {user.customStatus?.emoji && (
                <span className="glass-glass-text-xs">{user.customStatus.emoji}</span>
              )}
            </div>
          )}
        ...
        {showTypingIndicator && user.isTyping && (
          <motion.div
            className="glass-glass-flex space-x-1"
    ...
    return (
      ...
      >
        ...
        {showTypingIndicator && typingUsers.length > 0 && (
          <motion.div
            className="mt-3 pt-3 glass-glass-border-t glass-glass-border-white/10"
        ...
        <motion.div
          className="mt-3 pt-3 glass-glass-border-t glass-glass-border-white/10 glass-glass-flex glass-glass-justify-between glass-glass-items-center glass-glass-text-xs glass-glass-text-primary/50"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
