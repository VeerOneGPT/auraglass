...
export const Variants: Story = {
  render: (args) => (
    <div className="grid grid-cols-1 md:grid-cols-3 glass-gap-6 max-w-6xl">
      <GlassCard>
        <div className="glass-p-6 text-center">
          <h4 className="glass-text-sm font-medium glass-mb-4">Count Variant</h4>
      ...
      <GlassCard>
        <div className="glass-p-6 text-center">
          <h4 className="glass-text-sm font-medium glass-mb-4">Scale Variant</h4>
      ...
      <GlassCard>
        <div className="glass-p-6 text-center">
          <h4 className="glass-text-sm font-medium glass-mb-4">Glow Variant</h4>
    ...
    return (
      <GlassCard>
        <div className="p-8 text-center space-y-6">
          ...
          <div className="flex justify-center glass-gap-3">
...
export const AnimatedCounter: Story = {
  render: (args) => (
    <div className="grid grid-cols-1 md:grid-cols-2 glass-gap-6 max-w-4xl">
      <GlassCard>
        <div className="glass-p-6 text-center">
          <h4 className="glass-text-sm font-medium glass-mb-4">Simple Counter</h4>
      ...
      <GlassCard>
        <div className="glass-p-6 text-center">
          <h4 className="glass-text-sm font-medium glass-mb-4">Score Counter</h4>
...
export const DashboardExample: Story = {
  render: (args) => (
    <div className="grid grid-cols-1 md:grid-cols-4 glass-gap-6 max-w-7xl">
      <GlassCard>
        <div className="glass-p-6 text-center">
