    ...
    <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-2 glass-glass-gap-6 max-w-4xl">
      <GlassCard>
        <div className="glass-glass-p-6 glass-glass-text-center">
          ...
          <p className="glass-glass-text-sm opacity-80 glass-mt-2">Revenue</p>
        </div>
      </GlassCard>
      ...
      <GlassCard>
        <div className="glass-glass-p-6 glass-glass-text-center">
          ...
          <p className="glass-glass-text-sm opacity-80 glass-mt-2">Total Views</p>
        </div>
      </GlassCard>
      ...
      <GlassCard>
        <div className="glass-glass-p-6 glass-glass-text-center">
          ...
          <p className="glass-glass-text-sm opacity-80 glass-mt-2">Completion Rate</p>
        </div>
      </GlassCard>
      ...
      <GlassCard>
        <div className="glass-glass-p-6 glass-glass-text-center">
          ...
          <p className="glass-glass-text-sm opacity-80 glass-mt-2">Current Level</p>
        </div>
      </GlassCard>
    </div>
  ),
...
export const Variants: Story = {
  render: (args) => (
    <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-3 glass-glass-gap-6 max-w-6xl">
      <GlassCard>
        <div className="glass-glass-p-6 glass-glass-text-center">
          <h4 className="glass-glass-text-sm glass-glass-font-medium glass-glass-mb-4">Count Variant</h4>
      ...
      <GlassCard>
        <div className="glass-glass-p-6 glass-glass-text-center">
          <h4 className="glass-glass-text-sm glass-glass-font-medium glass-glass-mb-4">Scale Variant</h4>
      ...
      <GlassCard>
        <div className="glass-glass-p-6 glass-glass-text-center">
          <h4 className="glass-glass-text-sm glass-glass-font-medium glass-glass-mb-4">Glow Variant</h4>
...
export const Sizes: Story = {
  render: (args) => (
    <div className="glass-glass-flex glass-glass-flex-col glass-glass-items-center space-y-6">
      <div className="glass-glass-text-center">
        <GlassAnimatedNumber {...args} size="sm" value={1234} />
        <p className="glass-glass-text-xs opacity-80 glass-mt-1">Small</p>
      </div>

      <div className="glass-glass-text-center">
        <GlassAnimatedNumber {...args} size="md" value={56789} />
        <p className="glass-glass-text-xs opacity-80 glass-mt-1">Medium</p>
      </div>

      <div className="glass-glass-text-center">
        <GlassAnimatedNumber {...args} size="lg" value={123456} />
        <p className="glass-glass-text-xs opacity-80 glass-mt-1">Large</p>
      </div>

      <div className="glass-glass-text-center">
        <GlassAnimatedNumber {...args} size="xl" value={987654} />
        <p className="glass-glass-text-xs opacity-80 glass-mt-1">Extra Large</p>
      </div>
    </div>
  ),
  args: {},
...
export const InteractiveDemo: Story = {
  render: (args) => {
    ...
    return (
      <GlassCard>
        <div className="glass-glass-p-8 glass-glass-text-center space-y-6">
          <div>
            <GlassAnimatedNumber
              {...args}
              value={currentValue}
            ...
            />
            <p className="glass-glass-text-sm opacity-80 glass-mt-2">Current Value</p>
          </div>

          <div className="glass-glass-flex glass-glass-justify-center glass-glass-gap-3">
          ...
          <div className="glass-glass-text-xs opacity-60">
...
export const AnimatedCounter: Story = {
  render: (args) => (
    <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-2 glass-glass-gap-6 max-w-4xl">
      <GlassCard>
        <div className="glass-glass-p-6 glass-glass-text-center">
          <h4 className="glass-glass-text-sm glass-glass-font-medium glass-glass-mb-4">Simple Counter</h4>
          <GlassAnimatedCounter value={42} />
          <p className="glass-glass-text-xs opacity-80 glass-mt-2">Items in cart</p>
        </div>
      </GlassCard>

      <GlassCard>
        <div className="glass-glass-p-6 glass-glass-text-center">
          <h4 className="glass-glass-text-sm glass-glass-font-medium glass-glass-mb-4">Score Counter</h4>
          <GlassAnimatedCounter value={15420} />
          <p className="glass-glass-text-xs opacity-80 glass-mt-2">Total score</p>
        </div>
      </GlassCard>
    </div>
  ),
...
export const DashboardExample: Story = {
  render: (args) => (
    <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-4 glass-glass-gap-6 max-w-7xl">
      <GlassCard>
        <div className="glass-glass-p-6 glass-glass-text-center">
      ...
      <GlassCard>
        <div className="glass-glass-p-6 glass-glass-text-center">
          ...
          <p className="glass-glass-text-sm opacity-80 glass-mt-2">Active Users</p>
        </div>
      </GlassCard>
      ...
      <GlassCard>
        <div className="glass-glass-p-6 glass-glass-text-center">
          ...
          <p className="glass-glass-text-sm opacity-80 glass-mt-2">Uptime</p>
        </div>
      </GlassCard>
    </div>
  ),
