...
const GlassAlert = React.forwardRef<HTMLDivElement, GlassAlertProps>(
  ({
    ...
    const getDefaultIcon = () => {
      switch (variant) {
        case 'success':
          return <CheckCircle className="glass-glass-h-4 glass-glass-w-4" />;
        case 'warning':
          return <AlertTriangle className="glass-glass-h-4 glass-glass-w-4" />;
        case 'error':
        case 'destructive':
          return <AlertCircle className="glass-glass-h-4 glass-glass-w-4" />;
        case 'info':
          return <Info className="glass-glass-h-4 glass-glass-w-4" />;
        default:
          return <Info className="glass-glass-h-4 glass-glass-w-4" />;
      }
    };
    ...
    const alertContent = (
      ...
      >
        ...
        {dismissible && (
          ...
          >
            <X className="glass-glass-h-4 glass-glass-w-4" />
          </GlassButton>
        )}
      </OptimizedGlass>
    );
