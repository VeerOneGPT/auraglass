          ...
          {items.map((item, index) => {
            ...
            return (
              <li key={item.id} className="relative" role="listitem">
                ...
                >
                  <div className="flex items-start justify-between glass-gap-4">
                    <div className="flex items-start glass-gap-3 min-w-0 flex-1">
                      {item.icon && (
                        <div className="flex-shrink-0 glass-text-secondary mt-0.5">
                          {item.icon}
                        </div>
                      )}
    ...
    return (
      <div ref={ref} className={cn('timeline-item', className)} {...props}>
        ...
        >
          ...
          {item.subtitle && (
            <div className="glass-text-sm glass-text-secondary glass-mt-1">{item.subtitle}</div>
          )}
          {item.time && (
            <div className="glass-text-xs glass-text-secondary glass-mt-2">{item.time}</div>
          )}
        </OptimizedGlass>
      </div>
    );
