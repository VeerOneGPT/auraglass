...
export const GlassLoadingSkeleton = forwardRef<HTMLDivElement, GlassLoadingSkeletonProps>(
  (
      ...
      <OptimizedGlass
        ...
        <div className="glass-auto-gap glass-auto-gap-lg">
          ...
          <div className="glass-glass-flex glass-glass-items-center glass-glass-gap-4">
            ...
            <div className="glass-auto-gap glass-auto-gap-sm glass-glass-flex-1">
          ...
          {/* Actions */}
          <div className="glass-glass-flex glass-glass-gap-3 pt-2">
    ...
    const renderListSkeleton = () => (
      <div className="glass-auto-gap glass-auto-gap-md">
        {Array.from({ length: rows }, (_, index) => (
          <div key={index} className="glass-glass-flex glass-glass-items-center glass-glass-gap-4 glass-glass-p-3">
    ...
    const renderTableSkeleton = () => (
      <div className="glass-auto-gap glass-auto-gap-sm">
        {/* Header */}
        <div className="glass-glass-grid glass-glass-glass-grid-cols-4 glass-glass-gap-4 glass-glass-p-4 glass-glass-border-b glass-glass-border-white/10">
        ...
        {Array.from({ length: rows }, (_, rowIndex) => (
          <div key={rowIndex} className="glass-glass-grid glass-glass-glass-grid-cols-4 glass-glass-gap-4 glass-glass-p-4">
    ...
    const renderFormSkeleton = () => (
      <div className="glass-auto-gap glass-auto-gap-2xl">
        ...
        <div className="glass-glass-flex glass-glass-gap-3 pt-4">
    ...
    const renderDashboardSkeleton = () => (
      <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-2 lg:glass-glass-glass-grid-cols-3 glass-glass-gap-6">
        {Array.from({ length: rows }, (_, index) => (
          ...
          animation="none"
          performanceMode="medium"
          key={index}  className="glass-glass-p-6">
            <div className="glass-auto-gap glass-auto-gap-lg">
    ...
    return (
      ...
      >
        ...
        >
          ...
          {shouldShimmer && (
            <div className="glass-glass-absolute glass-glass-inset-0 -skew-x-12 glass-gradient-primary from-transparent via-blue-300/10 to-transparent animate-shimmer" />
          )}
        </div>
      </Motion>
    );
