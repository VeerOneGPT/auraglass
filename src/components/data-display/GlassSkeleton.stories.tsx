...
export const Variants: Story = {
  render: (args) => (
    <div className="space-y-6 max-w-md">
      <div>
        <h4 className="glass-text-sm font-medium mb-3">Rectangular</h4>
        <GlassSkeleton {...args} variant="rectangular" width="100%" height="60px" />
      </div>

      <div>
        <h4 className="glass-text-sm font-medium mb-3">Circular</h4>
        <GlassSkeleton {...args} variant="circular" width="60px" height="60px" />
      </div>

      <div>
        <h4 className="glass-text-sm font-medium mb-3">Rounded</h4>
        <GlassSkeleton {...args} variant="glass-radius-md" width="100%" height="40px" />
      </div>

      <div>
        <h4 className="glass-text-sm font-medium mb-3">Text</h4>
...
export const Animations: Story = {
  render: (args) => (
    <div className="glass-gap-4 max-w-md">
      <div>
        <h4 className="glass-text-sm font-medium glass-mb-2">Pulse Animation</h4>
        <GlassSkeleton {...args} animation="pulse" width="100%" height="40px" />
      </div>

      <div>
        <h4 className="glass-text-sm font-medium glass-mb-2">Wave Animation</h4>
        <GlassSkeleton {...args} animation="wave" width="100%" height="40px" />
      </div>

      <div>
        <h4 className="glass-text-sm font-medium glass-mb-2">No Animation</h4>
...
export const SkeletonText: Story = {
  render: (args) => (
    <div className="glass-gap-4 max-w-md">
      ...
      <div>
        <h4 className="glass-text-sm font-medium glass-mb-2">Long Text Block</h4>
...
export const SkeletonButton: Story = {
  render: (args) => (
    <div className="glass-gap-4 max-w-md">
      <div>
        <h4 className="glass-text-sm font-medium glass-mb-2">Button Sizes</h4>
      ...
      <div>
        <h4 className="glass-text-sm font-medium glass-mb-2">Full Width</h4>
...
export const LoadingState: Story = {
  render: (args) => (
    <div className="max-w-md glass-gap-4">
      ...
      <div className="flex justify-end glass-gap-2">
        <GlassSkeletonButton width="60px" />
        <GlassSkeletonButton width="60px" />
      </div>
    </div>
