  ...
  return (
    <div className="glass-gap-4">
      <div className="text-center mb-6">
        <h3 className="glass-text-lg font-semibold glass-mb-2">Notification Center Demo</h3>
        <p className="glass-text-sm opacity-80">Click the buttons below to trigger different types of notifications.</p>
      </div>

      <div className="grid grid-cols-2 md:grid-cols-3 glass-gap-3 max-w-md mx-auto">
  ...
  render: (args) => (
    <div className="space-y-8">
      <div className="text-center">
        <h3 className="glass-text-lg font-semibold glass-mb-2">Notification Positions</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 glass-gap-6">
        {(['top-right', 'top-left', 'bottom-right', 'bottom-left', 'top-center', 'bottom-center'] as const).map((position) => (
          <div key={position} className="border border-white/20 glass-radius-lg glass-p-4">
            <h4 className="glass-text-sm font-medium mb-3 capitalize text-center">{position.replace('-', ' ')}</h4>
            <GlassNotificationProvider>
  ...
  render: (args) => {
    ...
    return (
      <div className="text-center glass-gap-4">
        <h3 className="glass-text-lg font-semibold">Notification Types</h3>
...
export const WithActions: Story = {
  render: (args) => {
    ...
    return (
      <div className="text-center glass-gap-4">
        <h3 className="glass-text-lg font-semibold glass-mb-2">Notifications with Actions</h3>
...
export const BulkNotifications: Story = {
  render: (args) => {
    ...
    return (
      <div className="text-center glass-gap-4">
        <h3 className="glass-text-lg font-semibold glass-mb-2">Bulk Notifications</h3>
...
export const CustomStyling: Story = {
  render: (args) => (
    <GlassNotificationProvider>
      <div className="text-center glass-gap-4">
        <h3 className="glass-text-lg font-semibold glass-mb-2">Custom Styled Notifications</h3>
