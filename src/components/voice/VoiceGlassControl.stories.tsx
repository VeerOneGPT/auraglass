      ...
      <div className="max-w-4xl glass-glass-glass-mx-auto">
        ...
        <div className="glass-glass-glass-grid glass-glass-glass-glass-glass-grid-cols-1 md:glass-glass-glass-glass-glass-grid-cols-2 glass-glass-glass-gap-6 mb-8">
          <div className="glass-glass-glass-p-6 glass-surface-subtle/80 dark:glass-surface-primary/80 backdrop-blur-lg glass-radius-xl glass-glass-glass-border glass-glass-glass-border-subtle/50 dark:glass-glass-glass-border-gray-700/50">
            ...
            <div className="glass-glass-glass-space-y-2 glass-glass-glass-text-sm glass-text-secondary dark:text-gray-300">
          ...
          <div className="glass-glass-glass-p-6 glass-surface-subtle/80 dark:glass-surface-primary/80 backdrop-blur-lg glass-radius-xl glass-glass-glass-border glass-glass-glass-border-subtle/50 dark:glass-glass-glass-border-gray-700/50">
            ...
            <div className="glass-glass-glass-space-y-3">
              <div className="glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-gap-2">
                ...
                <span className="glass-glass-glass-text-sm glass-text-secondary dark:text-gray-300">Wake word detection</span>
              </div>
              <div className="glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-gap-2">
                <div className="glass-glass-glass-w-2 glass-glass-glass-h-2 glass-surface-blue glass-radius-full"></div>
                <span className="glass-glass-glass-text-sm glass-text-secondary dark:text-gray-300">Natural language processing</span>
              </div>
              <div className="glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-gap-2">
                <div className="glass-glass-glass-w-2 glass-glass-glass-h-2 glass-surface-primary glass-radius-full"></div>
                <span className="glass-glass-glass-text-sm glass-text-secondary dark:text-gray-300">Voice feedback</span>
              </div>
            </div>
          </div>
        </div>
...
export const MusicPlayer: Story = {
  ...
  render: (args: any) => (
    <div className="glass-min-glass-glass-h-screen glass-gradient-primary glass-gradient-primary via-pink-900 glass-gradient-primary glass-glass-glass-p-8">
      <div className="max-w-4xl glass-glass-glass-mx-auto">
        <h1 className="glass-glass-glass-text-3xl glass-glass-glass-font-bold glass-glass-glass-text-primary mb-8">
          Voice Music Player
        </h1>

        <div className="glass-surface-subtle/10 backdrop-blur-lg glass-radius-xl glass-glass-glass-p-6 mb-8">
          <div className="glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-justify-between glass-glass-glass-mb-4">
            <div>
              <h3 className="glass-glass-glass-text-xl glass-glass-glass-font-semibold glass-glass-glass-text-primary">Now Playing</h3>
              <p className="glass-glass-glass-text-primary/80">Song Title - Artist Name</p>
            </div>
            <div className="glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-gap-4">
              <button className="glass-glass-glass-p-2 glass-surface-subtle/20 glass-radius-lg hover:glass-surface-subtle/30 transition-colors">
                ⏮️
              </button>
              <button className="glass-glass-glass-p-3 glass-surface-subtle/20 glass-radius-lg hover:glass-surface-subtle/30 transition-colors">
                ▶️
              </button>
              <button className="glass-glass-glass-p-2 glass-surface-subtle/20 glass-radius-lg hover:glass-surface-subtle/30 transition-colors">
                ⏭️
          ...
          <div className="glass-glass-glass-mb-4">
            <div className="glass-glass-glass-w-full glass-surface-subtle/20 glass-radius-full glass-glass-glass-h-2">
              <div className="glass-surface-subtle glass-glass-glass-h-2 glass-radius-full" style={{ width: '30%' }}></div>
            </div>
            <div className="glass-glass-glass-flex glass-glass-glass-justify-between glass-glass-glass-text-sm glass-glass-glass-text-primary/60 mt-1">
              <span>1:23</span>
              <span>4:15</span>
            </div>
          </div>

          <div className="glass-glass-glass-text-center glass-glass-glass-text-primary/80 glass-glass-glass-text-sm">
...
export const SmartHome: Story = {
  ...
  render: (args: any) => (
    <div className="glass-min-glass-glass-h-screen glass-gradient-primary glass-gradient-primary via-teal-900 glass-gradient-primary glass-glass-glass-p-8">
      <div className="max-w-6xl glass-glass-glass-mx-auto">
        ...
        <div className="glass-glass-glass-grid glass-glass-glass-glass-glass-grid-cols-1 md:glass-glass-glass-glass-glass-grid-cols-3 glass-glass-glass-gap-6 mb-8">
          <div className="glass-surface-subtle/10 backdrop-blur-lg glass-radius-xl glass-glass-glass-p-6">
            <div className="glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-justify-between glass-glass-glass-mb-4">
              <h3 className="glass-glass-glass-text-lg glass-glass-glass-font-semibold glass-glass-glass-text-primary">Living Room</h3>
              <div className="glass-glass-glass-w-3 glass-glass-glass-h-3 glass-surface-yellow glass-radius-full"></div>
            </div>
            <div className="glass-glass-glass-space-y-2 glass-glass-glass-text-sm glass-glass-glass-text-primary/80">
              <p>💡 Lights: On</p>
          ...
          <div className="glass-surface-subtle/10 backdrop-blur-lg glass-radius-xl glass-glass-glass-p-6">
            <div className="glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-justify-between glass-glass-glass-mb-4">
              <h3 className="glass-glass-glass-text-lg glass-glass-glass-font-semibold glass-glass-glass-text-primary">Kitchen</h3>
              <div className="glass-glass-glass-w-3 glass-glass-glass-h-3 glass-surface-green glass-radius-full"></div>
            </div>
            <div className="glass-glass-glass-space-y-2 glass-glass-glass-text-sm glass-glass-glass-text-primary/80">
              <p>💡 Lights: Off</p>
          ...
          <div className="glass-surface-subtle/10 backdrop-blur-lg glass-radius-xl glass-glass-glass-p-6">
            <div className="glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-justify-between glass-glass-glass-mb-4">
              <h3 className="glass-glass-glass-text-lg glass-glass-glass-font-semibold glass-glass-glass-text-primary">Bedroom</h3>
              <div className="glass-glass-glass-w-3 glass-glass-glass-h-3 glass-surface-blue glass-radius-full"></div>
            </div>
            <div className="glass-glass-glass-space-y-2 glass-glass-glass-text-sm glass-glass-glass-text-primary/80">
              <p>💡 Lights: Dimmed</p>
        ...
        <div className="glass-surface-subtle/10 backdrop-blur-lg glass-radius-xl glass-glass-glass-p-6 mb-8">
          <h3 className="glass-glass-glass-text-lg glass-glass-glass-font-semibold glass-glass-glass-text-primary glass-glass-glass-mb-4">Voice Commands</h3>
          <div className="glass-glass-glass-grid glass-glass-glass-glass-glass-grid-cols-2 md:glass-glass-glass-glass-glass-grid-cols-4 glass-glass-glass-gap-4 glass-glass-glass-text-sm glass-glass-glass-text-primary/80">
      ...
      <div className="max-w-4xl glass-glass-glass-mx-auto">
        ...
        <div className="glass-glass-glass-grid glass-glass-glass-glass-glass-grid-cols-1 md:glass-glass-glass-glass-glass-grid-cols-2 glass-glass-glass-gap-6 mb-8">
          <div className="glass-glass-glass-p-6 glass-surface-subtle glass-radius-xl glass-glass-glass-border glass-glass-glass-border-subtle">
            ...
            <div className="glass-glass-glass-space-y-2 glass-glass-glass-text-sm glass-text-secondary">
        ...
        <div className="glass-glass-glass-p-6 glass-surface-subtle glass-radius-xl glass-glass-glass-border glass-glass-glass-border-blue-200 mb-8">
          <h3 className="glass-glass-glass-text-lg glass-glass-glass-font-semibold glass-glass-glass-text-primary glass-glass-glass-mb-4">
            Try These Commands
          </h3>
          <div className="glass-glass-glass-grid glass-glass-glass-glass-glass-grid-cols-1 md:glass-glass-glass-glass-glass-grid-cols-2 glass-glass-glass-gap-4 glass-glass-glass-text-sm glass-glass-glass-text-primary">
...
export const Minimal: Story = {
  ...
  render: (args: any) => (
    <div className="glass-min-glass-glass-h-screen glass-surface-subtle glass-glass-glass-p-8">
      <div className="max-w-4xl glass-glass-glass-mx-auto">
        <h1 className="glass-glass-glass-text-2xl glass-glass-glass-font-bold glass-text-secondary mb-8">
          Minimal Voice Control
        </h1>

        <div className="glass-glass-glass-p-6 glass-surface-subtle glass-radius-xl glass-glass-glass-border glass-glass-glass-border-subtle glass-glass-glass-shadow-sm">
          <h3 className="glass-glass-glass-text-lg glass-glass-glass-font-semibold glass-text-secondary glass-glass-glass-mb-4">
            Clean Interface
          </h3>
