...
export const Default: Story = {
  args: {
    ...
    children: (
      <div className="glass-glass-text-primary">
        <h3 className="glass-glass-text-lg glass-glass-font-semibold glass-glass-mb-2">Liquid Glass</h3>
...
export const HighIOR: Story = {
  args: {
    ...
    children: (
      <div className="glass-glass-text-primary">
        <h3 className="glass-glass-text-lg glass-glass-font-semibold glass-glass-mb-2">High IOR Glass</h3>
        <p className="glass-glass-text-sm opacity-80">
...
export const UltraClear: Story = {
  args: {
    ...
    children: (
      <div className="glass-glass-text-primary">
        <h3 className="glass-glass-text-lg glass-glass-font-semibold glass-glass-mb-2">Ultra Clear</h3>
        <p className="glass-glass-text-sm opacity-80">
...
export const Interactive: Story = {
  args: {
    ...
    children: (
      <div className="glass-glass-text-primary">
        <h3 className="glass-glass-text-lg glass-glass-font-semibold glass-glass-mb-2">Interactive Surface</h3>
        <p className="glass-glass-text-sm opacity-80">
...
export const QualityComparison: Story = {
  render: () => (
    <div className="glass-glass-grid glass-glass-glass-grid-cols-2 glass-glass-gap-6 glass-glass-p-6">
      {(['ultra', 'high', 'balanced', 'efficient'] as const).map((quality) => (
        <LiquidGlassMaterial
          ...
          environmentAdaptation
          motionResponsive
          className="w-48 h-32 glass-glass-p-4"
        >
          <div className="glass-glass-text-primary">
            <h4 className="glass-glass-font-medium glass-glass-mb-1 glass-glass-capitalize">{quality} Quality</h4>
            <p className="glass-glass-text-xs opacity-70">
...
export const MaterialVariants: Story = {
  render: () => (
    <div className="glass-glass-grid glass-glass-glass-grid-cols-2 glass-glass-gap-6 glass-glass-p-6">
      ...
      >
        <div className="glass-glass-text-primary">
          <h4 className="glass-glass-font-medium glass-glass-mb-1">Regular Variant</h4>
          <p className="glass-glass-text-xs opacity-70">
      ...
      >
        <div className="glass-glass-text-primary">
          <h4 className="glass-glass-font-medium glass-glass-mb-1">Clear Variant</h4>
          <p className="glass-glass-text-xs opacity-70">
...
export const ColorfulTints: Story = {
  render: () => (
    <div className="glass-glass-grid glass-glass-glass-grid-cols-3 glass-glass-gap-4 glass-glass-p-6">
      {[
        ...
        <LiquidGlassMaterial
          ...
          environmentAdaptation
          motionResponsive
          className="w-32 h-24 glass-glass-p-3"
        >
          <div className="glass-glass-text-primary glass-glass-text-center">
            <h5 className="glass-glass-text-sm glass-glass-font-medium">{name}</h5>
          </div>
        </LiquidGlassMaterial>
      ))}
    </div>
...
export const ThicknessVariations: Story = {
  render: () => (
    <div className="glass-glass-grid glass-glass-glass-grid-cols-4 glass-glass-gap-4 glass-glass-p-6">
      {[4, 8, 16, 32].map((thickness) => (
        ...
        >
          <div className="glass-glass-text-primary glass-glass-text-center">
            <h5 className="glass-glass-text-sm glass-glass-font-medium">{thickness}px</h5>
            <p className="glass-glass-text-xs opacity-70">thickness</p>
          </div>
        </LiquidGlassMaterial>
      ))}
    </div>
...
export const Playground: Story = {
  args: {
    ...
    children: (
      <div className="glass-glass-text-primary glass-glass-h-full glass-glass-flex glass-glass-flex-col glass-glass-justify-between">
        <div>
          <h2 className="glass-glass-text-xl font-bold glass-glass-mb-3">Liquid Glass Playground</h2>
