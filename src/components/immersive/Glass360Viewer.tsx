    ...
    const renderControls = () => {
      ...
      return (
        <OptimizedGlass
          ...
          tint="neutral"
          border="subtle"
          className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex items-center glass-gap-2 glass-px-4 glass-py-2 glass-radius-lg backdrop-blur-md border border-border/20"
        >
          {controls.autoRotate && (
            <button
          ...
          >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                {loadingComponent || (
                  <div className="flex flex-col items-center glass-gap-4">
                    ...
                    <div className="glass-text-sm glass-text-secondary">Loading 360° media...</div>
                  </div>
                )}
              </div>
            )}
            ...
            {debug && !isLoading && !hasError && (
              <OptimizedGlass
                ...
                tint="neutral"
                border="subtle"
                className="absolute top-4 left-4 glass-p-3 glass-radius-lg backdrop-blur-md border border-border/20"
              >
            ...
            <button
              ...
              className="absolute top-4 right-4 glass-p-2 glass-radius-full bg-background/20 hover:bg-background/40 transition-all"
