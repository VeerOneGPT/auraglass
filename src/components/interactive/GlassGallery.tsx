...
export const GlassGallery: React.FC<GlassGalleryProps> = ({
    ...
    const renderGridLayout = () => (
        <div className={cn('grid glass-gap-4', getGridColumnsClass())}>
            {filteredImages.map((image, index) => (
                <div
                    key={image.id}
                    className="group glass-glass-relative animate-fade-in"
                    style={{ 
                ...
                >
                    ...
                    >
                        <CardContent className="glass-glass-p-0">
                            <div className="glass-glass-relative overflow-hidden">
                                <img
                                    src={image.thumbnail || image.src}
                                    alt={image.alt || image.title}
                                    className="glass-glass-w-full glass-glass-h-full object-cover transition-transform duration-300 group-hover:scale-105"
                                    loading="lazy"
                                />

                                {/* Selection Indicator */}
                                {enableSelection && (
                                    <div className="glass-glass-absolute glass--glass--glassglass--top-2 left-2">
                                        <div className={cn(
                                ...
                                <div className="glass-glass-absolute glass-glass-inset-0 glass-surface-dark/0 group-hover:glass-surface-dark/40 transition-all duration-200">
                                    <div className="glass-glass-absolute glass-glass-inset-0 glass-glass-flex glass-glass-items-center glass-glass-justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            {showActions && (
                                                <>
                                                    <GlassButton
                                                        ...
                                                        className="glass-glass-p-2"
                                                    >
                                                        <Heart className="glass-glass-w-4 glass-glass-h-4" />
                                                    </GlassButton>
                                ...
                                {showInfo && image.title && (
                                    <div className="glass-glass-absolute bottom-0 left-0 right-0 glass-glass-p-3 bg-gradient-to-t from-black/80 to-transparent">
                                        <h3 className="glass-glass-text-primary glass-glass-font-medium glass-glass-text-sm glass-glass-truncate">
                                            {image.title}
                                        </h3>
                                        {image.description && (
                                            <p className="glass-glass-text-primary/80 glass-glass-text-xs glass-mt-1 line-clamp-2">
                                                {image.description}
                                            </p>
                                        )}
                                    </div>
                            ...
                            {(image.likes || image.views || image.tags) && (
                                <div className="glass-glass-p-3 glass-glass-border-t glass-glass-border-white/10">
                                    <div className="glass-glass-flex glass-glass-items-center glass-glass-justify-between glass-glass-text-xs glass-glass-text-primary/60">
            ...
            {filteredImages.map((image, index) => (
                ...
                >
                    <GlassCard
                        ...
                        interactive
                        onClick={(e) => handleImageClick(image, index)}
                        className="overflow-hidden glass-glass-cursor-pointer hover:scale-[1.01] transition-transform"
                    >
                        <CardContent className="glass-glass-p-0">
                            <div className="glass-glass-flex">
                                <div className="w-32 h-32 glass-glass-flex-shrink-0">
                                    <img
                                        src={image.thumbnail || image.src}
                                        alt={image.alt || image.title}
                                ...
                                <div className="glass-glass-flex-1 glass-glass-p-4">
                                    <div className="glass-glass-flex glass-glass-items-start glass-glass-justify-between">
                                        <div className="glass-glass-flex-1">
                                            <h3 className="glass-glass-text-primary glass-glass-font-medium glass-glass-mb-1">
                                                {image.title}
                                            </h3>
                                            {image.description && (
                                                <p className="glass-glass-text-primary/70 glass-glass-text-sm glass-glass-mb-2">
                                                    {image.description}
                                                </p>
                                            )}

                                            <div className="glass-glass-flex glass-glass-items-center glass-glass-gap-4 glass-glass-text-xs glass-glass-text-primary/60">
                                                {image.likes && (
                                                    <span className="glass-glass-flex glass-glass-items-center glass-glass-gap-1">
                                                        <Heart className="w-3 h-3" />
                                                        {image.likes}
                                        ...
                                        {showActions && (
                                            <div className="glass-glass-flex glass-glass-gap-1 glass-ml-4">
                                                <GlassButton
                                                    variant="ghost"
                                                    size="sm"
                                                    onClick={(e) => {
                                    ...
                                    {image.tags && image.tags.length > 0 && (
                                        <div className="glass-glass-flex glass-glass-gap-1 mt-3">
    ...
    const renderLightbox = () => {
        ...
        return (
            <div className="glass-glass-fixed glass-glass-inset-0 glass-z-50 glass-surface-dark/90 glass-glass-flex glass-glass-items-center glass-glass-justify-center glass-glass-p-4">
                <div className="glass-glass-relative max-w-4xl max-glass-glass-h-full">
                    {/* Close Button */}
                    <GlassButton
                        variant="secondary"
                        size="sm"
                        onClick={(e) => setLightboxIndex(null)}
                        className="glass-glass-absolute top-4 right-4 glass-z-10"
                    >
                    ...
                    {images.length > 1 && (
                        <>
                            <GlassButton
                                ...
                                className="glass-glass-absolute left-4 glass--glass-top-1/2 transform -translate-y-1/2"
                            >
                            ...
                            <GlassButton
                                ...
                                className="glass-glass-absolute right-4 glass--glass-top-1/2 transform -translate-y-1/2"
                            >
                    ...
                    {image && (image.title || image.description) && (
                        <div className="glass-mt-4 glass-glass-text-center">
                            {image.title && (
                                <h3 className="glass-glass-text-primary glass-glass-text-lg glass-glass-font-medium glass-glass-mb-1">
                                    {image.title}
                                </h3>
                            )}
                            {image.description && (
            ...
            <div className={cn('glass-auto-gap glass-auto-gap-2xl', className)} {...props}>
                    ...
                    <div className="glass-glass-flex glass-glass-items-center glass-glass-gap-4">
                        {showFilters && categories.length > 0 && (
                            <select
                                ...
                                className="bg-glass-fill ring-1 ring-white/10 glass-radius-md glass-glass-px-3 glass-glass-py-1 glass-glass-text-sm glass-glass-text-primary focus:outline-none focus:ring-white/30"
                            >
                ...
                {filteredImages.length === 0 ? (
                    <div className="glass-glass-text-center glass-glass-py-12">
                        <div className="glass-glass-text-primary/60 glass-glass-mb-4">
                            <Grid3X3 className="glass-glass-w-12 glass-glass-h-12 mx-auto" />
                        </div>
