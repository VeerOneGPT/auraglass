      ...
      {editing ? (
        <>
          <input
            ...
            className="glass-glass-bg-transparent glass-glass-border glass-glass-border-white/20 glass-radius-lg glass-glass-px-2 glass-glass-py-1 glass-glass-text-sm outline-none"
          />
        ...
        <button className="glass-glass-px-2 glass-glass-py-1 glass-radius-lg hover:glass-surface-subtle/10 glass-glass-text-sm" onClick={(e) => setEditing(true)}>
          {value || <span className="glass-glass-text-primary/60">{placeholder}</span>}
        </button>
      )}
    </div>
  );
