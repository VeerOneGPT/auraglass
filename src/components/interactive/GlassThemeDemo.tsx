...
export const GlassThemeDemo = forwardRef<HTMLDivElement, GlassThemeDemoProps>(
  (
    ...
    const categoryExamples = {
      inputs: (
        <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-2 lg:glass-glass-glass-grid-cols-3 glass-glass-gap-6 glass-mt-4">
          <Card className={cn(
            'p-5 h-full flex flex-col',
            'transition-all duration-200',
            !prefersReducedMotion && 'hover:scale-[1.02]'
          )}>
            <Typography variant="h6" className="glass-glass-mb-4 glass-glass-font-semibold">Button</Typography>
            ...
            {showCode && (
              <pre className="glass-surface-dark/10 glass-radius-md glass-glass-p-3 font-mono glass-glass-text-sm glass-glass-overflow-auto glass-mt-4">
...
<Button variant="text">Text</Button>`}
          ...
          <Card className={cn(
            ...
            <Typography variant="h6" className="glass-glass-mb-4 glass-glass-font-semibold">Text Field</Typography>
            <Box style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
...
<TextField label="Disabled" disabled />`}
          ...
          <Card className={cn(
            ...
            <Typography variant="h6" className="glass-glass-mb-4 glass-glass-font-semibold">Select</Typography>
            <Select
...
/>`}
          ...
          <Card className={cn(
            ...
            <Typography variant="h6" className="glass-glass-mb-4 glass-glass-font-semibold">Checkbox & Radio</Typography>
            <Box style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
...
<Switch label="Switch Option" />`}
          ...
          <Card className={cn(
            ...
            <Typography variant="h6" className="glass-glass-mb-4 glass-glass-font-semibold">Slider</Typography>
            <Slider defaultValue={50} aria-label="Slider" />
            {showCode && (
              <pre className="glass-surface-dark/10 glass-radius-md glass-glass-p-3 font-mono glass-glass-text-sm glass-glass-overflow-auto glass-mt-4">{`<Slider defaultValue={50} aria-label="Slider" />`}</pre>
            )}
          </Card>
        </div>
      ),
      ...
      feedback: (
        <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-2 lg:glass-glass-glass-grid-cols-3 glass-glass-gap-6 glass-mt-4">
          <Card className={cn(
            ...
            <Typography variant="h6" className="glass-glass-mb-4 glass-glass-font-semibold">Alert</Typography>
            <Box style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
...
<Alert severity="error">Error message</Alert>`}
          ...
          <Card className={cn(
            ...
            <Typography variant="h6" className="glass-glass-mb-4 glass-glass-font-semibold">Progress</Typography>
...
<Progress variant="indeterminate" />`}
          ...
          <Card className={cn(
            ...
            <Typography variant="h6" className="glass-glass-mb-4 glass-glass-font-semibold">Badge</Typography>
      ...
      layout: (
        <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-2 lg:glass-glass-glass-grid-cols-3 glass-glass-gap-6 glass-mt-4">
          <Card className={cn(
            ...
            <Typography variant="h6" className="glass-glass-mb-4 glass-glass-font-semibold">Card</Typography>
            <Card>
    ...
    <Box mt={2}>
      <Button size="small">Action</Button>
          ...
          <Card className={cn(
            ...
            <Typography variant="h6" className="glass-glass-mb-4 glass-glass-font-semibold">Paper Card</Typography>
            <Card>
              <Box style={{ padding: '16px' }}>
  ...
  <Box p={2}>
    <Typography>Paper Component</Typography>
          ...
          <Card className={cn(
            ...
            <Typography variant="h6" className="glass-glass-mb-4 glass-glass-font-semibold">Box Layout</Typography>
            <Box>
      ...
      navigation: (
        <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-2 lg:glass-glass-glass-grid-cols-3 glass-glass-gap-6 glass-mt-4">
          <Card className={cn(
            ...
            <Typography variant="h6" className="glass-glass-mb-4 glass-glass-font-semibold">Tabs</Typography>
      ...
      display: (
        <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-2 lg:glass-glass-glass-grid-cols-3 glass-glass-gap-6 glass-mt-4">
          <Card className={cn(
            ...
            <Typography variant="h6" className="glass-glass-mb-4 glass-glass-font-semibold">Typography</Typography>
            <Box style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
...
<Typography variant="caption">Caption text</Typography>`}
          ...
          <Card className={cn(
            ...
            <Typography variant="h6" className="glass-glass-mb-4 glass-glass-font-semibold">Chip</Typography>
...
<Chip label="With Avatar">`}
          ...
          <Card className={cn(
            ...
            <Typography variant="h6" className="glass-glass-mb-4 glass-glass-font-semibold">Avatar</Typography>
...
<Avatar alt="User" />`}
    ...
    return (
      ...
      >
        ...
        <header className="glass-glass-mb-4">
          {header || (
            <>
