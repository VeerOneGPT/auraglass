            ...
            >
                <CardContent className="glass-glass-p-0">
                    ...
                    >
                        ...
                        {/* Error State */}
                        {imageError && (
                            <div className="glass-glass-absolute glass-glass-inset-0 glass-glass-flex glass-glass-flex-col glass-glass-items-center glass-glass-justify-center glass-glass-text-primary/60">
                                <X className="glass-glass-w-12 glass-glass-h-12 glass-glass-mb-4" />
                        ...
                        {showImageInfo && currentImage.title && (
                            <div className="glass-glass-absolute bottom-0 left-0 right-0 glass-surface-dark/50 backdrop-blur-md glass-glass-p-4">
                                <h3 className="glass-glass-text-primary glass-glass-font-medium">{currentImage.title}</h3>
                                {currentImage.description && (
                                    <p className="glass-glass-text-primary/80 glass-glass-text-sm glass-mt-1">{currentImage.description}</p>
                                )}
                            </div>
                        )}
                    </div>
                    ...
                    {/* Controls Overlay */}
                    <div className="glass-glass-absolute top-4 left-4 right-4 glass-glass-flex glass-glass-justify-between glass-glass-items-start">
                        {/* Left Controls */}
                        <div className="glass-glass-flex glass-glass-items-center glass-glass-gap-2">
                            {enableNavigation && images.length > 1 && (
                                <>
                                    ...
                                    <span className="glass-glass-text-primary/80 glass-glass-text-sm glass-glass-px-2">
                            ...
                            {enableZoom && showZoomControls && (
                                <>
                                    <GlassButton
                                        ...
                                        className="glass-glass-p-2"
                                    >
                                        <ZoomOut className="glass-glass-w-4 glass-glass-h-4" />
                                    </GlassButton>

                                    <span className="glass-glass-text-primary/80 glass-glass-text-sm glass-glass-px-2 glass-glass-min-glass-w-16 glass-glass-text-center">
                                        {Math.round(zoom * 100)}%
                                    </span>
                            ...
                            {enableRotation && showRotationControls && (
                                <>
                                    ...
                                    <GlassButton
                                        ...
                                        className="glass-glass-p-2"
                                    >
                                        <RotateCw className="glass-glass-w-4 glass-glass-h-4" />
                                    </GlassButton>
                                </>
                            )}
                    ...
                    {enableNavigation && images.length > 1 && (
                        <div className="glass-glass-absolute bottom-4 left-1/2 transform -translate-x-1/2">
                            <div className="glass-glass-flex glass-glass-items-center glass-glass-gap-2 glass-surface-dark/50 backdrop-blur-md glass-radius-full glass-glass-px-4 glass-glass-py-2">
                                <GlassButton
                                    variant="ghost"
                                    size="sm"
                    ...
                    {(zoom !== 1 || rotation !== 0 || pan.x !== 0 || pan.y !== 0) && (
                        <div className="glass-glass-absolute glass--glass-top-1/2 left-4 transform -translate-y-1/2">
                            <GlassButton
                                variant="secondary"
                                size="sm"
                                onClick={(e) => {
