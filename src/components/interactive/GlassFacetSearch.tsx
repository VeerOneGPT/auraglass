...
const GlassFacetSearch = React.forwardRef<HTMLDivElement, GlassFacetSearchProps>(
    ({
        ...
        return (
            ...
            >
                {/* Search Input */}
                <div className="glass-glass-relative glass-glass-mb-4">
                    <GlassInput
                        value={query}
                        onChange={handleQueryChange}
                        onKeyDown={handleKeyDown}
                        placeholder={placeholder}
                        className="glass-glass-w-full pr-12"
                        leftIcon={<Search className="glass-glass-w-4 glass-glass-h-4" />}
                    />
                    <div className="glass-glass-absolute right-3 glass--glass-top-1/2 -translate-y-1/2 glass-glass-flex glass-glass-items-center glass-glass-gap-2">
                        {loading && (
                        ...
                        {query && (
                            <button
                                ...
                                className="glass-glass-text-primary/70 hover:glass-glass-text-primary transition-colors"
                            >
                        ...
                        {showFilters && (
                            ...
                            >
                                <SlidersHorizontal className="glass-glass-w-4 glass-glass-h-4" />
                            </GlassButton>
                        )}
                    </div>
                    ...
                    <AnimatePresence>
                        {showSuggestions && (suggestions.length > 0 || recentSearches.length > 0) && (
                            <motion.div
                                ...
                                exit={{ opacity: 0, y: -10 }}
                                className="glass-glass-absolute top-full left-0 right-0 glass-mt-1 glass-z-10 max-h-60 glass-glass-overflow-y-auto"
                            >
                                <OptimizedGlass elevation={'level2'} className="glass-radius-lg overflow-hidden glass-glass-shadow-lg">
                                {suggestions.length > 0 && (
                                    <div className="glass-glass-p-2">
                                        <div className="glass-glass-text-xs glass-glass-text-primary/70 glass-glass-px-2 glass-glass-py-1">Suggestions</div>
                                        {suggestions.map((suggestion, index) => (
                                            <button
                                                ...
                                                className="glass-glass-w-full glass-glass-text-left glass-glass-px-2 glass-glass-py-1 glass-glass-text-sm glass-glass-text-primary hover:glass-surface-subtle/10 glass-radius-md transition-colors"
                                            >
                                                {suggestion}
                                            </button>
                                        ))}
                                ...
                                {recentSearches.length > 0 && (
                                    <div className="glass-glass-p-2 glass-glass-border-t glass-glass-border-white/10">
                                        <div className="glass-glass-text-xs glass-glass-text-primary/70 glass-glass-px-2 glass-glass-py-1">Recent Searches</div>
                ...
                <AnimatePresence>
                    {showFacetPanel && showFilters && (
                        <motion.div
                            ...
                            className="mb-6 glass-glass-border glass-glass-border-white/20 glass-radius-lg overflow-hidden"
                        >
                            <div className="glass-glass-p-4">
                                <div className="glass-glass-flex glass-glass-items-center glass-glass-justify-between glass-glass-mb-4">
                                    <h3 className="glass-glass-font-semibold glass-glass-text-primary glass-glass-flex glass-glass-items-center glass-glass-gap-2">
                ...
                {showResults && (
                    <div className="glass-auto-gap glass-auto-gap-sm">
                        <div className="glass-glass-flex glass-glass-items-center glass-glass-justify-between">
                            <h3 className="glass-glass-font-semibold glass-glass-text-primary">
                                Results {results.length > 0 && `(${results.length})`}
                            </h3>
                            {results.length > maxResults && (
                                <span className="glass-glass-text-sm glass-glass-text-primary/70">
                        ...
                        <AnimatePresence>
                            {loading ? (
                                <motion.div
                                    ...
                                    animate={{ opacity: 1 }}
                                    exit={{ opacity: 0 }}
                                    className="glass-glass-flex glass-glass-items-center glass-glass-justify-center glass-glass-py-8"
                                >
                                    <div className="glass-glass-w-6 glass-glass-h-6 glass-glass-border-2 glass-glass-border-white/30 glass-glass-border-t-white glass-radius-full animate-spin" />
                                </motion.div>
                                ...
                                >
                                    {displayedResults.map((result, index) => (
                                        <motion.div
                                            ...
                                            className="glass-glass-p-3 glass-surface-dark/20 hover:glass-surface-dark/30 glass-radius-lg glass-glass-cursor-pointer transition-all duration-200 hover:-translate-y-0.5 ring-1 ring-white/10 hover:ring-white/20 glass-glass-border glass-glass-border-white/10 hover:glass-glass-border-white/20"
                                        ...
                                        >
                                            <div className="glass-glass-flex glass-glass-items-start glass-glass-justify-between">
                                                <div className="glass-glass-flex-1">
                                                    <h4 className="glass-glass-font-medium glass-glass-text-primary">{result.title}</h4>
                                                    {result.description && (
                                                        <p className="glass-glass-text-sm glass-glass-text-primary/70 glass-mt-1">{result.description}</p>
                                                    )}
                                                    <div className="glass-glass-flex glass-glass-items-center glass-glass-gap-2 glass-mt-2">
                                                        {result.category && (
                                                            <span className="glass-glass-px-2 glass-glass-py-1 glass-glass-text-xs glass-surface-subtle/10 glass-glass-text-primary/80 glass-radius-md">
                                                                {result.category}
                                                            </span>
                                                        )}
                                                        {result.tags && result.tags.map((tag, tagIndex) => (
                                                            <span key={tagIndex} className="glass-glass-flex glass-glass-items-center glass-glass-gap-1 glass-glass-px-2 glass-glass-py-1 glass-glass-text-xs glass-surface-blue/20 text-blue-300 glass-radius-md">
                                ...
                                <motion.div
                                    ...
                                    animate={{ opacity: 1 }}
                                    exit={{ opacity: 0 }}
                                    className="glass-glass-text-center glass-glass-py-8 glass-glass-text-primary/70"
                                >
...
const FacetGroup: React.FC<FacetGroupProps> = ({
    ...
    return (
        <div className="glass-glass-border glass-glass-border-white/10 glass-radius-lg overflow-hidden">
            <button
                onClick={onToggle}
            ...
            >
                <span className="glass-glass-font-medium glass-glass-text-primary">{facet.label}</span>
                {expanded ? (
            ...
            <AnimatePresence>
                {expanded && (
                    <motion.div
                        ...
                        animate={{ opacity: 1, height: 'auto' }}
                        exit={{ opacity: 0, height: 0 }}
                        className="glass-glass-px-3 pb-3"
                    >
                        <FacetContent
                            facet={facet}
                            value={value}
