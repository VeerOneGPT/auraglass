    ...
    examples: [
      {
        ...
        category: 'buttons',
        component: ({ children }) => <button className="px-4 py-2 bg-blue-500 text-white rounded">{children || 'Button'}</button>,
    ...
    examples: [
      {
        ...
        category: 'buttons',
        component: ({ children }) => <button className="px-4 py-2 bg-green-500 text-white rounded">{children || 'Primary'}</button>,
      ...
      },
      {
        ...
        category: 'buttons',
        component: ({ children }) => <button className="px-4 py-2 bg-gray-500 text-white rounded">{children || 'Secondary'}</button>,
