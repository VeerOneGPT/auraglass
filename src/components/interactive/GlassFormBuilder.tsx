  ...
  (
    ...
    const renderFieldComponent = (field: FormField) => {
      ...
      switch (field.type) {
        ...
        case 'checkbox':
          return (
            <label className="glass-glass-flex glass-glass-items-center glass-glass-gap-3 glass-glass-cursor-pointer">
            ...
            <div className="glass-auto-gap glass-auto-gap-sm">
              ...
              <div className="glass-auto-gap glass-auto-gap-sm">
                {field.options?.map((option) => (
                  <label key={option.value} className="glass-glass-flex glass-glass-items-center glass-glass-gap-3 glass-glass-cursor-pointer">
                    <GlassInput type="radio"
                      ...
                      onChange={(e: any) => handleValueChange(field.id, e.target.value)}
                      disabled={isDisabled}
                      className="glass-glass-border-glass-glass-border focus:ring-primary"
                    />
                    <span className="glass-glass-text-sm">{option.label}</span>
                  </label>
                ))}
              </div>
            </div>
      ...
      >
        ...
        {(title || description || showProgress) && (
          <div className="mb-6">
            ...
            {description && (
              <p className="glass-text-secondary glass-glass-mb-4">{description}</p>
            )}

            {showProgress && (
              <div className="glass-glass-flex glass-glass-items-center glass-glass-gap-4">
                <div className="glass-glass-flex-1 bg-muted/30 glass-radius-full h-2">
                  <div
              ...
              <GlassCard variant="default" className="glass-glass-p-6">
                ...
                >
                  <div>
                    ...
                    {section.description && (
                      <p className="glass-glass-text-sm glass-text-secondary glass-mt-1">
                        {section.description}
                      </p>
                    )}
                  </div>
                ...
                {(!section.collapsible || expandedSections.has(section.id)) && (
                  <div className="glass-glass-grid glass-glass-glass-grid-cols-12 glass-glass-gap-4">
                    {section.fields
                      ...
                      ?.map((field) => (
                        ...
                        >
                          ...
                          {field.description && (
                            <p className="glass-glass-text-xs glass-text-secondary glass-mt-1">
                              {field.description}
                            </p>
                          )}
                        </div>
        ...
        {/* Form actions */}
        <div className="glass-glass-flex glass-glass-items-center glass-glass-justify-end glass-glass-gap-3 mt-8">
          {autoSave && (
