  ...
  ({
    ...
    const StyleLibrary = () => (
      <div className="glass-glass-glass-space-y-4">
        <h4 className="glass-glass-glass-text-sm glass-glass-glass-font-medium glass-glass-glass-text-primary/80">Style Library</h4>
        <div className="glass-glass-glass-grid glass-glass-glass-glass-glass-grid-cols-2 md:glass-glass-glass-glass-glass-grid-cols-3 glass-glass-glass-gap-3">
          {styleModels.map((style) => (
            ...
            >
              <div className="aspect-square glass-gradient-primary glass-gradient-primary glass-gradient-primary glass-radius-lg glass-glass-glass-mb-2 overflow-hidden">
                <div className={`
              ...
              <div className="glass-glass-glass-text-xs glass-glass-glass-text-primary/90 glass-glass-glass-font-medium glass-glass-glass-mb-1">
                {style.name}
              </div>
    ...
    const AdvancedControls = () => (
      <div className="glass-glass-glass-space-y-4">
        <h4 className="glass-glass-glass-text-sm glass-glass-glass-font-medium glass-glass-glass-text-primary/80">Advanced Controls</h4>
        ...
        <div className="glass-glass-glass-grid glass-glass-glass-glass-glass-grid-cols-1 md:glass-glass-glass-glass-glass-grid-cols-2 glass-glass-glass-gap-4">
          <div>
            <label className="glass-glass-glass-block glass-glass-glass-text-xs glass-glass-glass-text-primary/70 glass-glass-glass-mb-2">
            ...
            <input
              ...
              className="glass-glass-glass-w-full glass-glass-glass-h-2 glass-surface-subtle/20 glass-radius-lg appearance-none glass-glass-glass-cursor-pointer slider"
            />
          </div>

          <div>
            <label className="glass-glass-glass-block glass-glass-glass-text-xs glass-glass-glass-text-primary/70 glass-glass-glass-mb-2">Resolution</label>
            <select
          ...
          <div>
            <label className="glass-glass-glass-block glass-glass-glass-text-xs glass-glass-glass-text-primary/70 glass-glass-glass-mb-2">Blend Mode</label>
            <select
        ...
        <div className="glass-glass-glass-flex glass-glass-glass-items-center space-x-6">
          <label className="glass-glass-glass-flex glass-glass-glass-items-center space-x-2 glass-glass-glass-cursor-pointer">
            <input
              type="checkbox"
              ...
              className="glass-glass-glass-w-4 glass-glass-glass-h-4 glass-radius glass-glass-glass-border-white/30"
            />
            <span className="glass-glass-glass-text-sm glass-glass-glass-text-primary/80">Preserve Colors</span>
          </label>
          ...
          <label className="glass-glass-glass-flex glass-glass-glass-items-center space-x-2 glass-glass-glass-cursor-pointer">
            <input
              ...
              className="glass-glass-glass-w-4 glass-glass-glass-h-4 glass-radius glass-glass-glass-border-white/30"
            />
            <span className="glass-glass-glass-text-sm glass-glass-glass-text-primary/80">Enhance Details</span>
          </label>
        </div>
      </div>
    )
    ...
    return (
      ...
      >
          ...
          <div className="glass-glass-glass-flex glass-glass-glass-items-center space-x-2">
            {realTimePreview && (
              <div className="glass-glass-glass-flex glass-glass-glass-items-center space-x-1 glass-glass-glass-text-primary">
                ...
                <span className="glass-glass-glass-text-xs">Real-time</span>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="glass-glass-glass-grid glass-glass-glass-glass-glass-grid-cols-1 lg:glass-glass-glass-glass-glass-grid-cols-2 glass-glass-glass-gap-6">
          {/* Source image */}
          <div className="glass-glass-glass-space-y-4">
            <h4 className="glass-glass-glass-text-sm glass-glass-glass-font-medium glass-glass-glass-text-primary/80">Source Image</h4>
            
            <div 
              className="glass-glass-glass-relative aspect-square glass-surface-subtle/5 glass-glass-glass-border-2 glass-glass-glass-border-dashed glass-glass-glass-border-white/30 glass-radius-lg overflow-hidden glass-glass-glass-cursor-pointer hover:glass-glass-glass-border-white/50 transition-colors"
            ...
            >
              {uploadedImage ? (
                ...
                <div className="glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-justify-center glass-glass-glass-h-full glass-glass-glass-text-primary/50">
                  <div className="glass-glass-glass-text-center">
                    <div className="glass-glass-glass-text-4xl glass-glass-glass-mb-2">📷</div>
                    <p>Click to upload image</p>
                    <p className="glass-glass-glass-text-xs mt-1">PNG, JPG up to 10MB</p>
                  </div>
                </div>
              )}
          ...
          <div className="glass-glass-glass-space-y-4">
            <div className="glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-justify-between">
              <h4 className="glass-glass-glass-text-sm glass-glass-glass-font-medium glass-glass-glass-text-primary/80">Style Preview</h4>
              {isProcessing && showProgressIndicator && (
                <div className="glass-glass-glass-flex glass-glass-glass-items-center space-x-2 glass-glass-glass-text-primary">
                  ...
                  <span className="glass-glass-glass-text-xs">{Math.round(progress)}%</span>
                </div>
              )}
            </div>
            
            <div className="glass-glass-glass-relative aspect-square glass-surface-subtle/5 glass-glass-glass-border glass-glass-glass-border-white/20 glass-radius-lg overflow-hidden">
              {previewImage ? (
                <img 
                  src={previewImage} 
                  alt="Styled preview" 
              ...
              {/* Processing overlay */}
              {isProcessing && (
                <div className="glass-glass-glass-absolute glass-glass-glass-inset-0 glass-surface-dark/50 glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-justify-center">
                  <div className="glass-glass-glass-text-center glass-glass-glass-text-primary">
                    <div className="glass-glass-glass-w-8 glass-glass-glass-h-8 glass-glass-glass-border-2 glass-glass-glass-border-white glass-glass-glass-border-t-transparent glass-radius-full animate-spin glass-glass-glass-mx-auto glass-glass-glass-mb-2" />
                    <div className="glass-glass-glass-text-sm">Processing...</div>
                    <div className="glass-glass-glass-text-xs mt-1">{Math.round(progress)}% complete</div>
                  </div>
                </div>
              )}
            </div>
        ...
        <div className="glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-justify-between pt-4 glass-glass-glass-border-t glass-glass-glass-border-white/10">
          <div className="glass-glass-glass-flex glass-glass-glass-items-center space-x-4">
            <motion.button
              className="glass-glass-glass-px-4 glass-glass-glass-py-2 glass-surface-blue hover:glass-surface-blue glass-glass-glass-text-primary glass-radius-lg glass-glass-glass-text-sm glass-glass-glass-font-medium transition-colors"
              whileHover={shouldAnimate ? { scale: 1.02 } : {}}
              whileTap={shouldAnimate ? { scale: 0.98 } : {}}
          ...
          {previewImage && (
            <motion.a
              ...
              className="glass-glass-glass-px-4 glass-glass-glass-py-2 glass-surface-green hover:glass-surface-green glass-glass-glass-text-primary glass-radius-lg glass-glass-glass-text-sm glass-glass-glass-font-medium transition-colors"
              whileHover={shouldAnimate ? { scale: 1.02 } : {}}
              whileTap={shouldAnimate ? { scale: 0.98 } : {}}
            >
              Download Result
        ...
        {isProcessing && showProgressIndicator && (
          ...
          `}>
            <div className="glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-justify-between glass-glass-glass-mb-2">
              <span className="glass-glass-glass-text-sm glass-glass-glass-text-primary/80">Processing Style Transfer</span>
              <span className="glass-glass-glass-text-sm glass-glass-glass-font-medium glass-glass-glass-text-primary">{Math.round(progress)}%</span>
            </div>
