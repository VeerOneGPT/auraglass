    ...
    return (
      <div className="space-y-8">
        <div className="glass-glass-glass-text-center glass-glass-glass-py-8 glass-gradient-primary glass-gradient-primary glass-gradient-primary glass-radius-xl">
          <h1 className="glass-glass-glass-text-3xl glass-glass-glass-font-bold glass-text-secondary glass-glass-glass-mb-4">🤖 AI-Powered Form Builder</h1>
          ...
          <div className="glass-glass-glass-grid glass-glass-glass-glass-glass-grid-cols-1 md:glass-glass-glass-glass-glass-grid-cols-4 glass-glass-glass-gap-6 mt-8 max-w-4xl glass-glass-glass-mx-auto">
            <div className="glass-glass-glass-text-center">
              ...
              <h3 className="glass-glass-glass-font-semibold">Smart Field Detection</h3>
              <p className="glass-glass-glass-text-sm glass-text-secondary mt-1">AI automatically suggests field types based on labels and context</p>
            </div>
            <div className="glass-glass-glass-text-center">
              ...
              <h3 className="glass-glass-glass-font-semibold">Validation Suggestions</h3>
              <p className="glass-glass-glass-text-sm glass-text-secondary mt-1">Intelligent validation rules and format requirements</p>
            </div>
            <div className="glass-glass-glass-text-center">
              ...
              <h3 className="glass-glass-glass-font-semibold">Accessibility First</h3>
              <p className="glass-glass-glass-text-sm glass-text-secondary mt-1">Built-in accessibility compliance and WCAG guidelines</p>
            </div>
            <div className="glass-glass-glass-text-center">
              <div className="glass-glass-glass-w-12 glass-glass-glass-h-12 glass-surface-primary glass-glass-glass-text-primary glass-radius-full glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-justify-center glass-glass-glass-mx-auto glass-glass-glass-mb-3">
                📊
              </div>
              <h3 className="glass-glass-glass-font-semibold">Performance Optimized</h3>
              <p className="glass-glass-glass-text-sm glass-text-secondary mt-1">Real-time performance monitoring and optimization</p>
            </div>
          </div>
        </div>
        ...
        {schema && (
          <div className="glass-surface-subtle glass-glass-glass-text-primary glass-glass-glass-p-6 glass-radius-lg font-mono glass-glass-glass-text-sm glass-glass-glass-overflow-auto">
            <h3 className="glass-glass-glass-text-primary glass-glass-glass-font-bold glass-glass-glass-mb-4">Generated Form Schema:</h3>
    ...
    return (
      <div className="space-y-8">
        <div className="glass-gradient-primary glass-gradient-primary glass-gradient-primary glass-glass-glass-text-primary glass-glass-glass-p-8 glass-radius-xl">
          <h2 className="glass-glass-glass-text-2xl glass-glass-glass-font-bold glass-glass-glass-mb-4">🚀 Advanced AI Features</h2>
          <div className="glass-glass-glass-grid glass-glass-glass-glass-glass-grid-cols-1 md:glass-glass-glass-glass-glass-grid-cols-2 lg:glass-glass-glass-glass-glass-grid-cols-3 glass-glass-glass-gap-6">
            <div>
              <h3 className="glass-glass-glass-font-semibold glass-glass-glass-mb-2">🎯 Purpose Detection</h3>
            ...
            <div>
              <h3 className="glass-glass-glass-font-semibold glass-glass-glass-mb-2">🧠 Field Intelligence</h3>
              <ul className="glass-glass-glass-text-sm space-y-1 glass-glass-glass-opacity-90">
            ...
            <div>
              <h3 className="glass-glass-glass-font-semibold glass-glass-glass-mb-2">📊 Optimization Engine</h3>
              <ul className="glass-glass-glass-text-sm space-y-1 glass-glass-glass-opacity-90">
        ...
        <div className="glass-surface-subtle glass-glass-glass-border-l-4 glass-glass-glass-border-yellow glass-glass-glass-p-6 glass-radius-r-lg">
          <h3 className="glass-glass-glass-font-semibold glass-glass-glass-text-primary glass-glass-glass-mb-2">💡 Pro Tips for AI Form Building</h3>
          <ul className="glass-glass-glass-text-sm glass-glass-glass-text-primary glass-glass-glass-space-y-2">
