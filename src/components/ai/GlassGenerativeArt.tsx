  ...
  ({
    ...
    const PromptLibrary = () => (
      <div className="glass-glass-glass-space-y-4">
        <h4 className="glass-glass-glass-text-sm glass-glass-glass-font-medium glass-glass-glass-text-primary/80">Prompt Library</h4>
        <div className="glass-glass-glass-grid glass-glass-glass-gap-2">
          {suggestions.map((suggestion) => (
            <motion.div
              key={suggestion.id}
              className="glass-glass-glass-p-3 glass-radius-lg glass-glass-glass-border glass-glass-glass-border-white/20 hover:glass-glass-glass-border-white/40 glass-surface-subtle/5 glass-glass-glass-cursor-pointer transition-colors"
            ...
            >
              <div className="glass-glass-glass-flex glass-glass-glass-items-start glass-glass-glass-justify-between">
                <div className="glass-glass-glass-flex-1">
                  <p className="glass-glass-glass-text-sm glass-glass-glass-text-primary/90 glass-glass-glass-mb-1">{suggestion.text}</p>
                  <div className="glass-glass-glass-flex glass-glass-glass-items-center space-x-2">
                    ...
                    {suggestion.tags.slice(0, 2).map(tag => (
                      <span key={tag} className="glass-glass-glass-px-1.5 glass-glass-glass-py-0.5 glass-surface-subtle/10 glass-glass-glass-text-primary/60 glass-radius glass-glass-glass-text-xs">
                        {tag}
                      </span>
                    ))}
                  </div>
    ...
    const AdvancedSettings = () => (
      <div className="glass-glass-glass-space-y-4">
        <h4 className="glass-glass-glass-text-sm glass-glass-glass-font-medium glass-glass-glass-text-primary/80">Generation Settings</h4>
        ...
        <div className="glass-glass-glass-grid glass-glass-glass-glass-glass-grid-cols-1 md:glass-glass-glass-glass-glass-grid-cols-2 glass-glass-glass-gap-4">
          <div>
            <label className="glass-glass-glass-block glass-glass-glass-text-xs glass-glass-glass-text-primary/70 glass-glass-glass-mb-2">Model</label>
            <select
          ...
          <div>
            <label className="glass-glass-glass-block glass-glass-glass-text-xs glass-glass-glass-text-primary/70 glass-glass-glass-mb-2">Style</label>
            <select
    ...
    return (
      ...
      >
        ...
        <div className="glass-glass-glass-space-y-4">
          <div>
            <label className="glass-glass-glass-block glass-glass-glass-text-sm glass-glass-glass-font-medium glass-glass-glass-text-primary/80 glass-glass-glass-mb-2">
            ...
            <textarea
              ...
              className="glass-glass-glass-w-full glass-glass-glass-h-24 glass-glass-glass-p-3 glass-surface-subtle/10 glass-glass-glass-border glass-glass-glass-border-white/20 glass-radius-lg glass-glass-glass-text-primary/90 placeholder-white/50 resize-none focus:outline-none focus:glass-glass-glass-border-blue"
            />
          </div>
          ...
          <div className="glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-justify-between">
            <div className="glass-glass-glass-flex glass-glass-glass-items-center space-x-4">
              <label className="glass-glass-glass-flex glass-glass-glass-items-center space-x-2 glass-glass-glass-cursor-pointer">
                ...
                />
                <span className="glass-glass-glass-text-sm glass-glass-glass-text-primary/80">Enhance Prompt</span>
              </label>
            </div>

            <motion.button
              className="glass-glass-glass-px-6 glass-glass-glass-py-2 glass-surface-blue hover:glass-surface-blue glass-glass-glass-text-primary glass-radius-lg glass-glass-glass-font-medium transition-colors disabled:opacity-50"
        ...
        {isGenerating && (
          ...
          `}>
            <div className="glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-justify-between glass-glass-glass-mb-2">
              <span className="glass-glass-glass-text-sm glass-glass-glass-text-primary/80">Generating artwork...</span>
        ...
        {generatedImages.length > 0 && (
          <div className="glass-glass-glass-space-y-4">
            <h4 className="glass-glass-glass-text-sm glass-glass-glass-font-medium glass-glass-glass-text-primary/80">Generated Artwork</h4>
        ...
        {showGenerationHistory && generationHistory.length > 0 && (
          <div className="glass-glass-glass-space-y-4">
            <h4 className="glass-glass-glass-text-sm glass-glass-glass-font-medium glass-glass-glass-text-primary/80">Recent Generations</h4>
            <div className="glass-glass-glass-space-y-2 glass-max-glass-glass-glass-h-64 glass-glass-glass-overflow-y-auto">
              {generationHistory.map((entry) => (
                <div
                  key={entry.id}
                  className="glass-glass-glass-flex glass-glass-glass-items-center space-x-3 glass-glass-glass-p-2 glass-radius-lg glass-surface-subtle/5 hover:glass-surface-subtle/10 glass-glass-glass-cursor-pointer transition-colors"
                  onClick={() => {
                ...
                >
                  <img 
                    src={entry.imageUrl} 
                    alt="Generated" 
                    className="glass-glass-glass-w-12 glass-glass-glass-h-12 glass-radius object-cover"
                  />
                  <div className="glass-glass-glass-flex-1 glass-glass-glass-min-glass-glass-w-0">
                    <p className="glass-glass-glass-text-sm glass-glass-glass-text-primary/90 glass-glass-glass-truncate">{entry.prompt}</p>
                    <div className="glass-glass-glass-flex glass-glass-glass-items-center space-x-2 mt-1">
