...
const meta: Meta<typeof GlassNavigationMenu> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Glass navigation menu presented in bounded app panels with readable active and nested states.",
      },
    },
  },
  argTypes: {
...
export const Default: Story = {
  render: (args) => (
    ...
    >
      <section
        className="glass-w-full glass-max-w-md glass-rounded-2xl glass-p-5 glass-shadow-xl glass-bg-white/25 glass-text-primary"
...
export const Variants: Story = {
  render: (args) => (
    ...
    >
      <div
        className="glass-grid glass-w-full glass-max-w-5xl glass-grid-cols-1 glass-gap-4 lg:glass-grid-cols-3"
      ...
      >
        {[
          ...
          <section
            key={label}
            className="glass-min-w-0 glass-rounded-2xl glass-p-4 glass-shadow-lg glass-bg-white/25 glass-text-primary"
          >
            <h3 className="glass-mb-3 glass-text-base glass-font-semibold glass-text-primary">
              {label}
            </h3>
            <GlassNavigationMenu
              {...args}
...
export const Collapsed: Story = {
  render: (args) => (
    ...
    >
      <section className="glass-rounded-2xl glass-p-4 glass-shadow-xl glass-bg-white/25 glass-text-primary">
        <GlassNavigationMenu
          {...args}
          className="glass-w-20 glass-rounded-xl glass-p-2"
        />
      </section>
    </div>
  ),
