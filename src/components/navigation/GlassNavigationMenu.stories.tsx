...
export const Variants: Story = {
  render: (args) => (
    <div className="space-y-8">
      ...
      <div>
        <h3 className="glass-glass-glass-text-lg glass-glass-glass-font-semibold glass-glass-glass-mb-4">Sidebar Variant</h3>
        <GlassNavigationMenu {...args} variant="sidebar" />
      </div>
      <div>
        <h3 className="glass-glass-glass-text-lg glass-glass-glass-font-semibold glass-glass-glass-mb-4">Header Variant</h3>
