  ...
  return (
    <AnimatePresence>
      {ripples.map(ripple => (
        ...
        >
          <OptimizedGlass intensity="medium" blur="strong" className="w-32 h-32 glass-radius-full glass-glass-border-2 glass-glass-border-white/30" />
        </motion.div>
      ))}
    </AnimatePresence>
  );
    ...
    <AnimatePresence>
      {Array.from({ length: particleCount }).map((_, i) => {
        ...
        return (
          ...
          >
            <div className="glass-glass-w-4 glass-glass-h-4 glass-radius-full glass-surface-primary" />
          </motion.div>
        );
      })}
    </AnimatePresence>
