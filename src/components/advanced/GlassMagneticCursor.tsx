  ...
  return (
    <>
      ...
      {variant === 'trail' && trail.map((point, index) => (
        <motion.div
          key={point.id}
          className="glass-glass-fixed glass-pointer-events-none z-[9998]"
        ...
        >
          <OptimizedGlass
            intensity="subtle"
            blur="subtle"
            className="glass-glass-w-full glass-glass-h-full glass-radius-full"
            style={{
              background: color,
      ...
      <AnimatePresence>
        {variant === 'ripple' && ripples.map(ripple => (
          <motion.div
            key={ripple.id}
            className="glass-glass-fixed glass-pointer-events-none z-[9997]"
          ...
          >
            <div
              className="w-20 h-20 glass-radius-full glass-glass-border-2"
              style={{
                borderColor: color,
              }}
            />
      ...
      {isHovering && targetElement && (
        <motion.div
          className="glass-glass-fixed glass-pointer-events-none z-[9996]"
        ...
        >
          <div className="glass-glass-w-full glass-glass-h-full glass-radius-lg glass-glass-border glass-glass-border-white/20" />
        </motion.div>
      )}
    </>
  );
