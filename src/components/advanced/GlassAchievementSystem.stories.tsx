  ...
  return (
    <div className="min-h-screen glass-glass-p-8 space-y-8">
      ...
      <div className="glass-glass-text-center glass-glass-gap-4">
        ...
        {/* XP Progress Bar */}
        {progress && (
          <div className="max-w-md mx-auto glass-glass-gap-2">
            ...
            <div className="glass-glass-flex glass-glass-justify-between glass-glass-text-xs glass-text-tertiary">
      ...
      <div className="space-y-6">
        ...
        {/* Special Actions */}
        <div className="glass-glass-text-center glass-glass-gap-4">
          <h3 className="glass-glass-text-xl glass-glass-font-medium glass-glass-text-primary">
            🎨 Special Actions
          </h3>
          <div className="glass-glass-flex glass-glass-justify-center glass-glass-gap-4">
            <button
              onClick={() => handleInteraction('customize')}
              className="glass-surface-secondary glass-elev-2 glass-radius-lg glass-glass-px-6 glass-glass-py-3 hover:glass-elev-3 transition-all duration-300"
            >
              🎨 Customize Theme
            </button>
      ...
      <div className="glass-surface-primary glass-elev-1 glass-radius-lg glass-glass-p-6">
        ...
        <div className="glass-glass-grid glass-glass-glass-grid-cols-2 md:glass-glass-glass-grid-cols-4 glass-glass-gap-4">
          <div className="glass-glass-text-center glass-surface-secondary glass-radius-md glass-glass-p-4">
            <div className="glass-glass-text-2xl font-bold glass-glass-text-primary">{actionCount}</div>
            <div className="glass-glass-text-sm glass-text-secondary">Actions</div>
          </div>
          <div className="glass-glass-text-center glass-surface-secondary glass-radius-md glass-glass-p-4">
            <div className="glass-glass-text-2xl font-bold glass-glass-text-primary">{progress?.stats.totalInteractions || 0}</div>
            <div className="glass-glass-text-sm glass-text-secondary">Total Interactions</div>
          </div>
          <div className="glass-glass-text-center glass-surface-secondary glass-radius-md glass-glass-p-4">
            <div className="glass-glass-text-2xl font-bold glass-glass-text-primary">{progress?.stats.componentsExplored.length || 0}</div>
            <div className="glass-glass-text-sm glass-text-secondary">Components</div>
          </div>
          <div className="glass-glass-text-center glass-surface-secondary glass-radius-md glass-glass-p-4">
            <div className="glass-glass-text-2xl font-bold glass-glass-text-primary">{Math.max(comboCount, progress?.stats.highestStreak || 0)}</div>
            <div className="glass-glass-text-sm glass-text-secondary">Best Combo</div>
          </div>
        </div>
      </div>
        ...
        <div className="glass-surface-primary glass-elev-1 glass-radius-lg glass-glass-p-6">
          ...
          <div className="glass-glass-gap-3">
            {recentNotifications.map((notification, index) => (
              <div 
                key={`recent-${index}`}
                className="glass-glass-flex glass-glass-items-center glass-glass-gap-4 glass-surface-secondary glass-radius-md glass-glass-p-3"
              >
                <div className="glass-glass-text-2xl">{notification.achievement.icon}</div>
      ...
      <div className="glass-surface-primary glass-elev-1 glass-radius-lg glass-glass-p-6">
        ...
        <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-2 lg:glass-glass-glass-grid-cols-3 glass-glass-gap-6">
          <div className="glass-glass-gap-3">
            <h4 className="glass-glass-text-lg glass-glass-font-medium glass-glass-text-primary">Quick Achievements</h4>
          ...
          <div className="glass-glass-gap-3">
            <h4 className="glass-glass-text-lg glass-glass-font-medium glass-glass-text-primary">Advanced Achievements</h4>
            <ul className="glass-glass-gap-1 glass-glass-text-sm glass-text-secondary">
          ...
          <div className="glass-glass-gap-3">
            <h4 className="glass-glass-text-lg glass-glass-font-medium glass-glass-text-primary">Hidden Achievements</h4>
            <ul className="glass-glass-gap-1 glass-glass-text-sm glass-text-secondary">
        ...
        <div className="glass-glass-grid glass-glass-glass-grid-cols-2 md:glass-glass-glass-grid-cols-4 glass-glass-gap-4">
          {['Action 1', 'Action 2', 'Action 3', 'Action 4'].map((action, i) => {
            ...
            return (
              <button
                key={action}
                className="glass-surface-primary glass-elev-2 glass-radius-lg glass-glass-p-6 glass-glass-text-center hover:glass-elev-3 transition-all duration-300"
                onClick={() => trackClick(`casual-action-${i}`)}
              >
                <div className="glass-glass-text-2xl glass-glass-mb-2">🎮</div>
                <div className="glass-glass-text-sm glass-glass-text-primary">{action}</div>
                <div className="glass-glass-text-xs glass-text-secondary">Casual XP</div>
              </button>
            );
          })}
        </div>
        
        <div className="glass-surface-primary glass-elev-1 glass-radius-lg glass-glass-p-6 glass-glass-text-center">
          <h3 className="glass-glass-text-lg glass-glass-font-medium glass-glass-text-primary glass-glass-mb-2">Casual Settings</h3>
          <div className="glass-glass-gap-1 glass-glass-text-sm glass-text-secondary">
  ...
  render: (args) => (
    <GlassAchievementProvider {...args}>
      <div className="min-h-screen glass-glass-p-8 space-y-8">
        ...
        <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-3 glass-glass-gap-6">
          {['Elite Challenge', 'Master Quest', 'Legendary Trial'].map((challenge, i) => {
            ...
            return (
              <button
                key={challenge}
                className="glass-surface-primary glass-elev-2 glass-radius-lg glass-glass-p-8 glass-glass-text-center hover:glass-elev-3 transition-all duration-300
                          glass-glass-border-2 glass-glass-border-red/30 hover:glass-glass-border-red/50"
                onClick={() => {
                  trackClick(`hardcore-challenge-${i}`);
                  recordAction('hardcore_action', { challenge, difficulty: 'extreme' });
                }}
              >
                <div className="glass-glass-text-3xl glass-glass-mb-4">⚔️</div>
                <h3 className="glass-glass-text-lg glass-glass-font-medium glass-glass-text-primary glass-glass-mb-2">{challenge}</h3>
                <p className="glass-glass-text-sm glass-text-secondary">
                  High difficulty challenge with reduced XP rewards
                </p>
                <div className="glass-glass-text-xs glass-text-tertiary glass-mt-2">
                  XP Multiplier: 0.5x
                </div>
              </button>
            );
        ...
        <div className="glass-surface-primary glass-elev-1 glass-radius-lg glass-glass-p-6">
          <h3 className="glass-glass-text-lg glass-glass-font-medium glass-glass-text-primary glass-glass-mb-4">Hardcore Features</h3>
          <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-2 glass-glass-gap-4">
            <div>
              <h4 className="glass-glass-text-sm glass-glass-font-medium glass-glass-text-primary glass-glass-mb-2">Challenges</h4>
              <ul className="glass-glass-gap-1 glass-glass-text-xs glass-text-secondary">
            ...
            <div>
              <h4 className="glass-glass-text-sm glass-glass-font-medium glass-glass-text-primary glass-glass-mb-2">Rewards</h4>
              <ul className="glass-glass-gap-1 glass-glass-text-xs glass-text-secondary">
  ...
  render: (args) => (
    <GlassAchievementProvider {...args}>
      <div className="min-h-screen glass-glass-p-8 space-y-8">
        ...
        <div className="glass-glass-grid glass-glass-glass-grid-cols-2 md:glass-glass-glass-grid-cols-3 glass-glass-gap-6">
        ...
        <div className="glass-surface-primary glass-elev-1 glass-radius-lg glass-glass-p-6 glass-glass-text-center">
          <h3 className="glass-glass-text-lg glass-glass-font-medium glass-glass-text-primary glass-glass-mb-2">Minimal Settings</h3>
          <div className="glass-glass-gap-1 glass-glass-text-sm glass-text-secondary">
  ...
  render: (args) => (
    <GlassAchievementProvider {...args}>
      <div className="min-h-screen glass-glass-p-8 space-y-8">
        ...
        <div className="glass-glass-grid glass-glass-glass-grid-cols-3 md:glass-glass-glass-grid-cols-6 glass-glass-gap-4">
            ...
            return (
              <button
                ...
                className="aspect-square glass-surface-primary glass-elev-2 glass-radius-lg 
                          hover:glass-elev-3 transition-all duration-300 glass-glass-flex glass-glass-items-center glass-glass-justify-center"
                onClick={() => {
  ...
  render: (args) => (
    <GlassAchievementProvider {...args}>
      <div className="min-h-screen glass-glass-p-8">
        <div className="glass-glass-text-center glass-glass-gap-4 mb-8">
          <h2 className="glass-glass-text-2xl font-bold glass-glass-text-primary">
            Achievement Dashboard
          </h2>
          <p className="glass-glass-text-sm glass-text-secondary">
        ...
        <div className="glass-glass-grid glass-glass-glass-grid-cols-2 md:glass-glass-glass-grid-cols-4 glass-glass-gap-4 mb-8">
          {Array.from({ length: 16 }, (_, i) => {
            const { trackClick } = useAchievementTracker();
            return (
              <button
                key={i}
                className="glass-surface-primary glass-elev-2 glass-radius-lg glass-glass-p-3 hover:glass-elev-3 transition-all duration-300"
                onClick={() => trackClick(`dashboard-test-${i}`)}
              >
                <div className="glass-glass-text-sm glass-glass-text-primary">Test {i + 1}</div>
              </button>
            );
          })}
        </div>
