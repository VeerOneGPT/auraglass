  ...
  return (
    <div className="min-h-screen p-8 space-y-8">
      ...
      <div className="text-center glass-gap-4">
        ...
        {/* XP Progress Bar */}
        {progress && (
          <div className="max-w-md mx-auto glass-gap-2">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 glass-gap-6">
          {[
            ...
            <button
              key={item.id}
              className="glass-surface-primary glass-elev-2 glass-radius-lg glass-p-6 text-center glass-gap-4 
        ...
        {/* Special Actions */}
        <div className="text-center glass-gap-4">
          <h3 className="glass-text-xl font-medium glass-text-primary">
            🎨 Special Actions
          </h3>
          <div className="flex justify-center glass-gap-4">
            <button
              onClick={() => handleInteraction('customize')}
              className="glass-surface-secondary glass-elev-2 glass-radius-lg glass-px-6 glass-py-3 hover:glass-elev-3 transition-all duration-300"
            >
              🎨 Customize Theme
            </button>
      ...
      <div className="glass-surface-primary glass-elev-1 glass-radius-lg glass-p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 glass-gap-4">
          <div className="text-center glass-surface-secondary glass-radius-md glass-p-4">
            <div className="glass-text-2xl font-bold glass-text-primary">{actionCount}</div>
            <div className="glass-text-sm glass-text-secondary">Actions</div>
          </div>
          <div className="text-center glass-surface-secondary glass-radius-md glass-p-4">
            <div className="glass-text-2xl font-bold glass-text-primary">{progress?.stats.totalInteractions || 0}</div>
            <div className="glass-text-sm glass-text-secondary">Total Interactions</div>
          </div>
          <div className="text-center glass-surface-secondary glass-radius-md glass-p-4">
            <div className="glass-text-2xl font-bold glass-text-primary">{progress?.stats.componentsExplored.length || 0}</div>
            <div className="glass-text-sm glass-text-secondary">Components</div>
          </div>
          <div className="text-center glass-surface-secondary glass-radius-md glass-p-4">
            <div className="glass-text-2xl font-bold glass-text-primary">{Math.max(comboCount, progress?.stats.highestStreak || 0)}</div>
        ...
        <div className="glass-surface-primary glass-elev-1 glass-radius-lg glass-p-6">
          ...
          <div className="glass-gap-3">
            {recentNotifications.map((notification, index) => (
              <div 
                key={`recent-${index}`}
                className="flex items-center glass-gap-4 glass-surface-secondary glass-radius-md glass-p-3"
              >
      ...
      <div className="glass-surface-primary glass-elev-1 glass-radius-lg glass-p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 glass-gap-6">
          <div className="glass-gap-3">
            <h4 className="glass-text-lg font-medium glass-text-primary">Quick Achievements</h4>
          ...
          <div className="glass-gap-3">
            <h4 className="glass-text-lg font-medium glass-text-primary">Advanced Achievements</h4>
            <ul className="glass-gap-1 glass-text-sm glass-text-secondary">
          ...
          <div className="glass-gap-3">
            <h4 className="glass-text-lg font-medium glass-text-primary">Hidden Achievements</h4>
            <ul className="glass-gap-1 glass-text-sm glass-text-secondary">
  ...
  render: (args) => (
    <GlassAchievementProvider {...args}>
      <div className="min-h-screen p-8 space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 glass-gap-4">
          {['Action 1', 'Action 2', 'Action 3', 'Action 4'].map((action, i) => {
            ...
            return (
              <button
                key={action}
                className="glass-surface-primary glass-elev-2 glass-radius-lg glass-p-6 text-center hover:glass-elev-3 transition-all duration-300"
        ...
        <div className="glass-surface-primary glass-elev-1 glass-radius-lg glass-p-6 text-center">
          <h3 className="glass-text-lg font-medium glass-text-primary glass-mb-2">Casual Settings</h3>
  ...
  render: (args) => (
    <GlassAchievementProvider {...args}>
      <div className="min-h-screen p-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 glass-gap-6">
          {['Elite Challenge', 'Master Quest', 'Legendary Trial'].map((challenge, i) => {
            ...
            return (
              ...
              >
                <div className="text-3xl glass-mb-4">⚔️</div>
                <h3 className="glass-text-lg font-medium glass-text-primary glass-mb-2">{challenge}</h3>
                <p className="glass-text-sm glass-text-secondary">
        ...
        <div className="glass-surface-primary glass-elev-1 glass-radius-lg glass-p-6">
          <h3 className="glass-text-lg font-medium glass-text-primary glass-mb-4">Hardcore Features</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 glass-gap-4">
            <div>
              <h4 className="glass-text-sm font-medium glass-text-primary glass-mb-2">Challenges</h4>
            ...
            <div>
              <h4 className="glass-text-sm font-medium glass-text-primary glass-mb-2">Rewards</h4>
              <ul className="glass-gap-1 glass-text-xs glass-text-secondary">
  ...
  render: (args) => (
    <GlassAchievementProvider {...args}>
      <div className="min-h-screen p-8 space-y-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 glass-gap-6">
          {['Simple Action', 'Quiet Task', 'Minimal Interaction', 'Basic Function', 'Clean Action', 'Pure Task'].map((action, i) => {
            const { trackClick } = useAchievementTracker();
            return (
              <button
                key={action}
                className="glass-surface-primary glass-elev-1 glass-radius-lg glass-p-4 text-center hover:glass-elev-2 transition-all duration-300"
        ...
        <div className="glass-surface-primary glass-elev-1 glass-radius-lg glass-p-6 text-center">
          <h3 className="glass-text-lg font-medium glass-text-primary glass-mb-2">Minimal Settings</h3>
          <div className="glass-gap-1 glass-text-sm glass-text-secondary">
  ...
  render: (args) => (
    <GlassAchievementProvider {...args}>
      <div className="min-h-screen p-8 space-y-8">
        ...
        <div className="grid grid-cols-3 md:grid-cols-6 glass-gap-4">
        ...
        <div className="text-center glass-surface-primary glass-elev-1 glass-radius-lg glass-p-4">
          <p className="glass-text-sm glass-text-secondary">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 glass-gap-4 mb-8">
          {Array.from({ length: 16 }, (_, i) => {
            ...
            return (
              <button
                key={i}
                className="glass-surface-primary glass-elev-2 glass-radius-lg glass-p-3 hover:glass-elev-3 transition-all duration-300"
