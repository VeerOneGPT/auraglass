  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        <h2 className="text-3xl font-bold glass-text-primary mb-4">Brand Color Integration</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="glass-surface-secondary backdrop-blur-lg rounded-2xl p-6">
          <div className="flex items-center justify-center w-12 h-12 rounded-full mb-4"
            ...
            <span className="glass-text-primary font-bold text-lg">
              {brandColors?.primaryColor ? '✓' : '?'}
            </span>
          </div>
          <h3 className="text-xl font-semibold glass-text-primary mb-2">Primary Color</h3>
          <p className="glass-text-secondary text-sm mb-3">
            {brandColors?.primaryColor || 'Loading...'}
          </p>
          <div className="w-full h-3 rounded-full glass-surface-accent">
            <div
        ...
        <div className="glass-surface-secondary backdrop-blur-lg rounded-2xl p-6">
          ...
          <h3 className="text-xl font-semibold glass-text-primary mb-2">Secondary Color</h3>
          <p className="glass-text-secondary text-sm mb-3">
        ...
        <div className="glass-surface-secondary backdrop-blur-lg rounded-2xl p-6">
          <div className="flex items-center justify-center w-12 h-12 rounded-full mb-4 glass-surface-accent">
            <span className="glass-text-primary font-bold text-lg">
              {brandColors?.colorHistory?.length || 0}
            </span>
          </div>
          <h3 className="text-xl font-semibold glass-text-primary mb-2">Color History</h3>
          <p className="glass-text-secondary text-sm mb-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="glass-surface-secondary backdrop-blur-lg rounded-2xl p-6">
          <h3 className="text-xl font-semibold glass-text-primary mb-4">Brand Glass Button</h3>
        ...
        <div className="glass-surface-secondary backdrop-blur-lg rounded-2xl p-6">
          <h3 className="text-xl font-semibold glass-text-primary mb-4">Brand Integration Features</h3>
          <div className="space-y-3 glass-text-primary/80">
...
export const BasicIntegration: Story = {
  ...
  render: (args) => (
    <IntelligentColorProvider>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-8 dark">
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-8 dark">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold glass-text-primary mb-4">
              🏢 Entity-Based Branding
            </h1>
            <p className="text-xl glass-text-primary/80">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <BrandColorIntegration entityId="apple">
              <div className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold glass-text-primary mb-2">Apple</h3>
            ...
            <BrandColorIntegration entityId="google">
              <div className="p-8 text-center">
                <div className="text-6xl mb-4">🔍</div>
                <h3 className="text-2xl font-bold glass-text-primary mb-2">Google</h3>
            ...
            <BrandColorIntegration entityId="microsoft">
              <div className="p-8 text-center">
                <div className="text-6xl mb-4">🪟</div>
                <h3 className="text-2xl font-bold glass-text-primary mb-2">Microsoft</h3>
          ...
          <div className="glass-surface-secondary backdrop-blur-lg rounded-2xl p-8">
            <h3 className="text-2xl font-bold glass-text-primary mb-6 text-center">Brand Integration Benefits</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="text-4xl mb-3">🎨</div>
                <h4 className="font-semibold glass-text-primary mb-2">Consistent Branding</h4>
                <p className="glass-text-secondary text-sm">Maintain brand identity across all components</p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-3">⚡</div>
                <h4 className="font-semibold glass-text-primary mb-2">Real-time Adaptation</h4>
                <p className="glass-text-secondary text-sm">Smooth transitions between brand themes</p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-3">♿</div>
                <h4 className="font-semibold glass-text-primary mb-2">Accessibility First</h4>
                <p className="glass-text-secondary text-sm">WCAG compliant color combinations</p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-3">📊</div>
                <h4 className="font-semibold glass-text-primary mb-2">Analytics Ready</h4>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <BrandColorIntegration entityId={activeBrand}>
                <div className="p-8">
                  <h3 className="text-2xl font-bold glass-text-primary mb-6">
                    {activeBrand.charAt(0).toUpperCase() + activeBrand.slice(1)} Brand Integration
                  </h3>

                  <div className="space-y-6">
                    <div className="glass-surface-secondary backdrop-blur-lg rounded-xl p-4">
                      <h4 className="font-semibold glass-text-primary mb-3">Color Palette</h4>
                      <div className="flex gap-3">
                        <div className="w-12 h-12 rounded-lg border border-white/20"
                             style={{ backgroundColor: 'var(--brand-primary)' }} />
                        <div className="w-12 h-12 rounded-lg border border-white/20"
                             style={{ backgroundColor: 'var(--brand-secondary)' }} />
                        <div className="w-12 h-12 rounded-lg glass-surface-accent" />
                      </div>
                    </div>

                    <div className="glass-surface-secondary backdrop-blur-lg rounded-xl p-4">
                      <h4 className="font-semibold glass-text-primary mb-3">Glass Effects</h4>
                      <div className="space-y-3">
                        <BrandGlassButton variant="primary" className="w-full">
                          Primary Action
                        </BrandGlassButton>
                    ...
                    <div className="glass-surface-secondary backdrop-blur-lg rounded-xl p-4">
                      <h4 className="font-semibold glass-text-primary mb-3">Brand Features</h4>
                      <div className="space-y-2 glass-text-primary/80">
              ...
              <div className="space-y-6">
                <div className="glass-surface-secondary backdrop-blur-lg rounded-2xl p-6">
                  <h3 className="text-xl font-semibold glass-text-primary mb-4">Integration Metrics</h3>
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="glass-text-primary/80">Color Harmony</span>
                      <div className="flex items-center gap-2">
                        <div className="w-20 h-2 glass-surface-accent rounded-full">
                          <div className="w-16 h-2 bg-green-400 rounded-full" />
                        </div>
                        <span className="glass-text-primary text-sm">80%</span>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="glass-text-primary text-sm">90%</span>
                      </div>
                    </div>
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="glass-text-primary text-sm">95%</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="glass-surface-secondary backdrop-blur-lg rounded-2xl p-6">
                  <h3 className="text-xl font-semibold glass-text-primary mb-4">Usage Examples</h3>
                  <div className="space-y-3 glass-text-primary/80">
                    <div className="p-3 glass-surface-muted rounded-lg">
