...
function SpatialAudioDemo() {
  ...
  return (
    <div ref={containerRef} className="glass-min-glass-glass-h-screen glass-glass-glass-p-8 space-y-8">
      {/* Header */}
      <div className="glass-glass-glass-text-center glass-glass-glass-gap-4">
        ...
        <div className="glass-glass-glass-flex glass-glass-glass-justify-center glass-glass-glass-items-center space-x-6">
          ...
          <div className="glass-glass-glass-flex glass-glass-glass-items-center glass-glass-glass-gap-2 glass-surface-secondary glass-radius-full glass-glass-glass-px-4 glass-glass-glass-py-2">
            <span className="glass-glass-glass-text-sm glass-glass-glass-text-primary">🔊</span>
            <input
              type="range"
              min="0"
              max="1"
      ...
      <div className="glass-stack glass-stack-lg">
        ...
        <div className="glass-glass-glass-grid glass-glass-glass-glass-glass-grid-cols-1 md:glass-glass-glass-glass-glass-grid-cols-3 glass-glass-glass-gap-6">
          ...
          >
            ...
            <h3 className="glass-glass-glass-text-lg glass-glass-glass-font-medium glass-glass-glass-text-primary">Volume Reactive</h3>
            <p className="glass-glass-glass-text-sm glass-text-secondary">
          ...
          >
            <div className="glass-glass-glass-text-2xl">🌈</div>
            <h3 className="glass-glass-glass-text-lg glass-glass-glass-font-medium glass-glass-glass-text-primary">Full Spectrum</h3>
            <p className="glass-glass-glass-text-sm glass-text-secondary">
          ...
          >
            <div className="glass-glass-glass-text-2xl">📊</div>
            <h3 className="glass-glass-glass-text-lg glass-glass-glass-font-medium glass-glass-glass-text-primary">Frequency Reactive</h3>
            <p className="glass-glass-glass-text-sm glass-text-secondary">
      ...
      <div className="glass-surface-primary glass-elev-1 glass-radius-lg glass-glass-glass-p-6">
        ...
        <div className="glass-glass-glass-grid glass-glass-glass-glass-glass-grid-cols-1 md:glass-glass-glass-glass-glass-grid-cols-2 lg:glass-glass-glass-glass-glass-grid-cols-3 glass-glass-glass-gap-6">
          <div className="glass-glass-glass-gap-3">
            <h4 className="glass-glass-glass-text-lg glass-glass-glass-font-medium glass-glass-glass-text-primary">3D Positioning</h4>
          ...
          <div className="glass-glass-glass-gap-3">
            <h4 className="glass-glass-glass-text-lg glass-glass-glass-font-medium glass-glass-glass-text-primary">Glass Sounds</h4>
            <ul className="glass-glass-glass-gap-1 glass-glass-glass-text-sm glass-text-secondary">
          ...
          <div className="glass-glass-glass-gap-3">
            <h4 className="glass-glass-glass-text-lg glass-glass-glass-font-medium glass-glass-glass-text-primary">Interactive Features</h4>
            <ul className="glass-glass-glass-gap-1 glass-glass-glass-text-sm glass-text-secondary">
        ...
        <div className="glass-glass-glass-grid glass-glass-glass-glass-glass-grid-cols-2 md:glass-glass-glass-glass-glass-grid-cols-4 glass-glass-glass-gap-4">
          {['Tap', 'Hover', 'Slide', 'Break'].map((soundType, i) => {
            ...
            return (
              ...
              >
                <div className="glass-glass-glass-text-xl glass-glass-glass-mb-2">🔊</div>
                <div className="glass-glass-glass-text-sm glass-glass-glass-text-primary">{soundType}</div>
              </button>
            );
          })}
        </div>
  ...
  render: (args) => (
    <GlassSpatialAudioProvider {...args}>
      <div className="glass-min-glass-glass-h-screen glass-glass-glass-p-8 space-y-8">
        ...
        <div className="glass-glass-glass-relative glass-glass-glass-h-96 glass-surface-primary glass-elev-1 glass-radius-lg glass-glass-glass-p-8">
          ...
          <div 
            className="glass-glass-glass-relative glass-glass-glass-w-full glass-glass-glass-h-full glass-surface-secondary glass-radius-lg cursor-crosshair"
            onClick={(e) => {
              ...
              dot.className='glass-glass-glass-absolute glass-glass-glass-w-4 glass-glass-glass-h-4 glass-surface-primary glass-radius-full animate-ping';
          ...
          >
            <div className="glass-glass-glass-absolute glass--glass--glass--glass--glass--glass--glass--glass--glass--glassglass--glassglass--top-2 left-2 glass-glass-glass-text-xs glass-text-tertiary">
              Left (-1, 1)
            </div>
            <div className="glass-glass-glass-absolute glass--glass--glass--glass--glass--glass--glass--glass--glass--glassglass--glassglass--top-2 right-2 glass-glass-glass-text-xs glass-text-tertiary">
              Right (1, 1)
            </div>
            <div className="glass-glass-glass-absolute bottom-2 left-2 glass-glass-glass-text-xs glass-text-tertiary">
              Left (-1, -1)
            </div>
            <div className="glass-glass-glass-absolute bottom-2 right-2 glass-glass-glass-text-xs glass-text-tertiary">
              Right (1, -1)
            </div>
            <div className="glass-glass-glass-absolute glass--glass--glass--glass--glassglass--glass-top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              <div className="glass-glass-glass-w-3 glass-glass-glass-h-3 glass-surface-green glass-radius-full" />
              <div className="glass-glass-glass-text-xs glass-glass-glass-text-primary glass-mt-1">Listener (0, 0)</div>
            </div>
          </div>
        </div>
      </div>
  ...
  render: (args) => (
    <GlassSpatialAudioProvider {...args}>
      <div className="glass-min-glass-glass-h-screen glass-glass-glass-p-8 space-y-8">
        ...
        <div className="glass-glass-glass-grid glass-glass-glass-glass-glass-grid-cols-3 md:glass-glass-glass-glass-glass-grid-cols-5 glass-glass-glass-gap-4">
        ...
        <div className="glass-glass-glass-text-center glass-surface-primary glass-elev-1 glass-radius-lg glass-glass-glass-p-4">
          ...
          <p className="glass-glass-glass-text-xs glass-text-tertiary glass-mt-2">
  ...
  render: (args) => (
    <GlassSpatialAudioProvider {...args}>
      <div className="glass-min-glass-glass-h-screen glass-glass-glass-p-8 space-y-8">
        ...
        <div className="glass-glass-glass-grid glass-glass-glass-glass-glass-grid-cols-1 md:glass-glass-glass-glass-glass-grid-cols-2 lg:glass-glass-glass-glass-glass-grid-cols-4 glass-glass-glass-gap-6">
          {[
            ...
            <GlassAudioReactive
              ...
              intensityMultiplier={1.5}
              className="glass-surface-primary glass-elev-2 glass-radius-lg glass-glass-glass-p-6 glass-glass-glass-text-center glass-glass-glass-gap-4 glass-min-glass-glass-h-32"
            >
              <div className="glass-glass-glass-text-2xl">🎵</div>
              <h3 className="glass-glass-glass-text-sm glass-glass-glass-font-medium glass-glass-glass-text-primary">{config.label}</h3>
        ...
        <div className="glass-glass-glass-text-center">
          <button
            className="glass-surface-primary glass-elev-2 glass-radius-lg glass-glass-glass-px-6 glass-glass-glass-py-3 hover:glass-elev-3 transition-all duration-300"
            onClick={() => {
              const { playGlassSound } = useSpatialAudio();
