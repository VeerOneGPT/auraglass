...
function SpatialAudioDemo() {
  ...
  return (
    <div ref={containerRef} className="min-h-screen p-8 space-y-8">
      {/* Header */}
      ...
      <div className="glass-stack glass-stack-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 glass-gap-6">
          ...
          >
            ...
            <h3 className="glass-text-lg font-medium glass-text-primary">Volume Reactive</h3>
            <p className="glass-text-sm glass-text-secondary">
          ...
          >
            <div className="glass-text-2xl">🌈</div>
            <h3 className="glass-text-lg font-medium glass-text-primary">Full Spectrum</h3>
            <p className="glass-text-sm glass-text-secondary">
          ...
          >
            <div className="glass-text-2xl">📊</div>
            <h3 className="glass-text-lg font-medium glass-text-primary">Frequency Reactive</h3>
            <p className="glass-text-sm glass-text-secondary">
      ...
      <div className="glass-surface-primary glass-elev-1 glass-radius-lg glass-p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 glass-gap-6">
          <div className="glass-gap-3">
            <h4 className="glass-text-lg font-medium glass-text-primary">3D Positioning</h4>
          ...
          <div className="glass-gap-3">
            <h4 className="glass-text-lg font-medium glass-text-primary">Glass Sounds</h4>
            <ul className="glass-gap-1 glass-text-sm glass-text-secondary">
          ...
          <div className="glass-gap-3">
            <h4 className="glass-text-lg font-medium glass-text-primary">Interactive Features</h4>
            <ul className="glass-gap-1 glass-text-sm glass-text-secondary">
    ...
    <GlassSpatialAudioProvider {...args}>
      <div className="min-h-screen p-8 space-y-8">
        ...
        <div className="relative h-96 glass-surface-primary glass-elev-1 glass-radius-lg p-8">
          ...
          >
            <div className="absolute top-2 left-2 glass-text-xs glass-text-tertiary">
              Left (-1, 1)
            </div>
            <div className="absolute top-2 right-2 glass-text-xs glass-text-tertiary">
              Right (1, 1)
            </div>
            <div className="absolute bottom-2 left-2 glass-text-xs glass-text-tertiary">
              Left (-1, -1)
            </div>
            <div className="absolute bottom-2 right-2 glass-text-xs glass-text-tertiary">
              Right (1, -1)
            </div>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              <div className="w-3 h-3 bg-green-400 glass-radius-full" />
  ...
  render: (args) => (
    <GlassSpatialAudioProvider {...args}>
      <div className="min-h-screen p-8 space-y-8">
        ...
        <div className="grid grid-cols-3 md:grid-cols-5 glass-gap-4">
  ...
  render: (args) => (
    <GlassSpatialAudioProvider {...args}>
      <div className="min-h-screen p-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 glass-gap-6">
          {[
            ...
            <GlassAudioReactive
              ...
              intensityMultiplier={1.5}
              className="glass-surface-primary glass-elev-2 glass-radius-lg glass-p-6 text-center glass-gap-4 min-h-32"
            >
              <div className="glass-text-2xl">🎵</div>
              <h3 className="glass-text-sm font-medium glass-text-primary">{config.label}</h3>
        ...
        <div className="text-center">
          <button
            className="glass-surface-primary glass-elev-2 glass-radius-lg glass-px-6 glass-py-3 hover:glass-elev-3 transition-all duration-300"
            onClick={() => {
              const { playGlassSound } = useSpatialAudio();
