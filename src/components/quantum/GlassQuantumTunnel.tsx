  ...
  ({
    ...
    return (
      <OptimizedGlass
        ...
        {...props}
      >
        <div className="glass-glass-p-6 glass-glass-space-y-4">
          {/* Header */}
          <div className="glass-glass-flex glass-glass-items-center glass-glass-justify-between">
            <div>
              <h2 className="glass-glass-text-xl glass-glass-font-semibold glass-glass-text-primary/90">
                Quantum Tunnel
              </h2>
          ...
          <div className="glass-glass-relative">
            <canvas
              ...
              width={800}
              height={300}
              className="glass-glass-border glass-glass-border-white/20 glass-radius-lg glass-surface-dark/20"
            />
              ...
              {quantumStates.map(state => (
                ...
                >
                  <div className="glass-glass-flex glass-glass-items-center space-x-2">
                    {state.icon && (
                      <span className="glass-glass-text-lg">{state.icon}</span>
                    )}
                    <div>
                      <div className="glass-glass-text-sm glass-glass-font-medium glass-glass-text-primary/90">
                        {state.label}
                      </div>
            ...
            <AnimatePresence>
              {activeTransitions.map(transition => {
                ...
                return (
                  ...
                  >
                    <div className="glass-glass-w-4 glass-glass-h-4 bg-pink-400 glass-radius-full glass-glass-shadow-lg animate-pulse" />
                    <div className="glass-glass-absolute -bottom-8 left-1/2 transform -translate-x-1/2 glass-glass-text-xs text-pink-300 whitespace-nowrap">
          ...
          <div className="glass-glass-flex glass-glass-items-center glass-glass-justify-between">
            ...
            <div className="glass-glass-flex glass-glass-items-center space-x-6 glass-glass-text-sm glass-glass-text-primary/60">
          ...
          <div className={`
            ...
            ${createGlassStyle({ opacity: 0.7 }).background}
          `}>
            <h3 className="glass-glass-text-sm glass-glass-font-semibold glass-glass-text-primary/90">Quantum Statistics</h3>
            ...
            <div className="glass-glass-grid glass-glass-glass-grid-cols-2 md:glass-glass-glass-grid-cols-4 glass-glass-gap-4 glass-glass-text-sm">
              <div>
                <span className="glass-glass-text-primary/60">Avg Tunneling:</span>
              ...
              <div>
                <span className="glass-glass-text-primary/60">Wave Coherence:</span>
                <div className="glass-glass-text-primary/90 glass-glass-font-medium">
              ...
              <div>
                <span className="glass-glass-text-primary/60">Energy Spread:</span>
                <div className="glass-glass-text-primary/90 glass-glass-font-medium">
              ...
              <div>
                <span className="glass-glass-text-primary/60">Barrier Count:</span>
                <div className="glass-glass-text-primary/90 glass-glass-font-medium">
                  {barriers.length}
                </div>
              </div>
            ...
            {activeTransitions.length > 0 && (
              <div className="space-y-1">
                <span className="glass-glass-text-primary/60 glass-glass-text-sm">Active Tunneling:</span>
                <div className="glass-glass-flex glass-glass-flex-wrap glass-glass-gap-1">
                  {activeTransitions.slice(-3).map((transition, index) => (
                    <div
                      key={index}
                      className="glass-glass-px-2 glass-glass-py-1 glass-glass-text-xs bg-pink-500/20 text-pink-300 glass-radius glass-glass-border glass-glass-border-pink-400/20"
                    >
