...
export const Sizes: Story = {
  render: (args) => (
    <div className="glass-glass-flex glass-glass-flex-wrap glass-glass-items-center glass-glass-gap-4">
...
export const WithIcons: Story = {
  render: (args) => (
    <div className="glass-glass-flex glass-glass-flex-wrap glass-glass-gap-4">
      <GlassButton {...args}>
        <svg className="glass-glass-w-4 glass-glass-h-4 glass-mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const SpecularParallax: Story = {
  render: (args) => (
    <div className="glass-glass-flex glass-glass-flex-wrap glass-glass-gap-6 glass-inset-lg">
  ...
  args: {
    ...
    children: (
      <div className="glass-glass-flex glass-glass-items-center">
        <svg className="glass-glass-w-5 glass-glass-h-5 glass-mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  render: (args) => (
    <div className="glass-stack glass-stack-lg">
      <div className="glass-surface-overlay glass-glass-backdrop-blur-sm glass-radius-lg glass-glass-p-4">
        <h3 className="glass-glass-text-sm glass-glass-font-medium glass-glass-text-primary glass-glass-mb-2">Predictive Button</h3>
        <p className="glass-glass-text-xs glass-glass-text-primary-secondary glass-glass-mb-4">Anticipates user actions and preloads responses</p>
        <GlassButton 
          {...args}
        >
          Predictive Action
...
export const WithEyeTracking: Story = {
  render: (args) => (
    <div className="glass-stack glass-stack-lg">
      <div className="glass-surface-overlay glass-glass-backdrop-blur-sm glass-radius-lg glass-glass-p-4">
        <h3 className="glass-glass-text-sm glass-glass-font-medium glass-glass-text-primary glass-glass-mb-2">Eye Tracking Enabled</h3>
        <p className="glass-glass-text-xs glass-glass-text-primary-secondary glass-glass-mb-4">Responds to user gaze with visual feedback</p>
        <div className="glass-glass-flex glass-glass-flex-wrap glass-glass-gap-4">
          <GlassButton 
            {...args}
          >
...
export const BiometricAdaptive: Story = {
  render: (args) => (
    <div className="glass-stack glass-stack-lg">
      <div className="glass-surface-overlay glass-glass-backdrop-blur-sm glass-radius-lg glass-glass-p-4">
        <h3 className="glass-glass-text-sm glass-glass-font-medium glass-glass-text-primary glass-glass-mb-2">Biometric Adaptive</h3>
        <p className="glass-glass-text-xs glass-glass-text-primary-secondary glass-glass-mb-4">Adjusts interaction patterns based on stress levels</p>
        <div className="glass-glass-flex glass-glass-flex-wrap glass-glass-gap-4">
          <GlassButton 
            {...args}
          >
...
export const WithSpatialAudio: Story = {
  render: (args) => (
    <div className="glass-stack glass-stack-lg">
      <div className="glass-surface-overlay glass-glass-backdrop-blur-sm glass-radius-lg glass-glass-p-4">
        <h3 className="glass-glass-text-sm glass-glass-font-medium glass-glass-text-primary glass-glass-mb-2">Spatial Audio Feedback</h3>
        <p className="glass-glass-text-xs glass-glass-text-primary-secondary glass-glass-mb-4">Provides positional audio cues for interactions</p>
...
export const AchievementTracking: Story = {
  render: (args) => (
    <div className="glass-stack glass-stack-lg">
      <div className="glass-surface-overlay glass-glass-backdrop-blur-sm glass-radius-lg glass-glass-p-4">
        <h3 className="glass-glass-text-sm glass-glass-font-medium glass-glass-text-primary glass-glass-mb-2">Achievement System</h3>
        <p className="glass-glass-text-xs glass-glass-text-primary-secondary glass-glass-mb-4">Tracks user interactions for gamification</p>
        <div className="glass-glass-flex glass-glass-flex-wrap glass-glass-gap-4">
          <GlassButton 
            {...args}
          >
  ...
  render: (args) => (
    <div className="space-y-8">
      <div className="glass-glass-text-center glass-glass-gap-2">
        <h2 className="glass-glass-text-xl glass-glass-font-semibold glass-glass-text-primary">Consciousness-Enhanced Button</h2>
        <p className="glass-glass-text-sm glass-glass-text-primary-secondary">All consciousness features enabled</p>
      </div>
      ...
      <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-2 glass-glass-gap-4 glass-glass-text-sm">
        <div className="glass-surface-overlay glass-radius-lg glass-glass-p-3">
          <h4 className="glass-glass-font-medium glass-glass-text-primary glass-glass-mb-2">Active Features</h4>
        ...
        <div className="glass-surface-overlay glass-radius-lg glass-glass-p-3">
          <h4 className="glass-glass-font-medium glass-glass-text-primary glass-glass-mb-2">User Experience</h4>
          <ul className="glass-glass-text-primary-secondary glass-glass-gap-1">
...
export const ConsciousnessComparison: Story = {
  render: (args) => (
    <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-2 glass-glass-gap-6">
      <div className="glass-surface-overlay glass-glass-backdrop-blur-sm glass-radius-lg glass-glass-p-4">
        <h3 className="glass-glass-text-sm glass-glass-font-medium glass-glass-text-primary glass-glass-mb-4">Standard Button</h3>
        <GlassButton {...args}>
          Traditional Interaction
        </GlassButton>
        <p className="glass-glass-text-xs glass-glass-text-primary-secondary glass-mt-2">Basic click interactions</p>
      </div>
      <div className="glass-surface-overlay glass-glass-backdrop-blur-sm glass-radius-lg glass-glass-p-4">
        <h3 className="glass-glass-text-sm glass-glass-font-medium glass-glass-text-primary glass-glass-mb-4">Consciousness Enhanced</h3>
        <GlassButton 
          {...args}
        >
          <div className="glass-glass-flex glass-glass-items-center">
        ...
        <p className="glass-glass-text-xs glass-glass-text-primary-secondary glass-mt-2">Intelligent, adaptive, immersive</p>
      </div>
    </div>
  ),
  args: {
