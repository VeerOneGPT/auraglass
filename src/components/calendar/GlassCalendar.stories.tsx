...
export const Default: Story = {
  render: (args) => (
    <div className="glass-glass-w-full max-w-4xl">
      <GlassCalendar {...args} />
    </div>
  ),
  args: {
...
export const Views: Story = {
  render: (args) => (
    <div className="space-y-8 glass-glass-w-full max-w-4xl">
      <div>
        <h4 className="glass-glass-text-lg glass-glass-font-semibold glass-glass-mb-4 glass-glass-text-primary">Month View</h4>
        <GlassCalendar {...args} view="month" />
      </div>
      <div>
        <h4 className="glass-glass-text-lg glass-glass-font-semibold glass-glass-mb-4 glass-glass-text-primary">Week View</h4>
        <GlassCalendar {...args} view="week" />
      </div>
      <div>
        <h4 className="glass-glass-text-lg glass-glass-font-semibold glass-glass-mb-4 glass-glass-text-primary">Day View</h4>
