...
const AccessibilityDemo = () => {
  ...
  return (
    <div className="glass-glass-p-6 space-y-6">
      <GlassCard className="glass-glass-p-6">
        <h2 className="glass-glass-text-xl glass-glass-font-semibold glass-glass-mb-4">Accessibility Settings</h2>
      ...
      <GlassCard className="glass-glass-p-6">
        <h3 className="glass-glass-text-lg glass-glass-font-semibold glass-glass-mb-2">Current Settings</h3>
        <pre className="glass-glass-text-sm glass-surface-subtle glass-glass-p-2 glass-radius">
