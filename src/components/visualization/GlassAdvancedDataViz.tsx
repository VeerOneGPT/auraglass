        ...
        <g key={series.id}>
          ...
          {series.data.map((point, index) => (
            <circle
              ...
              stroke="white"
              strokeWidth={2}
              className="glass-glass-cursor-pointer hover:r-6 transition-all"
        ...
        {series.data.map((point, pointIndex) => {
          ...
          return (
            <rect
              ...
              height={height}
              fill={seriesColors[series.id]}
              className="glass-glass-cursor-pointer hover:opacity-80 transition-all"
              onClick={() => handleDataPointClick(point, series)}
            />
          );
        })}
      ...
      <g>
          ...
          return (
            <g key={i}>
              ...
              <text
                ...
                textAnchor="middle"
                className="glass-glass-text-xs fill-gray-600"
              >
                {formatValue(value)}
              </text>
            </g>
        ...
        {xAxisLabel && (
          <text
            ...
            textAnchor="middle"
            className="glass-glass-text-sm glass-glass-font-medium fill-gray-700"
          >
            {xAxisLabel}
          </text>
        )}
    ...
    <div ref={containerRef} className={cn("relative", className)}>
      <Glass className="glass-glass-p-6">
        ...
        <div className="glass-glass-flex glass-glass-items-center glass-glass-justify-between mb-6">
          <div>
            {title && <h2 className="glass-glass-text-xl glass-glass-font-semibold glass-text-secondary">{title}</h2>}
          ...
          <div className="glass-glass-flex glass-glass-items-center glass-glass-gap-2">
            {enableZoom && (
              <button
                onClick={resetZoom}
                className="glass-glass-px-3 glass-glass-py-1 glass-glass-text-xs glass-surface-subtle glass-text-secondary glass-radius hover:bg-gray-200 transition-colors"
              >
                Reset Zoom
              </button>
            )}
            
            <div className="glass-glass-flex glass-glass-border glass-glass-border-subtle glass-radius overflow-hidden">
              <button
                onClick={() => exportChart('csv')}
                className="glass-glass-px-3 glass-glass-py-1 glass-glass-text-xs glass-surface-subtle glass-text-secondary hover:glass-surface-subtle glass-glass-border-r glass-glass-border-subtle"
              >
                CSV
              </button>
              <button
                onClick={() => exportChart('json')}
                className="glass-glass-px-3 glass-glass-py-1 glass-glass-text-xs glass-surface-subtle glass-text-secondary hover:glass-surface-subtle"
              >
                JSON
              </button>
            </div>
        ...
        {enableDrillDown && appliedFilters.length > 0 && (
          <div className="glass-glass-flex glass-glass-items-center glass-glass-gap-2 glass-glass-mb-4 glass-glass-text-sm glass-text-secondary">
            <span>📊</span>
            <span>Filtered by:</span>
            {appliedFilters.map((filter, index) => (
              <span
                key={index}
                className="glass-glass-px-2 glass-glass-py-1 bg-blue-100 glass-glass-text-primary glass-radius glass-glass-flex glass-glass-items-center glass-glass-gap-1"
              >
                {filter.field}: {filter.value}
                <button
                  onClick={() => setAppliedFilters(prev => prev.filter((_, i) => i !== index))}
                  className="glass-glass-text-primary hover:glass-glass-text-primary ml-1"
                >
                  ✕
                </button>
              </span>
        ...
        <div className="glass-glass-relative">
          <svg
            ...
            className="glass-glass-border glass-glass-border-subtle glass-radius"
          >
        ...
        {/* Legend */}
        {showLegend && (
          <div className="glass-glass-flex glass-glass-flex-wrap glass-glass-items-center glass-glass-gap-4 mt-4 pt-4 glass-glass-border-t glass-glass-border-subtle">
      ...
      {tooltip.visible && (
        <div
          className="glass-glass-fixed glass-z-50 glass-glass-px-3 glass-glass-py-2 bg-gray-900 glass-glass-text-primary glass-glass-text-sm glass-radius glass-glass-shadow-lg glass-pointer-events-none"
          style={{
            left: tooltip.x + 10,
            top: tooltip.y - 10,
