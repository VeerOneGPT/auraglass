    ...
    const renderControls = () => {
      ...
      return (
        <OptimizedGlass
          ...
          tint="neutral"
          border="subtle"
          className="glass-weather-controls glass-glass-flex glass-glass-flex-wrap glass-glass-items-center glass-glass-gap-4 glass-glass-p-4 glass-radius-lg backdrop-blur-md glass-glass-border glass-glass-border-glass-glass-border/20"
        >
          <div className="glass-glass-flex glass-glass-items-center glass-glass-gap-2">
            <label className="glass-glass-text-sm">Weather:</label>
            <select
          ...
          <div className="glass-glass-flex glass-glass-items-center glass-glass-gap-2">
            <label className="glass-glass-text-sm">Temp:</label>
            <input
              type="range"
              min="-20"
              max="40"
              ...
              className="w-20"
            />
            <span className="glass-glass-text-sm min-w-[3ch]">{currentWeather.temperature}°C</span>
          </div>
