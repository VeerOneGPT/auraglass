...
export const GlassWeatherGlass = forwardRef<HTMLDivElement, GlassWeatherGlassProps>(
  (
    ...
    useEffect(() => {
      ...
      setBackgroundGradient(colors.sky);
      
      if (currentWeather.type === 'clear' || currentWeather.type === 'sunny') {
        setGlassColor(getTemperatureColor(currentWeather.temperature));
      } else {
        setGlassColor(colors.glass);
      }
    }, [currentWeather, weatherResponsive, getTemperatureColor]);
    ...
    }, [prefersReducedMotion, respectMotionPreference, render, updateParticles, updateAtmosphericEffects]);
    ...
    const renderControls = () => {
      ...
      return (
        <OptimizedGlass
          ...
          tint="neutral"
          border="subtle"
          className="glass-weather-controls flex flex-wrap items-center glass-gap-4 glass-p-4 glass-radius-lg backdrop-blur-md border border-border/20"
        >
          ...
          <div className="flex items-center glass-gap-2">
            ...
            <input
              ...
              className="w-20"
            />
            <span className="glass-text-sm min-w-[3ch]">{currentWeather.temperature}°C</span>
          </div>
