...
export const AdvancedVideoPlayer: VideoStory = {
  render: () => (
    <MediaProvider>
      <div className="h-screen glass-surface-subtle glass-glass-p-4">
...
export const CompactAudioPlayer: AudioStory = {
  render: () => (
    <MediaProvider>
      <div className="glass-glass-p-8 glass-surface-subtle min-h-screen">
  ...
  render: () => (
    <MediaProvider>
      <div className="min-h-screen glass-surface-subtle">
        {/* Header */}
        <div className="glass-surface-subtle glass-glass-border-b glass-glass-border-subtle glass-glass-p-6">
          <div className="max-w-6xl mx-auto">
            <h1 className="glass-glass-text-3xl font-bold glass-text-secondary glass-glass-mb-2">
            ...
            <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-4 glass-glass-gap-4 mt-6">
              <div className="glass-glass-text-center glass-glass-p-4 bg-blue-50 glass-radius-lg">
                ...
                <h3 className="glass-glass-font-semibold glass-glass-text-primary">AI Transcription</h3>
                <p className="glass-glass-text-sm glass-glass-text-primary">Real-time speech-to-text with speaker ID</p>
              </div>
              <div className="glass-glass-text-center glass-glass-p-4 bg-green-50 glass-radius-lg">
                <div className="glass-glass-text-2xl glass-glass-mb-2">📊</div>
                <h3 className="glass-glass-font-semibold glass-glass-text-primary">Advanced Analytics</h3>
                <p className="glass-glass-text-sm glass-glass-text-primary">Detailed engagement and view metrics</p>
              </div>
              <div className="glass-glass-text-center glass-glass-p-4 bg-purple-50 glass-radius-lg">
                <div className="glass-glass-text-2xl glass-glass-mb-2">🎨</div>
                <h3 className="glass-glass-font-semibold text-purple-900">Visualizers</h3>
                <p className="glass-glass-text-sm text-purple-700">Real-time audio frequency displays</p>
              </div>
              <div className="glass-glass-text-center glass-glass-p-4 bg-orange-50 glass-radius-lg">
                <div className="glass-glass-text-2xl glass-glass-mb-2">📱</div>
                <h3 className="glass-glass-font-semibold text-orange-900">Responsive</h3>
                <p className="glass-glass-text-sm text-orange-700">Perfect on desktop, tablet, and mobile</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Content */}
        <div className="max-w-6xl mx-auto glass-glass-p-6 space-y-8">
          {/* Video Player Section */}
          <section>
            <h2 className="glass-glass-text-2xl glass-glass-font-semibold glass-text-secondary glass-glass-mb-4">🎬 Video Player</h2>
            <div className="glass-surface-subtle glass-radius-lg glass-glass-shadow-sm overflow-hidden">
              <GlassAdvancedVideoPlayer
                mediaFile={sampleVideoFile}
                showControls={true}
                showChapters={true}
          ...
          <section>
            <h2 className="glass-glass-text-2xl glass-glass-font-semibold glass-text-secondary glass-glass-mb-4">🎵 Audio Players</h2>
            <div className="glass-glass-grid glass-glass-glass-grid-cols-1 lg:glass-glass-glass-grid-cols-2 glass-glass-gap-6">
              <div className="glass-surface-subtle glass-radius-lg glass-glass-shadow-sm glass-glass-p-6">
                <h3 className="glass-glass-text-lg glass-glass-font-medium glass-text-secondary glass-glass-mb-4">Full Player with Visualizer</h3>
                <GlassAdvancedAudioPlayer
                  mediaFile={sampleAudioFile}
                  variant="full"
                  visualizerType="bars"
              ...
              <div className="glass-surface-subtle glass-radius-lg glass-glass-shadow-sm glass-glass-p-6">
                <h3 className="glass-glass-text-lg glass-glass-font-medium glass-text-secondary glass-glass-mb-4">Compact Player</h3>
                <GlassAdvancedAudioPlayer
                  mediaFile={sampleAudioFile}
                  variant="compact"
                  visualizerType="none"
                ...
                <div className="mt-6">
                  <h4 className="text-md glass-glass-font-medium glass-text-secondary glass-glass-mb-2">With Waveform</h4>
                  <GlassAdvancedAudioPlayer
                    mediaFile={sampleAudioFile}
                    variant="full"
                    showWaveform={true}
          ...
          {/* Features Grid */}
          <section>
            <h2 className="glass-glass-text-2xl glass-glass-font-semibold glass-text-secondary glass-glass-mb-4">🚀 Revolutionary Features</h2>
            <div className="glass-glass-grid glass-glass-glass-grid-cols-1 md:glass-glass-glass-grid-cols-2 lg:glass-glass-glass-grid-cols-3 glass-glass-gap-6">
              {[
                ...
                <div key={index} className="glass-surface-subtle glass-radius-lg glass-glass-shadow-sm glass-glass-p-6">
                  <div className="glass-glass-text-3xl glass-glass-mb-3">{feature.icon}</div>
                  <h3 className="glass-glass-text-lg glass-glass-font-semibold glass-text-secondary glass-glass-mb-2">{feature.title}</h3>
                  <p className="glass-text-secondary glass-glass-text-sm">{feature.description}</p>
                </div>
              ))}
            </div>
          </section>
