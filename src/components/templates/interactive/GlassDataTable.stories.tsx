...
const userColumns = [
  {
    ...
    render: (value: any) => (
      <div className="glass-glass-flex glass-glass-items-center glass-glass-gap-3">
        <div className="glass-glass-w-8 glass-glass-h-8 glass-gradient-primary from-blue-500 to-purple-500 glass-radius-full glass-glass-flex glass-glass-items-center glass-glass-justify-center glass-glass-text-primary glass-glass-text-sm glass-glass-font-medium">
          {String(value).charAt(0)}
        </div>
        <span className="glass-glass-font-medium">{String(value)}</span>
      </div>
    ),
  },
  {
    ...
    sortable: true,
    render: (value: any) => (
      <span className="glass-glass-text-primary hover:glass-glass-text-primary">{String(value)}</span>
    ),
  },
  {
    key: 'role' as const,
  ...
  },
  {
    ...
    render: (value: any) => (
      <div className="glass-glass-flex glass-glass-items-center glass-glass-gap-2">
        <span className="font-mono glass-glass-text-sm">{String(value)}</span>
        <div className="glass-glass-w-16 h-1 bg-gray-200 glass-radius-full overflow-hidden">
          <div 
...
export const Default: Story = {
  ...
  render: (args) => (
    <div className="glass-glass-p-8 min-h-screen glass-gradient-primary from-slate-50 to-blue-50">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <h1 className="glass-glass-text-2xl font-bold glass-text-secondary glass-glass-mb-2">User Management</h1>
...
export const LoadingState: Story = {
  ...
  render: (args) => (
    <div className="glass-glass-p-8 min-h-screen glass-gradient-primary from-slate-50 to-blue-50">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <h1 className="glass-glass-text-2xl font-bold glass-text-secondary glass-glass-mb-2">Loading Data</h1>
...
export const EmptyState: Story = {
  ...
  render: (args) => (
    <div className="glass-glass-p-8 min-h-screen glass-gradient-primary from-slate-50 to-blue-50">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <h1 className="glass-glass-text-2xl font-bold glass-text-secondary glass-glass-mb-2">Empty State</h1>
  ...
  render: (args) => (
    <div className="glass-glass-p-8 min-h-screen glass-gradient-primary from-slate-50 to-blue-50">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          <h1 className="glass-glass-text-2xl font-bold glass-text-secondary glass-glass-mb-2">Simple Task List</h1>
...
export const AllFeatures: Story = {
  ...
  render: (args) => (
    <div className="glass-glass-p-8 min-h-screen glass-gradient-primary from-slate-50 to-blue-50">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <h1 className="glass-glass-text-2xl font-bold glass-text-secondary glass-glass-mb-2">Complete Data Table</h1>
