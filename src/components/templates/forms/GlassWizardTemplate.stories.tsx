...
const sampleSteps = [
  ...
  },
  {
    ...
    schema: [],
    component: (
      <div className="glass-glass-text-center glass-glass-py-8">
        <h3 className="glass-glass-text-lg glass-glass-font-semibold glass-glass-mb-4">Ready to Complete Setup</h3>
