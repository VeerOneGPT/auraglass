  ...
  (
    ...
    const renderTable = () => {
      ...
      if ((displayRows?.length || 0) === 0) {
        return (
          <div className="glass-glass-flex glass-glass-items-center glass-glass-justify-center glass-glass-py-8 glass-text-secondary">
            No data available
          </div>
        );
      }
      ...
      return (
        <div className="glass-overflow-x-auto">
          <table className="glass-glass-w-full">
            ...
            {showHeader && (
              <thead>
                <tr className="glass-glass-border-b glass-glass-border-glass-glass-border/20">
                  {showRowNumbers && (
                  ...
                  {(data?.columns || []).map((column) => (
                    ...
                    >
                      <HStack space="xs" align="center" className="glass-glass-justify-start">
