import{j as s}from"./iframe-LDZ2lzKB.js";import{G as r}from"./GlassGrid-43XFWHBZ.js";import"./preload-helper-PPVm8Dsz.js";import"./a11y-Bm8A_Ibc.js";import"./MotionPreferenceContext-YEn8QOBK.js";const x={title:"Surfaces/App Shells + Layout/Glass Grid",component:r,parameters:{layout:"centered",previewSurface:"app",docs:{description:{component:"Responsive CSS grid used in dashboard and panel layouts."}}},argTypes:{className:{control:"text",description:"className prop"}},args:{className:""}},c=[["Revenue","$128.4k","+12.8%"],["Pipeline","42 deals","+6"],["Latency","124ms","-18ms"],["Tickets","17 open","-9"]],e={render:t=>s.jsxs("section",{className:"glass-neutral-level1 glass-w-full glass-max-w-5xl glass-rounded-2xl glass-p-6 glass-shadow-xl",children:[s.jsxs("div",{className:"glass-mb-5 glass-flex glass-items-center glass-justify-between glass-gap-4",children:[s.jsxs("div",{children:[s.jsx("p",{className:"glass-text-xs glass-font-semibold glass-uppercase glass-tracking-wide glass-text-secondary",children:"Operations"}),s.jsx("h2",{className:"glass-text-xl glass-font-semibold glass-text-primary",children:"Grid overview"})]}),s.jsx("span",{className:"glass-rounded-full glass-bg-blue-100 glass-px-3 glass-py-1 glass-text-xs glass-font-medium glass-text-blue-700",children:"Live"})]}),s.jsx(r,{...t,cols:4,gap:"md",className:"glass-w-full",children:c.map(([a,g,i])=>s.jsxs("article",{className:"glass-rounded-xl glass-bg-white/70 glass-p-4 glass-shadow-sm",children:[s.jsx("p",{className:"glass-text-sm glass-text-secondary",children:a}),s.jsx("div",{className:"glass-mt-2 glass-text-2xl glass-font-semibold glass-text-primary",children:g}),s.jsx("p",{className:"glass-mt-2 glass-text-sm glass-text-green-700",children:i})]},a))})]}),args:{className:""}},l={render:t=>s.jsx("section",{className:"glass-w-full glass-max-w-5xl glass-space-y-4",children:s.jsx(r,{...t,autoFit:!0,minColWidth:"180px",gap:"lg",className:"glass-w-full",children:["Review queue","Health checks","Deployments","Incidents","Budgets","Owners"].map(a=>s.jsxs("div",{className:"glass-min-h-28 glass-rounded-xl glass-bg-white/70 glass-p-4 glass-shadow-sm",children:[s.jsx("h3",{className:"glass-text-sm glass-font-semibold glass-text-primary",children:a}),s.jsx("p",{className:"glass-mt-2 glass-text-sm glass-text-secondary",children:"Compact content keeps the grid readable across viewport sizes."})]},a))})}),args:{className:""}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  render: args => <section className="glass-neutral-level1 glass-w-full glass-max-w-5xl glass-rounded-2xl glass-p-6 glass-shadow-xl">
