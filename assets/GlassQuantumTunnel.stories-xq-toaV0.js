import{r as g,a as ce,b as w,j as a,d as re,m as G}from"./iframe-D7NmxSe9.js";import{u as ge}from"./a11y-AzHiXVvX.js";import{u as de}from"./useMotionPreference-2-Zuo_1E.js";import{O as me}from"./OptimizedGlassCore-KF10QAKi.js";import"./preload-helper-PPVm8Dsz.js";import"./deviceCapabilities-BxFGwbZv.js";const ne=(s,d,p)=>{const y=Math.sqrt(2*d),x=d/(2*Math.PI);return Math.sin(y*s-x*p)},he=(s,d,p)=>{if(s>=d)return 1;const y=Math.sqrt(2*(d-s));return Math.exp(-2*y*p)},m={error:s=>`rgba(100, 116, 139, ${Math.min(.48,s)})`,info:s=>`rgba(148, 163, 184, ${s})`,secondary:s=>`rgba(203, 213, 225, ${s})`,white:s=>`rgba(241, 245, 249, ${s})`,hover:"rgba(100, 116, 139, 0.28)"},v={background:"linear-gradient(145deg, rgba(255,255,255,0.105) 0%, rgba(255,255,255,0.035) 52%, rgba(255,255,255,0.018) 100%)",backgroundColor:"rgba(255,255,255,0.018)",border:"1px solid rgba(255,255,255,0.18)",color:"var(--glass-theme-text, var(--glass-text-primary))",backdropFilter:"blur(24px) saturate(1.5) brightness(1.06) contrast(1.04)",WebkitBackdropFilter:"blur(24px) saturate(1.5) brightness(1.06) contrast(1.04)",boxShadow:"0 12px 32px rgba(15, 23, 42, 0.12)"},R=g.forwardRef(({quantumStates:s=[],barriers:d=[],showWaveFunction:p=!0,showTunnelingProbability:y=!0,showEnergyLevels:x=!0,showBarriers:U=!0,animateTransitions:xe=!0,tunnelingSpeed:J=1,waveAmplitude:$=20,coherenceDecay:fe=.02,realTimeMode:z=!1,onStateTransition:K,onTunnelingEvent:X,className:te="",...ie},oe)=>{const f=ce(),Y=g.useRef(null),[h,le]=g.useState(0),[b,Z]=g.useState([]),[O,ee]=g.useState(new Set),[H,_]=g.useState([]);ge("glass-quantum-tunnel");const{shouldAnimate:ue}=de();g.useEffect(()=>{if(s.length===0){_([]);return}const n=s.map((e,r)=>({id:`particle-${e.id}`,x:e.position.x,y:e.position.y,energy:e.energy,wavePhase:Math.random()*Math.PI*2,tunneling:!1}));_(n)},[s]),g.useEffect(()=>{if(s.length===0)return;const n=setInterval(()=>{le(e=>e+.1*J)},w.DURATION.fast);return()=>clearInterval(n)},[J,s.length]),g.useEffect(()=>{if(!z||s.length===0)return;const n=setInterval(()=>{s.forEach(e=>{e.isActive&&e.connections.forEach(r=>{const o=s.find(u=>u.id===r);if(!o)return;const t=d.find(u=>Math.abs(u.position.x-(e.position.x+o.position.x)/2)<u.width/2);let i=1;t&&(i=he(e.energy,t.height,t.width)),Math.random()<i*.1&&(Z(u=>[...u,{from:e.id,to:r,progress:0,probability:i,startTime:h}]),X?.(i),K?.(e.id,r))})})},w.DURATION.slower*3);return()=>clearInterval(n)},[z,s,d,h,X,K]),g.useEffect(()=>{s.length!==0&&Z(n=>n.map(e=>({...e,progress:Math.min(1,(h-e.startTime)/5)})).filter(e=>e.progress<1))},[h,s.length]),g.useEffect(()=>{s.length!==0&&_(n=>n.map(e=>{const r=s.find(i=>i.id===e.id.replace("particle-",""));if(!r)return e;const o=(e.wavePhase+.1)%(2*Math.PI),t=b.find(i=>i.from===r.id&&i.progress<1);if(t){const i=s.find(u=>u.id===t.to);if(i)return{...e,x:r.position.x+(i.position.x-r.position.x)*t.progress,y:r.position.y+(i.position.y-r.position.y)*t.progress,wavePhase:o,tunneling:!0,targetState:t.to}}return{...e,x:r.position.x,y:r.position.y,wavePhase:o,tunneling:!1,targetState:void 0}}))},[s,b,h]),g.useEffect(()=>{const n=Y.current;if(!n)return;const e=n.getContext("2d");e&&(e.clearRect(0,0,n.width,n.height),U&&d.forEach(r=>{e.fillStyle=m.error(r.transparency),e.fillRect(r.position.x-r.width/2,50,r.width,r.height),e.fillStyle=m.white(.8),e.font="12px Arial",e.textAlign="center",e.fillText(`${r.height.toFixed(1)} eV`,r.position.x,45)}),x&&s.forEach(r=>{const o=200-r.energy*20;e.strokeStyle=m.info(.6),e.lineWidth=2,e.setLineDash&&e.setLineDash([5,5]),e.beginPath(),e.moveTo(r.position.x-30,o),e.lineTo(r.position.x+30,o),e.stroke(),e.setLineDash&&e.setLineDash([])}),p&&H.forEach(r=>{const o=s.find(t=>t.id===r.id.replace("particle-",""));if(o){e.strokeStyle=r.tunneling?m.secondary(.8):m.info(.6),e.lineWidth=2,e.beginPath();for(let t=-50;t<=50;t+=2){const i=ne(t/10,o.energy,h+r.wavePhase),u=o.position.y+i*$;t===-50?e.moveTo(r.x+t,u):e.lineTo(r.x+t,u)}e.stroke(),e.fillStyle=r.tunneling?m.secondary(.2):m.info(.2),e.beginPath(),e.moveTo(r.x-50,o.position.y);for(let t=-50;t<=50;t+=2){const i=ne(t/10,o.energy,h+r.wavePhase),u=o.position.y+Math.abs(i)*$*.5;e.lineTo(r.x+t,u)}e.lineTo(r.x+50,o.position.y),e.closePath(),e.fill()}}),H.forEach(r=>{const o=r.tunneling?8:6,t=r.tunneling?.9:.7;e.beginPath(),e.arc(r.x,r.y,o,0,2*Math.PI);const i=e.createRadialGradient(r.x,r.y,0,r.x,r.y,o);if(i.addColorStop(0,m.white(t)),i.addColorStop(1,m.info(t*.3)),e.fillStyle=i,e.fill(),r.tunneling)for(let u=1;u<=3;u++)e.beginPath(),e.arc(r.x,r.y,o+u*4,0,2*Math.PI),e.strokeStyle=m.secondary(.3/u),e.lineWidth=2,e.stroke()}),s.forEach(r=>{r.connections.forEach(o=>{const t=s.find(i=>i.id===o);t&&(e.strokeStyle=m.hover,e.lineWidth=1,e.setLineDash([3,3]),e.beginPath(),e.moveTo(r.position.x,r.position.y),e.lineTo(t.position.x,t.position.y),e.stroke(),e.setLineDash&&e.setLineDash([]))})}))},[s,H,d,h,p,x,U,$]);const se=n=>{ee(e=>new Set(e).add(n))},ae=g.useMemo(()=>s.reduce((n,e)=>n+e.tunnelingProbability,0)/Math.max(1,s.length),[s]);return a.jsx(me,{"data-glass-component":!0,ref:oe,variant:"frosted",className:`relative ${te}`,role:"region","aria-label":"Quantum tunneling visualization",...ie,children:a.jsxs("div",{className:"glass-p-6 glass-space-y-4",children:[a.jsxs("div",{className:"glass-flex glass-items-start glass-justify-between glass-flex-wrap glass-gap-3",children:[a.jsxs("div",{children:[a.jsx("h2",{className:"glass-text-xl glass-font-semibold glass-text-primary-glass-opacity-90",children:"Quantum Tunnel"}),a.jsxs("p",{className:"glass-text-sm glass-text-primary-glass-opacity-60",children:[s.length," quantum states • ",d.length," ","barriers"]})]}),a.jsxs("div",{className:"glass-flex glass-items-center glass-space-x-4",children:[a.jsxs("div",{className:"glass-text-sm glass-text-primary-glass-opacity-60",children:["T: ",(ae*100).toFixed(1),"%"]}),z&&a.jsxs("div",{className:"glass-flex glass-items-center glass-space-x-1 glass-text-primary",children:[a.jsx("div",{className:"glass-w-2 glass-h-2 glass-surface-green glass-radius-full glass-animate-pulse"}),a.jsx("span",{className:"glass-text-xs",children:"Live"})]})]})]}),a.jsxs("div",{className:"glass-relative",children:[a.jsx("style",{children:`
