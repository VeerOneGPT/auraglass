import{j as r}from"./iframe-C5od7h8K.js";import{L as a}from"./LiquidGlassToolbar-D68om_xZ.js";import"./preload-helper-PPVm8Dsz.js";import"./LiquidGlassMaterial-Ctjdw0yC.js";import"./LiquidGlassLayerProvider-CDXyPgOp.js";const n={title:"Navigation/Liquid Glass Toolbar",component:a,parameters:{layout:"fullscreen",previewSurface:"app"}},t=`
  .liquid-toolbar-story {
    ...
    --toolbar-story-panel:
      ...
      radial-gradient(circle at 86% 16%, rgba(255,255,255,0.28), rgba(255,255,255,0.08) 30%);
    min-height: 100vh;
  ...
  [data-storybook-preview-mode="dark"] .liquid-toolbar-story {
    ...
    --toolbar-story-panel:
      ...
      radial-gradient(circle at 86% 16%, rgba(255,255,255,0.12), rgba(255,255,255,0.02) 30%);
  }
  ...
  [data-storybook-preview-mode="liquid"] .liquid-toolbar-story {
    --toolbar-story-panel:
      ...
      radial-gradient(circle at 86% 16%, rgba(255,255,255,0.24), rgba(255,255,255,0.08) 30%);
  }
...
}`,...o.parameters?.docs?.source}}};const b=["Default"];export{o as Default,b as __namedExportsOrder,n as default};
