import{r as h,j as s,R as b,c as N}from"./iframe-D7NmxSe9.js";import{u as w}from"./a11y-AzHiXVvX.js";import{u as v}from"./MotionPreferenceContext-Dh_pw3dF.js";import"./preload-helper-PPVm8Dsz.js";const a=h.forwardRef(({columns:e=3,gap:t=12,children:o,className:i,respectMotionPreference:c=!0,"aria-label":d="Masonry layout",role:m="grid",...g},p)=>{const u=w(),{prefersReducedMotion:x}=v(),n=c&&!x;return s.jsx("div",{ref:p,id:u,className:N("w-full",n&&"motion-safe:transition-all motion-reduce:transition-none",i),style:{columnCount:e,columnGap:t},"aria-label":d,role:m,...g,children:b.Children.map(o,(f,y)=>s.jsx("div",{role:"gridcell",style:{breakInside:"avoid",marginBottom:t},className:n?"motion-safe:transition-all motion-reduce:transition-none":"",children:f},y))})});a.displayName="GlassMasonry";try{a.displayName="GlassMasonry",a.__docgenInfo={description:`GlassMasonry component
