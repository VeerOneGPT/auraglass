import{r as u,a as es,j as a,c as x,m as We}from"./iframe-LDZ2lzKB.js";import{u as ss}from"./useMotionPreference-13sabYj_.js";import{u as A}from"./a11y-Bm8A_Ibc.js";import{c as as}from"./createGlassStyle-Cr0Un8y6.js";import{u as ns}from"./soundDesign-D74LJfWl.js";import{P as ts,p as rs,q as is}from"./components-DD_B3kCE.js";import{O as os}from"./OptimizedGlassCore-e1josnyx.js";import"./preload-helper-PPVm8Dsz.js";import"./deviceCapabilities-DS6lz9Jr.js";const ls={volume:.8,gain:1,bassBoost:0,trebleBoost:0,smoothing:.8,fftSize:256},cs={mode:"bars",colorScheme:"monochrome",particleCount:100,sensitivity:1,symmetry:!1,mirror:!1},k={rainbow:["hsl(var(--glass-color-danger))","hsl(var(--glass-color-warning))","hsl(var(--glass-color-warning))","hsl(var(--glass-color-success))","hsl(var(--glass-color-success))","hsl(var(--glass-color-info))","hsl(var(--glass-color-info))","hsl(var(--glass-color-primary))","hsl(var(--glass-color-primary))","var(--glass-color-secondary)"],monochrome:["rgba(248,250,252,.96)","rgba(226,232,240,.96)","rgba(203,213,225,.96)","rgba(148,163,184,.96)","rgba(100,116,139,.96)","rgba(71,85,105,.96)","rgba(51,65,85,.96)","rgba(30,41,59,.96)"],neon:["#ff00ff","#ff0080","#ff0040","#ff8040","#ffff40","#80ff40","#40ff40","#40ff80","#40ffff","#4080ff"],fire:["#ffff00","#ffcc00","#ff9900","#ff6600","#ff3300","#ff0000","#cc0000","#990000"],ice:["var(--glass-white)","color-mix(in srgb, hsl(var(--glass-color-info)) 12%, white)","color-mix(in srgb, hsl(var(--glass-color-info)) 25%, white)","color-mix(in srgb, hsl(var(--glass-color-info)) 38%, white)","color-mix(in srgb, hsl(var(--glass-color-info)) 50%, white)","color-mix(in srgb, hsl(var(--glass-color-info)) 63%, white)","color-mix(in srgb, hsl(var(--glass-color-info)) 75%, white)","color-mix(in srgb, hsl(var(--glass-color-info)) 88%, white)"],galaxy:["#1a1a2e","#16213e","#0f3460","#533483","#7209b7","#a663cc","#4cc9f0"]},us={"--glass-text-primary":"rgba(15, 23, 42, 0.96)","--glass-text-secondary":"rgba(30, 41, 59, 0.84)","--glass-text-tertiary":"rgba(51, 65, 85, 0.72)","--typography-text-primary":"rgba(15, 23, 42, 0.96)","--typography-text-secondary":"rgba(30, 41, 59, 0.84)","--typography-text-tertiary":"rgba(51, 65, 85, 0.72)","--glass-theme-text":"rgba(15, 23, 42, 0.96)",color:"rgba(15, 23, 42, 0.96)"},le=u.forwardRef(({audioSource:f,audioSettings:Ne={},visualSettings:De={},compact:m=!1,contained:ce=!1,maxHeight:He,showControls:Re=!0,showFrequencyDisplay:ke=!1,showWaveform:gs=!0,showSpectrum:ms=!0,showSettings:Ve=!1,realTimeAnalysis:ue=!0,enableInteraction:ve=!0,enableRecording:hs=!1,canvasWidth:F=800,canvasHeight:M=400,onAudioLoad:Pe,onFrequencyData:be,onBeatDetected:Se,className:Be="",...Ge},Le)=>{const T=es(),[y,I]=u.useState(!1),[_e,ds]=u.useState(!1),[we,xe]=u.useState(0),[Ce,$e]=u.useState(0),[W,je]=u.useState(new Uint8Array(128)),[fs,qe]=u.useState(new Uint8Array(128)),[ge,Ee]=u.useState(0),[v,me]=u.useState({...ls,...Ne}),[d,he]=u.useState({...cs,...De}),N=u.useRef(null),h=u.useRef(null),C=u.useRef(null),j=u.useRef(null),de=u.useRef(null),w=u.useRef(),z=u.useRef([]),Ae=A("glass-music-mode"),ze=A("glass-music-color-scheme");A("glass-music-smoothing"),A("glass-music-fft-size");const Fe=A("glass-music-volume");A("glass-music-visualizer");const{shouldAnimate:S}=ss(),{play:q}=ns(),D=He??(m||ce?320:void 0),H=u.useCallback(async()=>{try{C.current||(C.current=new(window.AudioContext||window.webkitAudioContext));const e=C.current,s=e.createAnalyser();s.fftSize=v.fftSize,s.smoothingTimeConstant=v.smoothing,j.current=s;const t=s.frequencyBinCount;if(je(new Uint8Array(t)),qe(new Uint8Array(t)),f&&typeof f=="string"){const r=h.current;if(r){r.src=f;const n=e.createMediaElementSource(r);n.connect(s),s.connect(e.destination),de.current=n}}else if(f instanceof MediaStream){const r=e.createMediaStreamSource(f);r.connect(s),s.connect(e.destination),de.current=r}}catch{j.current=null,de.current=null}},[f,v.fftSize,v.smoothing]),Me=u.useCallback(e=>{const s=Math.floor(e.length*.1),t=Math.floor(e.length*.3);let r=0,n=0;for(let c=0;c<s;c++)r+=e[c];for(let c=s;c<t;c++)n+=e[c];const o=r/s,i=n/(t-s),l=(o+i)/2/255;return Ee(l),l>.7&&Se?.(l),l},[Se]),fe=u.useCallback(()=>{const e=N.current,s=j.current;if(!e||!s)return;const t=e.getContext("2d");if(!t)return;const r=new Uint8Array(s.frequencyBinCount),n=new Uint8Array(s.frequencyBinCount);s.getByteFrequencyData(r),s.getByteTimeDomainData(n),je(r),qe(n),be?.(r);const o=Me(r);t.fillStyle="rgba(var(--glass-color-black) / var(--glass-opacity-10))",t.fillRect(0,0,e.width,e.height);const i=k[d.colorScheme]||k.rainbow;switch(d.mode){case"bars":Ue(t,r,i,o);break;case"wave":Oe(t,n,i,o);break;case"circular":Ye(t,r,i,o);break;case"spectrum":Xe(t,r,i);break;case"particles":Je(t,r,i);break;case"ripples":Ke(t,r,i,o);break}ue&&y&&S&&!T&&(w.current=requestAnimationFrame(fe))},[d,ue,y,S,T,Me,be]),Ue=(e,s,t,r)=>{const n=e.canvas.width/s.length,o=d.sensitivity;for(let i=0;i<s.length;i++){const l=s[i]/255*e.canvas.height*o,c=Math.floor(i/s.length*t.length),g=Math.max(.3,r);e.fillStyle=t[c]+Math.floor(g*255).toString(16).padStart(2,"0"),e.fillRect(i*n,e.canvas.height-l,n-1,l),d.mirror&&e.fillRect(i*n,0,n-1,l)}},Oe=(e,s,t,r)=>{e.lineWidth=2+r*3,e.strokeStyle=t[Math.floor(r*t.length)],e.beginPath();const n=e.canvas.width/s.length;let o=0;for(let i=0;i<s.length;i++){const c=s[i]/128*d.sensitivity*e.canvas.height/2;i===0?e.moveTo(o,c):e.lineTo(o,c),o+=n}e.stroke()},Ye=(e,s,t,r)=>{const n=e.canvas.width/2,o=e.canvas.height/2,i=Math.min(n,o)*.7;for(let l=0;l<s.length;l++){const c=l/s.length*Math.PI*2,g=s[l]/255*i*d.sensitivity*.5,p=n+Math.cos(c)*i,b=o+Math.sin(c)*i,R=n+Math.cos(c)*(i+g),pe=o+Math.sin(c)*(i+g),ye=Math.floor(l/s.length*t.length);e.strokeStyle=t[ye],e.lineWidth=1+r*2,e.beginPath(),e.moveTo(p,b),e.lineTo(R,pe),e.stroke()}},Xe=(e,s,t,r)=>{const{width:n,height:o}=e.canvas;e.drawImage(e.canvas,1,0,n-1,o,0,0,n-1,o),e.clearRect(n-1,0,1,o);const i=n-1;for(let l=0;l<s.length;l++){const c=Math.floor(l/s.length*o),g=s[l]/255,p=Math.floor(g*t.length),b=t[p]||"#ffffff";e.fillStyle=b.startsWith("#")?`${b}${Math.round(g*255).toString(16).padStart(2,"0")}`:b,e.fillRect(i,c,1,Math.max(1,Math.ceil(o/s.length)))}},Je=(e,s,t,r)=>{z.current=z.current.filter(n=>(n.x+=n.vx,n.y+=n.vy,n.life-=.01,n.vy+=.1,n.life>0&&n.x>=0&&n.x<=e.canvas.width&&n.y>=0&&n.y<=e.canvas.height));for(let n=0;n<s.length;n+=4)if(z.current.length<d.particleCount){const o=s[n]/255;o>.1&&z.current.push({x:n/s.length*e.canvas.width,y:e.canvas.height-o*e.canvas.height*.5,vx:(Math.random()-.5)*4,vy:-Math.random()*o*5,size:o*5+1,color:t[Math.floor(o*t.length)],life:1})}z.current.forEach(n=>{e.save(),e.globalAlpha=n.life,e.fillStyle=n.color,e.beginPath(),e.arc(n.x,n.y,n.size,0,Math.PI*2),e.fill(),e.restore()})},Ke=(e,s,t,r)=>{const n=e.canvas.width/2,o=e.canvas.height/2;if(s.reduce((i,l)=>i+l,0)/s.length/255,r>.3)for(let l=0;l<5;l++){const c=r*200+l*50,g=Math.max(0,1-c/300);e.strokeStyle=t[l%t.length]+Math.floor(g*255).toString(16).padStart(2,"0"),e.lineWidth=3,e.beginPath(),e.arc(n,o,c,0,Math.PI*2),e.stroke()}for(let i=0;i<s.length;i+=8){const l=i/s.length*Math.PI*2,c=s[i]/255,g=c*100+50,p=n+Math.cos(l)*g,b=o+Math.sin(l)*g;e.fillStyle=t[Math.floor(c*t.length)],e.beginPath(),e.arc(p,b,c*5+1,0,Math.PI*2),e.fill()}},Te=u.useCallback(async()=>{if(C.current||await H(),h.current)try{await h.current.play(),I(!0),S&&!T&&fe(),q("play")}catch{I(!1)}},[H,fe,q,S,T]),Ie=u.useCallback(()=>{h.current&&(h.current.pause(),I(!1),w.current&&cancelAnimationFrame(w.current),q("pause"))},[q]),Qe=u.useCallback(()=>{h.current&&(h.current.pause(),h.current.currentTime=0,I(!1),xe(0),w.current&&cancelAnimationFrame(w.current),q("stop"))},[q]);u.useEffect(()=>(f&&H(),()=>{w.current&&cancelAnimationFrame(w.current),C.current&&C.current.close()}),[f,H]),u.useEffect(()=>{const e=N.current;e&&(e.width=F,e.height=M)},[F,M]),u.useEffect(()=>{const e=N.current;if(!e||j.current&&y)return;const s=e.getContext("2d");if(!s)return;const{width:t,height:r}=e,n=s.createLinearGradient(0,0,t,r);n.addColorStop(0,"rgba(255, 255, 255, 0.18)"),n.addColorStop(.48,"rgba(255, 255, 255, 0.08)"),n.addColorStop(1,"rgba(255, 255, 255, 0.12)"),s.clearRect(0,0,t,r),s.fillStyle="rgba(255, 255, 255, 0.08)",s.fillRect(0,0,t,r),s.fillStyle=n,s.fillRect(0,0,t,r);const o=k[d.colorScheme]||k.rainbow,i=m?32:56,l=m?3:4,c=Math.max(3,(t-l*(i-1))/i);for(let g=0;g<i;g+=1){const p=g/Math.max(1,i-1),b=.25+Math.abs(Math.sin(p*Math.PI*3.2))*.48+Math.abs(Math.cos(p*Math.PI*8.4))*.16,R=Math.min(r*.82,r*b),pe=g*(c+l),ye=r-R-r*.08;s.fillStyle=o[g%o.length],s.globalAlpha=.74,s.fillRect(pe,ye,c,R)}s.globalAlpha=1,s.strokeStyle="rgba(255,255,255,0.14)",s.lineWidth=1,s.beginPath(),s.moveTo(0,r*.5);for(let g=0;g<=t;g+=8){const p=r*.5+Math.sin(g/t*Math.PI*4)*(m?10:18);s.lineTo(g,p)}s.stroke()},[F,M,m,y,d.colorScheme]);const Ze=()=>a.jsxs("div",{className:x("glass-flex glass-items-center glass-gap-2",m?"glass-flex-wrap":"glass-space-x-4"),children:[a.jsx("style",{children:`.glass-music-visualizer,
          ...
          .glass-music-visualizer input[type="range"]::-moz-range-thumb {
            ...
            background: rgba(255,255,255,.98);
            box-shadow: 0 4px 12px rgba(15,23,42,.2);
          }`}),a.jsx(We.button,{className:x("glass-text-primary glass-radius-lg glass-transition-colors",m?"glass-p-1.5 glass-text-xs":"glass-p-2"),whileHover:S?{scale:1.1}:{},whileTap:S?{scale:.9}:{},onClick:y?Ie:Te,style:{color:"rgba(15, 23, 42, 0.96)"},"aria-label":y?"Pause visualization":"Play visualization",children:y?a.jsx(ts,{className:"glass-h-4 glass-w-4","aria-hidden":"true"}):a.jsx(rs,{className:"glass-h-4 glass-w-4","aria-hidden":"true"})}),a.jsx(We.button,{className:x("glass-text-primary glass-radius-lg glass-transition-colors",m?"glass-p-1.5 glass-text-xs":"glass-p-2"),whileHover:S?{scale:1.1}:{},whileTap:S?{scale:.9}:{},onClick:Qe,style:{color:"rgba(15, 23, 42, 0.96)"},"aria-label":"Stop visualization",children:a.jsx(is,{className:"glass-h-4 glass-w-4","aria-hidden":"true"})}),a.jsxs("div",{className:"glass-flex glass-items-center glass-gap-1",children:[a.jsxs("span",{className:"glass-text-xs",style:{color:"rgba(30, 41, 59, 0.88)"},children:[Math.floor(we/60),":",Math.floor(we%60).toString().padStart(2,"0")]}),a.jsx("span",{style:{color:"rgba(51, 65, 85, 0.82)"},children:"/"}),a.jsxs("span",{className:"glass-text-xs",style:{color:"rgba(30, 41, 59, 0.88)"},children:[Math.floor(Ce/60),":",Math.floor(Ce%60).toString().padStart(2,"0")]})]}),a.jsxs("div",{className:"glass-flex glass-items-center glass-gap-1",children:[a.jsx("label",{htmlFor:Fe,className:"glass-text-xs",style:{color:"rgba(30, 41, 59, 0.92)"},children:m?"Vol":"Volume:"}),a.jsxs("div",{className:x("glass-relative glass-h-5",m?"glass-w-12":"glass-w-16"),children:[a.jsx("span",{"aria-hidden":"true",className:"glass-absolute glass-left-0 glass-right-0 glass-top-1/2 glass-h-2 glass-radius-full",style:{background:"rgba(255,255,255,.28)",border:"1px solid rgba(71,85,105,.34)",transform:"translateY(-50%)"}}),a.jsx("span",{"aria-hidden":"true",className:"glass-absolute glass-top-1/2 glass-h-4 glass-w-4 glass-radius-full",style:{left:`calc(${v.volume*100}% - 8px)`,background:"rgba(255,255,255,.98)",border:"1px solid rgba(71,85,105,.4)",boxShadow:"0 3px 9px rgba(15,23,42,.18)",transform:"translateY(-50%)"}}),a.jsx("input",{type:"range",min:"0",max:"1",step:"0.1",value:v.volume,onChange:e=>{const s=parseFloat(e.target.value);me(t=>({...t,volume:s})),h.current&&(h.current.volume=s)},className:"glass-absolute glass-inset-0 glass-h-full glass-w-full glass-cursor-pointer",style:{opacity:.001},"aria-label":"Volume",id:Fe})]})]})]});return a.jsxs(os,{ref:Le,variant:"frosted","data-glass-component":!0,className:x("glass-music-visualizer glass-max-w-full glass-overflow-auto",m?"glass-p-3 glass-space-y-2":"glass-p-4 glass-space-y-4",Be),style:{...us,background:"rgba(255,255,255,.28)",border:"1px solid rgba(148,163,184,.3)",boxShadow:"0 24px 64px rgba(15,23,42,.14), inset 0 1px 0 rgba(255,255,255,.9)",maxHeight:D!==void 0?typeof D=="number"?`${D}px`:D:"100%",overflow:m||ce?"auto":void 0,minWidth:0},...Ge,children:[a.jsxs("div",{className:"glass-flex glass-items-center glass-justify-between glass-gap-3",children:[a.jsxs("div",{className:"glass-min-w-0",children:[a.jsx("h3",{className:x("glass-font-semibold glass-truncate",m?"glass-text-sm":"glass-text-lg"),style:{color:"rgba(15, 23, 42, 0.96)"},children:"Music Visualizer"}),a.jsx("p",{className:x(m||ce?"glass-whitespace-normal glass-break-words":"glass-truncate",m?"glass-text-xs":"glass-text-sm"),style:{color:"rgba(30, 41, 59, 0.88)"},children:"Real-time audio visualization and analysis"})]}),a.jsxs("div",{className:"glass-flex glass-items-center glass-space-x-2",children:[ue&&a.jsxs("div",{className:"glass-flex glass-items-center glass-space-x-1 glass-text-primary",children:[a.jsx("div",{className:"glass-w-2 glass-h-2 glass-surface-green glass-radius-full glass-animate-pulse"}),a.jsx("span",{className:"glass-text-xs",children:"Live"})]}),_e&&a.jsxs("div",{className:"glass-flex glass-items-center glass-space-x-1 glass-text-primary",children:[a.jsx("div",{className:"glass-w-2 glass-h-2 glass-surface-red glass-radius-full glass-animate-pulse"}),a.jsx("span",{className:"glass-text-xs",children:"Recording"})]})]})]}),f&&typeof f=="string"&&a.jsx("audio",{ref:h,src:f,onLoadedMetadata:()=>{h.current&&($e(h.current.duration),Pe?.(h.current.duration))},onTimeUpdate:()=>{h.current&&xe(h.current.currentTime)}}),Re&&a.jsx(Ze,{}),a.jsxs("div",{className:"glass-relative",children:[a.jsx("canvas",{ref:N,width:F,height:M,className:`
