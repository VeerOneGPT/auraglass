import{j as r}from"./iframe-W10Ontp8.js";import{F as i}from"./FeatureTile-DKD5rWRD.js";import"./preload-helper-PPVm8Dsz.js";import"./ShowcaseCard-Bpm9li7h.js";/* empty css                  */const c={title:"Marketing/Feature Tile",component:i,parameters:{layout:"padded"},argTypes:{size:{control:"select",options:["sm","md","lg"]},tone:{control:"select",options:["neutral","aurora","success","info","warning"]}}},e={args:{index:"01",title:"Refractive depth",description:"Reusable marketing cards with package-owned token defaults.",tone:"aurora",visual:r.jsx("div",{style:{height:80}})}},t={render:()=>r.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(3, minmax(0, 1fr))",gap:16},children:["SSR safe","Reduced motion","Token driven"].map((a,n)=>r.jsx(i,{index:n+1,title:a,description:"Built for package consumers and homepage composition.",visual:r.jsx("div",{style:{height:72}})},a))})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    index: "01",
