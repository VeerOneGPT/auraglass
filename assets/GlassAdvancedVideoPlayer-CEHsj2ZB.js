import{r as g,R as Ee,j as e,c as w,f as C}from"./iframe-LDZ2lzKB.js";import{u as Re}from"./GlassMediaProvider-Bjf72AhD.js";import{G as oe}from"./GlassCore-B6VBG55O.js";const S=s=>{if(isNaN(s))return"0:00";const d=Math.floor(s/3600),r=Math.floor(s%3600/60),i=Math.floor(s%60);return d>0?`${d}:${r.toString().padStart(2,"0")}:${i.toString().padStart(2,"0")}`:`${r}:${i.toString().padStart(2,"0")}`},Ae=s=>s.subtitles?.flatMap(d=>d.content?.map(r=>({...r,keywords:[],sentiment:"neutral"}))??[])??[],ne=(s,d)=>!Number.isFinite(s)||!Number.isFinite(d)||d<=0?0:Math.max(0,Math.min(100,s/d*100)),qe=s=>!!s?.startsWith("data:video/"),Le="data:image/svg+xml,"+encodeURIComponent(`
  ...
  `),$={...C({intent:"neutral",elevation:"level4",interactive:!0}),appearance:"none",WebkitAppearance:"none",border:"1px solid rgba(148, 163, 184, 0.42)",color:"#0f172a",background:"linear-gradient(180deg, rgba(255,255,255,.32), rgba(248,250,252,.22))",boxShadow:"inset 0 1px 0 rgba(255,255,255,0.12), 0 12px 28px rgba(2,6,23,0.28)"},Ie={...C({intent:"neutral",elevation:"level4",interactive:!0}),appearance:"none",WebkitAppearance:"none",color:"#0f172a",background:"linear-gradient(180deg, rgba(255,255,255,.35), rgba(248,250,252,.25))",borderColor:"rgba(148, 163, 184, 0.48)",boxShadow:"inset 0 1px 0 rgba(255,255,255,0.12), 0 12px 28px rgba(2,6,23,0.28)"},Z={...C({intent:"neutral",elevation:"level4"}),color:"#0f172a",border:"1px solid rgba(148, 163, 184, 0.34)",boxShadow:"0 18px 38px rgba(2, 6, 23, 0.42)"},$e={appearance:"none",WebkitAppearance:"none",color:"#334155",accentColor:"#334155"},Ge=`
