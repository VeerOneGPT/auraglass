import{j as e}from"./iframe-D7NmxSe9.js";import{L as i}from"./LiquidGlassInspectorPanel-B_Hs_7MD.js";import"./preload-helper-PPVm8Dsz.js";import"./LiquidGlassMaterial-BoYaHFKo.js";import"./LiquidGlassLayerProvider-DfdCh4M5.js";import"./LiquidGlassScrollEdge-D4YOZCLK.js";const c={title:"Navigation/Liquid Glass Inspector Panel",component:i,parameters:{layout:"fullscreen",previewSurface:"app"}},t=`
...
`,r={render:()=>e.jsxs("div",{className:"liquid-inspector-story",children:[e.jsx("style",{children:t}),e.jsxs("div",{className:"liquid-inspector-work-area",children:[e.jsx("h2",{style:{margin:0},children:"Selected photo"}),e.jsx("p",{className:"liquid-inspector-muted",children:"The inspector is anchored to a composed work area with readable surrounding content."})]}),e.jsx(i,{open:!0,selectionLabel:"Hero image - final crop",sections:[{id:"properties",title:"Properties",content:e.jsx("div",{className:"liquid-inspector-muted",children:"1200 x 900, sRGB, approved"})},{id:"access",title:"Access",content:e.jsx("div",{className:"liquid-inspector-muted",children:"Shared with design review"})}],style:{width:"100%",minHeight:520}})]})};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: () => <div className="liquid-inspector-story">
      ...
      id: "properties",
      title: "Properties",
      content: <div className="liquid-inspector-muted">
