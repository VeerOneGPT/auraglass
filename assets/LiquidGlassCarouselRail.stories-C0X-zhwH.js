import{r as o,j as s,c as m}from"./iframe-f4tkjEOL.js";import{L as d}from"./LiquidGlassScrollEdge-CgtX-phf.js";import"./preload-helper-PPVm8Dsz.js";const a=o.forwardRef(({items:i,showScrollButtons:e=!0,className:c,children:u,...g},p)=>{const r=o.useRef(null),t=n=>r.current?.scrollBy({left:n,behavior:"smooth"});return s.jsxs("div",{ref:p,className:m("liquid-glass-carousel-rail glass-relative",c),"data-liquid-glass-carousel-rail":"true",...g,children:[s.jsx(d,{edge:"left",styleMode:"soft",targetRef:r}),s.jsxs("div",{ref:r,className:"glass-flex glass-gap-3 glass-overflow-x-auto glass-px-8 glass-py-2","data-liquid-glass-scroll-target":!0,children:[i?.map((n,f)=>s.jsx("div",{className:"glass-shrink-0",children:n},f)),u]}),s.jsx(d,{edge:"right",styleMode:"soft",targetRef:r}),e&&s.jsxs(s.Fragment,{children:[s.jsx("button",{type:"button","aria-label":"Scroll left",className:"glass-absolute glass-left-0 glass-top-1/2",onClick:()=>t(-240),children:"‹"}),s.jsx("button",{type:"button","aria-label":"Scroll right",className:"glass-absolute glass-right-0 glass-top-1/2",onClick:()=>t(240),children:"›"})]})]})});a.displayName="LiquidGlassCarouselRail";try{a.displayName="LiquidGlassCarouselRail",a.__docgenInfo={description:"",displayName:"LiquidGlassCarouselRail",props:{items:{defaultValue:null,description:"",name:"items",required:!1,type:{name:"ReactNode[] | undefined"}},showScrollButtons:{defaultValue:{value:"true"},description:"",name:"showScrollButtons",required:!1,type:{name:"boolean | undefined"}}}}}catch{}const y={title:"Data + Visualization/Liquid Glass Carousel Rail",component:a,parameters:{layout:"fullscreen",previewSurface:"app"}},l={render:()=>s.jsxs("div",{style:{minHeight:"100vh",display:"grid",placeItems:"center",padding:32,boxSizing:"border-box"},children:[s.jsx("style",{children:`
