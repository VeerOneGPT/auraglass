...
export default App;`,language:"typescript"}],onFileChange:(...c)=>console.log("Mock function called",...c)}),args:{}},E={render:t=>e.jsx(S,{files:[{name:"package.json",content:`{
  "name": "my-project",
  "version": "1.0.0",
  "scripts": {
...
2. Start development server: \`npm start\``,language:"markdown"}],onFileChange:(...c)=>console.log("Mock function called",...c)}),args:{}};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  args: {
