import{r as n,j as a,c as u}from"./iframe-D7NmxSe9.js";import{L as v}from"./LiquidGlassMaterial-BoYaHFKo.js";import{L as w}from"./LiquidGlassScrollEdge-D4YOZCLK.js";import"./preload-helper-PPVm8Dsz.js";import"./LiquidGlassLayerProvider-DfdCh4M5.js";const i=n.forwardRef(({open:r,onOpenChange:g,items:p,placeholder:h="Search commands",className:x,...b},f)=>{const[o,y]=n.useState(""),[t,d]=n.useState(0),m=n.useRef(null),c=n.useMemo(()=>p.filter(e=>e.label.toLowerCase().includes(o.toLowerCase())),[p,o]);return r?a.jsxs("div",{className:"glass-fixed glass-inset-0 glass-z-1200 glass-grid glass-place-items-start glass-overflow-y-auto glass-px-4 glass-py-16 sm:glass-px-6 sm:glass-py-24",children:[a.jsx("div",{"aria-hidden":"true","data-glass-overlay":"true",className:"glass-absolute glass-inset-0 glass-bg-white/20 glass-backdrop-blur-md",onClick:()=>g?.(!1)}),a.jsxs(v,{ref:f,material:"liquid",radius:"2xl",className:u("liquid-glass-command-surface glass-relative glass-z-10 glass-mx-auto glass-w-full glass-max-w-2xl glass-overflow-hidden",x),style:{background:"linear-gradient(135deg, rgba(255,255,255,0.30), rgba(255,255,255,0.18) 55%, rgba(255,255,255,0.12))",color:"var(--glass-theme-text, var(--glass-text-primary))","--glass-theme-text":"rgba(15,23,42,0.94)","--glass-theme-text-secondary":"rgba(15,23,42,0.76)"},...b,children:[a.jsx("input",{value:o,onChange:e=>y(e.target.value),onKeyDown:e=>{e.key==="Escape"&&g?.(!1),e.key==="ArrowDown"&&d(s=>Math.min(s+1,c.length-1)),e.key==="ArrowUp"&&d(s=>Math.max(s-1,0)),e.key==="Enter"&&c[t]?.onSelect?.()},role:"combobox","aria-expanded":!0,placeholder:h,className:"glass-w-full glass-bg-transparent glass-p-4 glass-outline-none"}),a.jsxs("div",{ref:m,role:"listbox",className:"glass-relative glass-max-h-[min(24rem,calc(100vh-12rem))] glass-overflow-y-auto glass-p-2 glass-space-y-2","data-liquid-glass-scroll-target":!0,children:[a.jsx(w,{edge:"top",styleMode:"soft",targetRef:m}),c.map((e,s)=>a.jsxs("button",{type:"button",role:"option","aria-selected":s===t,disabled:e.disabled,className:u("glass-flex glass-w-full glass-min-w-0 glass-items-center glass-gap-3 glass-radius-lg glass-px-3 glass-py-2 glass-text-left",s===t&&"glass-surface-primary/20"),style:{background:s===t?"rgba(255,255,255,0.24)":"rgba(255,255,255,0.12)",color:"var(--glass-theme-text, var(--glass-text-primary))"},onMouseEnter:()=>d(s),onClick:e.onSelect,children:[e.icon,a.jsxs("span",{className:"glass-min-w-0 glass-flex-1",children:[a.jsx("span",{className:"glass-block glass-truncate glass-text-primary",children:e.label}),e.description&&a.jsx("span",{className:"glass-block glass-truncate glass-text-xs glass-text-secondary",style:{color:"var(--glass-theme-text-secondary, var(--glass-text-secondary))"},children:e.description})]}),e.shortcut&&a.jsx("span",{className:"glass-shrink-0 glass-text-xs glass-text-secondary",style:{color:"var(--glass-theme-text-secondary, var(--glass-text-secondary))"},children:e.shortcut})]},e.id))]})]})]}):null});i.displayName="LiquidGlassCommandSurface";try{i.displayName="LiquidGlassCommandSurface",i.__docgenInfo={description:"",displayName:"LiquidGlassCommandSurface",props:{open:{defaultValue:null,description:"",name:"open",required:!0,type:{name:"boolean"}},onOpenChange:{defaultValue:null,description:"",name:"onOpenChange",required:!1,type:{name:"((open: boolean) => void) | undefined"}},items:{defaultValue:null,description:"",name:"items",required:!0,type:{name:"LiquidGlassCommandItem[]"}},placeholder:{defaultValue:{value:"Search commands"},description:"",name:"placeholder",required:!1,type:{name:"string | undefined"}}}}}catch{}const N={title:"Effects + Advanced/Liquid Glass Command Surface",component:i,parameters:{layout:"fullscreen",previewSurface:"app"}},l={render:()=>a.jsxs("div",{"data-bg":"light",className:"glass-on-light",style:{minHeight:"100vh",width:"100%",padding:32,boxSizing:"border-box",color:"#0f172a"},children:[a.jsx("style",{children:`
