import{r as p,j as a,c}from"./iframe-D7NmxSe9.js";import{L as m}from"./LiquidGlassControlGroup-BjLrZ5DQ.js";import"./preload-helper-PPVm8Dsz.js";import"./LiquidGlassMaterial-BoYaHFKo.js";import"./LiquidGlassLayerProvider-DfdCh4M5.js";const n=p.forwardRef(({controls:i,placement:t="top-right",materialVariant:l="clear",className:o,...s},d)=>a.jsx("div",{ref:d,className:c("liquid-glass-map-controls glass-absolute glass-z-30",o),"data-liquid-glass-map-controls":"true","data-placement":t,...s,children:a.jsx(m,{orientation:"vertical",materialVariant:l,"aria-label":"Map controls",className:"glass-map-control-material",style:{background:"linear-gradient(135deg, rgba(255,255,255,0.30), rgba(255,255,255,0.18) 55%, rgba(255,255,255,0.12))"},children:i.map(e=>a.jsx("button",{type:"button",disabled:e.disabled,"aria-label":e.label,className:"glass-radius-full glass-p-2 glass-mb-1 last:glass-mb-0",onClick:e.onClick,children:e.icon??e.label},e.id))})}));n.displayName="LiquidGlassMapControls";try{n.displayName="LiquidGlassMapControls",n.__docgenInfo={description:"",displayName:"LiquidGlassMapControls",props:{controls:{defaultValue:null,description:"",name:"controls",required:!0,type:{name:"LiquidGlassMapControl[]"}},placement:{defaultValue:{value:"top-right"},description:"",name:"placement",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"bottom-right"'},{value:'"bottom-left"'},{value:'"top-right"'},{value:'"top-left"'}]}},materialVariant:{defaultValue:{value:"clear"},description:"",name:"materialVariant",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"regular"'},{value:'"clear"'}]}}}}}catch{}const f={title:"Effects + Advanced/Liquid Glass Map Controls",component:n,parameters:{layout:"fullscreen",previewSurface:"app"}},r={render:()=>a.jsxs("div",{style:{minHeight:"100vh",width:"100%",display:"grid",placeItems:"center",padding:32,boxSizing:"border-box"},children:[a.jsx("style",{children:`
        .liquid-map-story {
          position: relative;
          width: min(980px, 100%);
          min-height: 560px;
