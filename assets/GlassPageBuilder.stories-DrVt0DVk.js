import{j as e,r as n,c as i,b as D}from"./iframe-D7NmxSe9.js";import{D as _,u as P}from"./GlassDragDropProvider-9TIFEPfN.js";import{G as T}from"./GlassComponentPalette-qjPARrvz.js";import{G as E}from"./GlassCanvas-DF3xhKjd.js";import{G as A}from"./GlassPropertyPanel-dQJrpSgz.js";import{G as I}from"./GlassPageStructure-pkKmkRd9.js";import"./preload-helper-PPVm8Dsz.js";import"./GlassCore-N3X42H-m.js";import"./colorInput-DwY-dk75.js";const L=[{key:"desktop",icon:"🖥️",label:"Desktop"},{key:"tablet",icon:"📱",label:"Tablet"},{key:"mobile",icon:"📱",label:"Mobile"}],R=()=>{const{pageState:s,undo:d,redo:p,canUndo:m,canRedo:c,togglePreviewMode:t,setActiveBreakpoint:o,toggleGrid:g,toggleSnapToGrid:b,clearPage:f,exportPage:u,importPage:h}=P(),x=n.useCallback(()=>{const a=u();localStorage.setItem("glass-page-builder-autosave",JSON.stringify(a))},[u]),v=n.useCallback(()=>{const a=localStorage.getItem("glass-page-builder-autosave");if(a)try{const r=JSON.parse(a);h(r)}catch{}},[h]);return n.useEffect(()=>{const a=setInterval(()=>{s.components.length>0&&x()},D.DURATION.slower*42);return()=>clearInterval(a)},[s.components.length,x]),e.jsxs("div",{"data-glass-component":!0,className:"glass-flex glass-items-center glass-justify-between glass-flex-wrap glass-p-4 glass-surface-subtle glass-border-b glass-border-subtle",style:{rowGap:8},children:[e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-4 glass-flex-wrap",children:[e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-2 glass-flex-wrap",children:[e.jsx("h1",{className:"glass-text-xl glass-font-bold glass-text-secondary",children:"Page Builder"}),e.jsx("span",{className:"glass-text-xs glass-text-secondary glass-surface-subtle glass-px-2 glass-py-1 glass-radius",children:"v1.0"})]}),e.jsx("div",{className:"glass-w-px glass-h-6 glass-surface-subtle"}),e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-2 glass-flex-wrap",children:[e.jsxs("button",{onClick:f,className:"glass-flex glass-items-center glass-gap-2 glass-px-3 glass-py-2 glass-text-sm glass-text-secondary hover:glass-surface-subtle glass-radius-md glass-transition-colors glass-focus glass-touch-target glass-contrast-guard glass-focus glass-touch-target glass-contrast-guard",children:[e.jsx("span",{children:"🗑️"}),"New"]}),e.jsxs("button",{onClick:x,className:"glass-flex glass-items-center glass-gap-2 glass-px-3 glass-py-2 glass-text-sm glass-text-secondary hover:glass-surface-subtle glass-radius-md glass-transition-colors glass-focus glass-touch-target glass-contrast-guard glass-focus glass-touch-target glass-contrast-guard",children:[e.jsx("span",{children:"💾"}),"Save"]}),e.jsxs("button",{onClick:v,className:"glass-flex glass-items-center glass-gap-2 glass-px-3 glass-py-2 glass-text-sm glass-text-secondary hover:glass-surface-subtle glass-radius-md glass-transition-colors glass-focus glass-touch-target glass-contrast-guard glass-focus glass-touch-target glass-contrast-guard",children:[e.jsx("span",{children:"📁"}),"Load"]})]}),e.jsx("div",{className:"glass-w-px glass-h-6 glass-surface-subtle"}),e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-1 glass-flex-wrap",children:[e.jsx("button",{onClick:d,disabled:!m(),className:i("p-2 rounded-md transition-colors",m()?"glass-text-secondary hover:bg-white/10 hover:glass-text-primary":"glass-text-disabled cursor-not-allowed"),title:"Undo (Ctrl+Z)",children:"↶"}),e.jsx("button",{onClick:p,disabled:!c(),className:i("p-2 rounded-md transition-colors",c()?"glass-text-secondary hover:bg-white/10 hover:glass-text-primary":"glass-text-disabled cursor-not-allowed"),title:"Redo (Ctrl+Y)",children:"↷"})]})]}),e.jsx("div",{className:"glass-flex glass-items-center glass-gap-2 glass-surface-subtle glass-radius-lg glass-p-1 glass-flex-wrap",children:L.map(a=>e.jsxs("button",{onClick:()=>o(a.key),className:i("flex items-center gap-2 px-3 py-2 text-sm rounded-md transition-colors",s.activeBreakpoint===a.key?"bg-white/15 glass-text-primary shadow-sm":"glass-text-secondary hover:glass-text-primary"),title:a.label,children:[e.jsx("span",{children:a.icon}),a.label]},a.key))}),e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-4 glass-flex-wrap",children:[e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-2 glass-flex-wrap",children:[e.jsxs("button",{onClick:g,className:i("flex items-center gap-2 px-3 py-2 text-sm rounded-md transition-colors",s.showGrid?"glass-cms-control-frost glass-text-primary glass-shadow-sm":"glass-text-secondary hover:glass-surface-subtle"),children:[e.jsx("span",{children:"⊞"}),"Grid"]}),e.jsxs("button",{onClick:b,className:i("flex items-center gap-2 px-3 py-2 text-sm rounded-md transition-colors",s.snapToGrid?"glass-cms-control-frost glass-text-primary glass-shadow-sm":"glass-text-secondary hover:glass-surface-subtle"),children:[e.jsx("span",{children:"🧲"}),"Snap"]})]}),e.jsx("div",{className:"glass-w-px glass-h-6 glass-surface-subtle"}),e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-2 glass-flex-wrap",children:[e.jsxs("button",{onClick:t,className:i("flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-md transition-colors",s.previewMode?"glass-cms-control-frost glass-text-primary glass-shadow-sm":"glass-cms-control-frost glass-text-secondary hover:glass-text-primary"),children:[e.jsx("span",{children:s.previewMode?"👁️":"✏️"}),s.previewMode?"Exit Preview":"Preview"]}),e.jsxs("button",{onClick:()=>{u(),alert("Page published! (Demo)")},className:"glass-flex glass-items-center glass-gap-2 glass-px-4 glass-py-2 glass-text-sm glass-font-medium glass-cms-control-frost glass-text-primary glass-shadow-sm glass-radius-md glass-transition-colors",children:[e.jsx("span",{children:"🚀"}),"Publish"]})]})]})]})},G=({className:s,initialData:d,onSave:p,onPreview:m,onPublish:c,"data-testid":t})=>{const{importPage:o}=P(),[g,b]=n.useState(!1),[f,u]=n.useState(!1),[h,x]=n.useState("components"),[v,a]=n.useState(!1);return n.useEffect(()=>{const r=()=>a(window.innerWidth<1024);return r(),window.addEventListener("resize",r),()=>window.removeEventListener("resize",r)},[]),n.useEffect(()=>{v&&(b(!0),u(!0))},[v]),n.useEffect(()=>{if(d)o(d);else{const r=localStorage.getItem("glass-page-builder-autosave");if(r)try{const l=JSON.parse(r);o(l)}catch{}}},[d,o]),n.useEffect(()=>{const r=l=>{if((l.metaKey||l.ctrlKey)&&!l.shiftKey&&!l.altKey)switch(l.key){case"z":l.preventDefault();break;case"y":l.preventDefault();break;case"s":l.preventDefault();break;case"p":l.preventDefault();break}};return document.addEventListener("keydown",r),()=>document.removeEventListener("keydown",r)},[p,m]),e.jsxs("div",{className:i("h-screen flex flex-col glass-overflow-auto glass-surface-subtle",s),"data-testid":t,children:[e.jsx(R,{}),e.jsxs("div",{className:"glass-flex-1 glass-flex glass-overflow-auto",children:[e.jsxs("div",{className:"glass-flex",children:[!g&&e.jsxs("div",{className:"glass-w-12 glass-surface-subtle glass-border-r glass-border-subtle glass-flex glass-flex-col",style:{gap:8,paddingBlock:8},children:[e.jsxs("button",{onClick:()=>x("components"),className:i("flex flex-col items-center gap-1 p-3 text-xs transition-colors",h==="components"?"glass-cms-control-frost glass-text-primary glass-shadow-sm":"glass-text-secondary hover:glass-surface-subtle"),title:"Components",children:[e.jsx("span",{className:"glass-text-lg",children:"📦"}),"Comp"]}),e.jsxs("button",{onClick:()=>x("structure"),className:i("flex flex-col items-center gap-1 p-3 text-xs transition-colors",h==="structure"?"glass-cms-control-frost glass-text-primary glass-shadow-sm":"glass-text-secondary hover:glass-surface-subtle"),title:"Structure",children:[e.jsx("span",{className:"glass-text-lg",children:"🌳"}),"Tree"]})]}),e.jsx("div",{className:"glass-border-r glass-border-subtle",children:h==="components"?e.jsx(T,{collapsed:g,onToggleCollapse:()=>b(!g)}):e.jsx(I,{collapsed:g,onToggleCollapse:()=>b(!g)})})]}),e.jsx(E,{}),e.jsx("div",{className:"glass-border-l glass-border-subtle",children:e.jsx(A,{collapsed:f,onToggleCollapse:()=>u(!f)})})]}),e.jsxs("div",{className:"glass-h-6 glass-surface-primary glass-text-secondary glass-text-xs glass-flex glass-items-center glass-justify-between glass-px-4",children:[e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-4",children:[e.jsx("span",{children:"🟢 Ready"}),e.jsx("span",{children:"Auto-save: ON"})]}),e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-4",children:[e.jsx("span",{children:"Zoom: 100%"}),e.jsxs("span",{children:["Grid: ","OFF"]})]})]})]})},C=s=>e.jsx(_,{children:e.jsx(G,{...s})});try{C.displayName="GlassPageBuilder",C.__docgenInfo={description:"",displayName:"GlassPageBuilder",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string | undefined"}},initialData:{defaultValue:null,description:"",name:"initialData",required:!1,type:{name:"PageBuilderInitialData | undefined"}},onSave:{defaultValue:null,description:"",name:"onSave",required:!1,type:{name:"((data: PageExportData) => void) | undefined"}},onPreview:{defaultValue:null,description:"",name:"onPreview",required:!1,type:{name:"((data: PageExportData) => void) | undefined"}},onPublish:{defaultValue:null,description:"",name:"onPublish",required:!1,type:{name:"((data: PageExportData) => void) | undefined"}},"data-testid":{defaultValue:null,description:"",name:"data-testid",required:!1,type:{name:"string | undefined"}}}}}catch{}const K={title:"Workflows/Glass Page Builder",component:C,decorators:[s=>e.jsxs("div",{className:"ag-page-builder-story",children:[e.jsx("style",{children:`
        ...
        `}),e.jsx(s,{})]})],parameters:{layout:"fullscreen",docs:{description:{component:`
# 🎨 Glass Page Builder
...
5. Use the property panel to change colors and styles
        `}}}},w={args:{initialData:j},parameters:{docs:{description:{story:`
...
5. Try Undo/Redo with the toolbar buttons
        `}}}},N={args:{initialData:B},parameters:{docs:{description:{story:`
...
}`,...k.parameters?.docs?.source}}};const $=["EmptyBuilder","LandingPageBuilder","DashboardBuilder","InteractiveShowcase","MobileFirst"];export{N as DashboardBuilder,y as EmptyBuilder,S as InteractiveShowcase,w as LandingPageBuilder,k as MobileFirst,$ as __namedExportsOrder,K as default};
