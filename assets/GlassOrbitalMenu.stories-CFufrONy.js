import{r,j as e,m as g,d as X}from"./iframe-D7NmxSe9.js";import{f as le}from"./index-DdjpOZjl.js";import{p as ue,b2 as Y,a7 as Z,S as ee,az as se,m as ce,as as me,H as we,bi as Ne,a9 as Re,bn as Ve,_ as Ae,a_ as de,P as Fe,bm as qe,z as ke,a0 as Pe}from"./components-BOfJuyi9.js";import{u as He}from"./useMotionPreference-2-Zuo_1E.js";import{u as Ge}from"./a11y-AzHiXVvX.js";import{u as Le}from"./soundDesign-C6wKSzTW.js";import{u as Te}from"./use-motion-value-DhfmWhpA.js";import{u as _e}from"./use-transform-D4U1IIHq.js";import{O as De}from"./OptimizedGlassCore-KF10QAKi.js";import"./preload-helper-PPVm8Dsz.js";import"./index-ByImX2pa.js";import"./deviceCapabilities-BxFGwbZv.js";const U=r.forwardRef(({items:n=[],centerElement:f,radius:o=120,itemSize:l=48,isOpen:i=!1,onOpenChange:te,rotationSpeed:re=.5,autoRotate:ne=!1,hoverExpansion:ge=1.2,springTension:b=300,springFriction:h=25,glassConfig:fe={},soundEnabled:c=!0,className:be="",style:he={},...xe},Se)=>{const[ye,ie]=r.useState(null),[ve,ze]=r.useState(null),[x,je]=r.useState(0),Oe=r.useRef(null),S=r.useRef(),{prefersReducedMotion:u}=He(),B=Ge(),{play:m}=Le(),J=Te(0);_e(J,[0,360],[0,360]),r.useEffect(()=>{if(ne&&i&&!u){const s=()=>{je(d=>(d+re)%360),J.set(x),S.current=requestAnimationFrame(s)};S.current=requestAnimationFrame(s)}return()=>{S.current&&cancelAnimationFrame(S.current)}},[ne,i,re,u,x,J]);const Ie=r.useCallback(()=>{te?.(!i),c&&m("tap")},[i,te,c,m]),Ce=r.useCallback(s=>{s.disabled||(ie(s.id),s.onClick?.(),c&&m("tap"),setTimeout(()=>ie(null),200))},[c,m]),oe=r.useCallback(s=>{ze(s),c&&s&&m("hover")},[c,m]),K=r.useCallback((s,d)=>{const p=(360/d*s+x)*(Math.PI/180),Q=Math.cos(p)*o,W=Math.sin(p)*o;return{x:Q,y:W,angle:p*(180/Math.PI)}},[o,x]),Ee=()=>({hidden:{scale:0,opacity:0,x:0,y:0},visible:s=>({scale:1,opacity:1,x:K(s,n.length).x,y:K(s,n.length).y,transition:{type:"spring",tension:b,friction:h,delay:u?0:s*.1}}),hover:{scale:ge,transition:{type:"spring",tension:b*2,friction:h}},active:{scale:.9,transition:{type:"spring",tension:b*3,friction:h}}}),Me={closed:{rotate:0,scale:1},open:{rotate:u?0:180,scale:1.1,transition:{type:"spring",tension:b,friction:h}}};return e.jsxs(De,{ref:Se,className:`glass-orbital-menu relative ${be}`,style:{width:(o+l)*2+40,height:(o+l)*2+40,...he},glassConfig:{blur:20,opacity:.8,saturation:1.2,brightness:1.1,...fe},"aria-label":"Orbital navigation menu",role:"toolbar",id:B,...xe,children:[e.jsxs("div",{ref:Oe,className:"glass-absolute glass-inset-0 glass-flex glass-items-center glass-justify-center",children:[e.jsx(g.button,{className:"glass-relative glass-z-20 glass-flex glass-items-center glass-justify-center glass-surface glass-radius-full glass-border glass-border-white/20 glass-backdrop-blur-md glass-surface-subtle/10 hover:glass-surface-subtle/15 glass-transition-colors glass-contrast-guard",style:{width:l+8,height:l+8},variants:Me,animate:i?"open":"closed",onClick:Ie,"aria-expanded":i,"aria-controls":`${B}-items`,"aria-label":i?"Close menu":"Open menu",children:f||e.jsxs(g.div,{className:"glass-w-6 glass-h-6 glass-flex glass-flex-col glass-items-center glass-justify-center",animate:{rotate:i?45:0},children:[e.jsx("div",{className:"glass-w-4 glass-h-0-5 glass-surface-subtle/70 glass-mb-1"}),e.jsx("div",{className:"glass-w-4 glass-h-0-5 glass-surface-subtle/70"})]})}),e.jsx("div",{id:`${B}-items`,className:"glass-absolute glass-inset-0 glass-flex glass-items-center glass-justify-center glass-pointer-events-none",role:"group",children:e.jsx(X,{children:i&&n.map((s,d)=>{const p=K(d,n.length),Q=ve===s.id,W=ye===s.id;return e.jsx(g.div,{className:"glass-absolute glass-pointer-events-auto",custom:d,variants:Ee(),initial:u?!1:"hidden",animate:u?!1:"visible",exit:"hidden",whileHover:!u&&!s.disabled?"hover":void 0,style:{x:p.x,y:p.y},children:e.jsxs(g.button,{className:`
...
}`,...$.parameters?.docs?.source}}};const ns=["Default","Closed","AutoRotating","FastRotation","LargeRadius","SmallRadius","ManyItems","MediaControls","CustomCenter","LargeItems","SmallItems","HighExpansion","LowExpansion","SlowAnimation","FastAnimation","BouncyAnimation","StiffAnimation","DisabledItems","NoSounds","CustomGlass","MinimalGlass","IntenseGlass","CompactLayout","SpacedLayout","Interactive"];export{z as AutoRotating,q as BouncyAnimation,v as Closed,_ as CompactLayout,M as CustomCenter,G as CustomGlass,y as Default,P as DisabledItems,F as FastAnimation,j as FastRotation,R as HighExpansion,T as IntenseGlass,$ as Interactive,w as LargeItems,O as LargeRadius,V as LowExpansion,C as ManyItems,E as MediaControls,L as MinimalGlass,H as NoSounds,A as SlowAnimation,N as SmallItems,I as SmallRadius,D as SpacedLayout,k as StiffAnimation,ns as __namedExportsOrder,rs as default};
