import{j as r,R as h}from"./iframe-D7NmxSe9.js";import{a as o,b as x,G as y,c as b}from"./errorBoundary-CIfB-5gh.js";import"./preload-helper-PPVm8Dsz.js";import"./OptimizedGlassCore-KF10QAKi.js";import"./deviceCapabilities-BxFGwbZv.js";const S={title:"Effects + Advanced/error Boundary",component:o,parameters:{layout:"fullscreen",previewSurface:"app",docs:{description:{component:"Comprehensive error boundary components with glass morphism styling for graceful error handling."}}},argTypes:{maxRetries:{control:{type:"number",min:0,max:10},description:"Maximum number of retry attempts"},resetOnPropsChange:{control:"boolean",description:"Reset error state when props change"}},args:{maxRetries:3,resetOnPropsChange:!0}},s=({children:e})=>r.jsxs("div",{"data-bg":"light",className:"glass-on-light glass-error-boundary-story",style:{width:"100%",minHeight:"100vh",padding:"clamp(20px, 4vw, 40px)",boxSizing:"border-box",overflowX:"hidden",display:"grid",placeItems:"center",backgroundColor:"#f8fafc",backgroundImage:"linear-gradient(135deg, #ffffff 0%, #f5f6f7 48%, #eceef0 100%)",color:"#0f172a"},children:[r.jsx("style",{children:`
