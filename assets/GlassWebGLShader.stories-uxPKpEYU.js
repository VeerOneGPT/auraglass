import{r as l,a as X,j as n,c as U,f as w}from"./iframe-D7NmxSe9.js";import"./preload-helper-PPVm8Dsz.js";const K={...w({intent:"neutral",elevation:"level3"}),minHeight:220,borderColor:"rgba(255, 255, 255, 0.18)",color:"var(--glass-theme-text, var(--glass-text-primary))",background:"linear-gradient(145deg, rgba(255,255,255,0.34), rgba(255,255,255,0.2))",contain:"layout paint"},Y={...w({intent:"primary",elevation:"level2"})},$={...w({intent:"neutral",elevation:"level3"}),borderColor:"rgba(255, 255, 255, 0.18)",boxShadow:"0 24px 80px rgba(15,23,42,0.12), inset 0 1px 0 rgba(255,255,255,0.28)",transform:"translate(-50%, -50%)"},J=`
...
}`,...f.parameters?.docs?.source}}};const oe=["Default"];export{f as Default,oe as __namedExportsOrder,ne as default};
