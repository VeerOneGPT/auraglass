import{r,a as as,j as e,m as O,b as me,ah as ts}from"./iframe-D7NmxSe9.js";import{u as rs}from"./useMotionPreference-2-Zuo_1E.js";import{u as os}from"./a11y-AzHiXVvX.js";import{u as is}from"./soundDesign-C6wKSzTW.js";import{O as ke}from"./OptimizedGlassCore-KF10QAKi.js";import"./preload-helper-PPVm8Dsz.js";import"./deviceCapabilities-BxFGwbZv.js";const ls={containerPadding:50,islandSpacing:100,connectionDistance:300,animationSpeed:1,gravityStrength:.02,repulsionStrength:100,enablePhysics:!1,enableAutoArrange:!1,enableCollisionDetection:!0},se=r.forwardRef(({islands:i,connections:l=[],config:ze={},showMinimap:Oe=!0,showConnections:Re=!0,showGrid:Ge=!1,showStats:Ae=!0,enablePhysics:b=!1,enableDragging:pe=!0,enableResizing:Ze=!1,enableZooming:qe=!0,zoomLevel:ae=1,width:Ve="min(1120px, calc(100vw - 48px))",height:Ee=600,compact:v=!1,contained:Te=!1,maxHeight:$e,centerOnLoad:fe=!0,onIslandMove:ye,onIslandResize:cs,onIslandSelect:be,onConnectionCreate:xe,className:Xe="",...Ye},L)=>{const we=as(),[f,D]=r.useState(i),[P,te]=r.useState([]),[C,ve]=r.useState(null),[Se,Ce]=r.useState(!1),[re,_e]=r.useState({x:0,y:0}),[M,He]=r.useState({x:0,y:0}),[m,oe]=r.useState(ae),[ds,Me]=r.useState(null),[k,je]=r.useState(!1),[R,Ne]=r.useState(null),We=r.useRef(null),ie=r.useRef(null),le=r.useRef(null),G=r.useRef(),[h]=r.useState({...ls,...ze});os("glass-island-layout");const{shouldAnimate:S}=rs(),{play:ce}=is(),I=$e??(v||Te?240:Ee),Fe=v?"100%":Ve,Ue=v?!1:Oe,Be=v?!1:Ae,Je=v?!1:qe,Ie=v?!1:Re,de=r.useCallback(()=>{if(!h.enableAutoArrange)return;const s=i.map((n,t)=>{const a=t*.618*2*Math.PI,o=Math.sqrt(t+1)*h.islandSpacing;return{...n,x:Math.cos(a)*o+400,y:Math.sin(a)*o+400}});D(s)},[i,h]),Le=r.useCallback(()=>{if(!b)return;const s=f.map(n=>({...n,vx:0,vy:0,mass:n.width*n.height/1e4,fixed:n.pinned||!1}));te(s)},[f,b]),De=r.useCallback(()=>{!b||P.length===0||te(s=>{const n=s.map(t=>({...t}));for(let t=0;t<n.length;t++){const a=n[t];if(a.fixed)continue;let o=0,g=0;for(let y=0;y<n.length;y++){if(t===y)continue;const c=n[y],d=c.x+c.width/2-(a.x+a.width/2),j=c.y+c.height/2-(a.y+a.height/2),x=Math.sqrt(d*d+j*j);if(x>0){const N=h.repulsionStrength/(x*x);if(o-=d/x*N,g-=j/x*N,l.some(w=>w.from===a.id&&w.to===c.id||w.to===a.id&&w.from===c.id)){const w=h.gravityStrength*x;o+=d/x*w,g+=j/x*w}}}a.vx+=o/a.mass,a.vy+=g/a.mass,a.vx*=.95,a.vy*=.95,a.x+=a.vx*h.animationSpeed,a.y+=a.vy*h.animationSpeed,a.x<h.containerPadding&&(a.x=h.containerPadding,a.vx=0),a.y<h.containerPadding&&(a.y=h.containerPadding,a.vy=0)}return n})},[b,P,l,h]);r.useEffect(()=>{if(!b)return;const s=()=>{De(),G.current=requestAnimationFrame(s)};return G.current=requestAnimationFrame(s),()=>{G.current&&cancelAnimationFrame(G.current)}},[b,De]),r.useEffect(()=>{b&&P.length>0&&D(P)},[P,b]);const Pe=r.useCallback(()=>{if(!Ie||!le.current)return;const s=le.current,n=s.getContext("2d");n&&(n.clearRect(0,0,s.width,s.height),n.save(),n.scale(m,m),n.translate(M.x,M.y),l.forEach(t=>{const a=f.find(w=>w.id===t.from),o=f.find(w=>w.id===t.to);if(!a||!o)return;const g=a.x+a.width/2,y=a.y+a.height/2,c=o.x+o.width/2,d=o.y+o.height/2;n.strokeStyle=t.color||"var(--glass-bg-hover)",n.lineWidth=(t.strength||1)*2,t.type==="dashed"?n.setLineDash([5,5]):t.type==="dotted"?n.setLineDash([2,3]):n.setLineDash([]),n.beginPath(),n.moveTo(g,y);const j=(g+c)/2,x=Math.min(y,d)-Math.abs(c-g)/4;n.quadraticCurveTo(j,x,c,d),n.stroke();const N=Math.atan2(d-x,c-j),z=10;n.fillStyle=t.color||"var(--glass-border-hover)",n.beginPath(),n.moveTo(c,d),n.lineTo(c-z*Math.cos(N-Math.PI/6),d-z*Math.sin(N-Math.PI/6)),n.lineTo(c-z*Math.cos(N+Math.PI/6),d-z*Math.sin(N+Math.PI/6)),n.closePath(),n.fill()}),n.restore())},[Ie,l,f,m,M]),Ke=r.useCallback((s,n)=>{if(pe){if(Ce(!0),ve(n.id),_e({x:s.clientX-n.x*m,y:s.clientY-n.y*m}),k){R?(xe?.(R,n.id),Ne(null),je(!1),ce("connect")):Ne(n.id);return}be?.(n),ce("select")}},[pe,m,k,R,xe,be,ce]),ge=r.useCallback(s=>{if(!Se||!C)return;const n=(s.clientX-re.x)/m,t=(s.clientY-re.y)/m;D(o=>o.map(g=>g.id===C?{...g,x:n,y:t}:g)),b&&te(o=>o.map(g=>g.id===C?{...g,x:n,y:t,vx:0,vy:0}:g));const a=f.find(o=>o.id===C);a&&ye?.(a,n,t)},[Se,C,re,m,b,f,ye]),ue=r.useCallback(()=>{Ce(!1),ve(null),Me(null)},[]);r.useEffect(()=>{if(fe&&f.length>0&&ie.current){const s=f.reduce((c,d)=>({minX:Math.min(c.minX,d.x),minY:Math.min(c.minY,d.y),maxX:Math.max(c.maxX,d.x+d.width),maxY:Math.max(c.maxY,d.y+d.height)}),{minX:1/0,minY:1/0,maxX:-1/0,maxY:-1/0}),n=ie.current.getBoundingClientRect(),t=Math.max(1,s.maxX-s.minX),a=Math.max(1,s.maxY-s.minY),o=Math.max(1,n.width-64),g=Math.max(1,n.height-(v?48:112)),y=Math.max(.2,Math.min(ae,o/t,g/a));oe(y),He({x:(n.width-t*y)/2-s.minX*y,y:(n.height-a*y)/2-s.minY*y+(v?0:28)})}},[fe,v,f,ae]);const Qe=r.useCallback(s=>{ie.current=s,typeof L=="function"?L(s):L&&Object.assign(L,{current:s})},[L]);r.useEffect(()=>{D(i),h.enableAutoArrange&&de()},[i,de,h.enableAutoArrange]),r.useEffect(()=>{Le()},[Le]),r.useEffect(()=>{Pe()},[Pe]),r.useEffect(()=>(document.addEventListener("mousemove",ge),document.addEventListener("mouseup",ue),()=>{document.removeEventListener("mousemove",ge),document.removeEventListener("mouseup",ue)}),[ge,ue]);const es=()=>e.jsxs("div",{className:"glass-island-layout-minimap glass-absolute glass-right-4 glass-w-50 glass-h-38 glass-surface-dark/50 glass-border glass-border-white/20 glass-radius-lg glass-p-2",style:{top:96},children:[e.jsx("div",{className:"glass-text-xs glass-text-primary-opacity-70 glass-mb-1",children:"Overview"}),e.jsxs("div",{className:"glass-relative glass-surface-dark/30 glass-radius",style:{width:200,height:150},children:[f.map(a=>e.jsx("div",{className:`absolute rounded ${C===a.id?"bg-blue-400":"bg-white/40"}`,style:{left:a.x*.1,top:a.y*.1,width:Math.max(2,a.width*.1),height:Math.max(2,a.height*.1)}},`mini-${a.id}`)),e.jsx("div",{className:"glass-absolute glass-border glass-border-blue glass-pointer-events-none",style:{left:-M.x*.1/m,top:-M.y*.1/m,width:200*.1/m,height:150*.1/m}})]})]}),ss=()=>e.jsx("div",{className:"glass-island-layout-stats glass-absolute glass-bottom-4 glass-left-4 glass-p-3 glass-radius-lg glass-border glass-border-soft",style:{background:"rgba(255,255,255,.2)",boxShadow:"inset 0 1px 0 rgba(255,255,255,.28)"},children:e.jsxs("div",{className:"glass-text-xs glass-text-primary-glass-opacity-90 glass-space-y-1",children:[e.jsxs("div",{children:["Islands: ",f.length]}),e.jsxs("div",{children:["Connections: ",l.length]}),e.jsxs("div",{children:["Zoom: ",Math.round(m*100),"%"]}),b&&e.jsx("div",{children:"Physics: ON"})]})}),ns=()=>e.jsxs("div",{className:"glass-island-layout-controls glass-absolute glass-left-4 glass-flex glass-flex-col glass-space-y-2",style:{top:96},children:[e.jsx(O.button,{className:"glass-p-2 glass-surface-subtle/10 hover:glass-surface-subtle/20 glass-border glass-border-white/20 glass-radius-lg glass-text-primary glass-transition-colors glass-focus glass-touch-target glass-contrast-guard",whileHover:S?{scale:1.05}:{},whileTap:S?{scale:.95}:{},onClick:()=>oe(s=>Math.min(3,s*1.2)),style:{appearance:"none",width:44,height:44,border:"1px solid rgba(148,163,184,.3)",borderRadius:14,background:"rgba(255,255,255,.2)",color:"var(--glass-theme-text, var(--glass-text-primary))"},children:"🔍+"}),e.jsx(O.button,{className:"glass-p-2 glass-surface-subtle/10 hover:glass-surface-subtle/20 glass-border glass-border-white/20 glass-radius-lg glass-text-primary glass-transition-colors glass-focus glass-touch-target glass-contrast-guard",whileHover:S?{scale:1.05}:{},whileTap:S?{scale:.95}:{},onClick:()=>oe(s=>Math.max(.2,s/1.2)),style:{appearance:"none",width:44,height:44,border:"1px solid rgba(148,163,184,.3)",borderRadius:14,background:"rgba(255,255,255,.2)",color:"var(--glass-theme-text, var(--glass-text-primary))"},children:"🔍-"}),e.jsx(O.button,{className:`p-2 border border-white/20 ${ts.lg} glass-text-primary glass-surface-overlay transition-colors glass-focus glass-touch-target glass-contrast-guard`,style:{appearance:"none",width:44,height:44,border:"1px solid rgba(148,163,184,.3)",borderRadius:14,background:"rgba(255,255,255,.2)",color:"var(--glass-theme-text, var(--glass-text-primary))"},whileHover:S?{scale:1.05}:{},whileTap:S?{scale:.95}:{},onClick:()=>je(!k),children:"🔗"}),e.jsx(O.button,{className:"glass-p-2 glass-surface-subtle/10 hover:glass-surface-subtle/20 glass-border glass-border-white/20 glass-radius-lg glass-text-primary glass-transition-colors glass-focus glass-touch-target glass-contrast-guard",whileHover:S?{scale:1.05}:{},whileTap:S?{scale:.95}:{},onClick:de,style:{appearance:"none",width:44,height:44,border:"1px solid rgba(148,163,184,.3)",borderRadius:14,background:"rgba(255,255,255,.2)",color:"var(--glass-theme-text, var(--glass-text-primary))"},children:"⚡"})]});return e.jsxs(ke,{ref:Qe,variant:"frosted",className:`glass-island-layout glass-relative glass-overflow-hidden ${Xe}`,style:{width:Fe,maxWidth:"100%",height:typeof I=="number"?`${I}px`:I,maxHeight:typeof I=="number"?`${I}px`:I,overflow:"hidden",contain:"layout paint"},...Ye,children:[e.jsx("style",{children:`
